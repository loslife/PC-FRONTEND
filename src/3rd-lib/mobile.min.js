...
if(!Ha)break;x++}x>1&&(a.staggerLines=x)}n(e,function(b){(0===h||2===h||{1:"left",3:"right"}[h]===a.labelAlign)&&(aa=r(f[b].getLabelSize(),aa))}),a.staggerLines&&(aa*=a.staggerLines,a.labelOffset=aa)}else for(w in f)f[w].destroy(),delete f[w];p&&p.text&&p.enabled!==!1&&(a.axisTitle||(a.axisTitle=c.text(p.text,0,0,p.useHTML).attr({zIndex:7,rotation:p.rotation||0,align:p.textAlign||{low:"left",middle:"center",high:"right"}[p.align]}).css(p.style).add(a.axisGroup),a.axisTitle.isNew=!0),b&&(k=a.axisTitle.getBBox()[g?"height":"width"],m=o(p.margin,g?5:10),l=p.offset),a.axisTitle[b?"show":"hide"]()),a.offset=s*o(d.offset,B[h]),a.axisTitleMargin=o(l,aa+m+(2!==h&&aa&&s*d.labels[g?"y":"x"])),B[h]=r(B[h],a.axisTitleMargin+k+s*a.offset),t[i]=r(t[i],2*P(d.lineWidth/2))},getLinePath:function(a){var b=this.chart,c=this.opposite,d=this.offset,e=this.horiz,f=this.left+(c?this.width:0)+d,d=b.chartHeight-this.bottom-(c?this.height:0)+d;return c&&(a*=-1),b.renderer.crispLine(["M",e?this.left:f,e?d:this.top,"L",e?b.chartWidth-this.right:f,e?d:b.chartHeight-this.bottom],a)},getTitlePosition:function(){var a=this.horiz,b=this.left,c=this.top,d=this.len,e=this.options.title,f=a?b:c,g=this.opposite,h=this.offset,i=y(e.style.fontSize||12),d={low:f+(a?0:d),middle:f+d/2,high:f+(a?d:0)}[e.align],b=(a?c+this.height:b)+(a?1:-1)*(g?-1:1)*this.axisTitleMargin+(2===this.side?i:0);return{x:a?d:b+(g?this.width:0)+h+(e.x||0),y:a?b-(g?this.height:0)+h:d+(e.y||0)}},render:function(){var B,a=this,b=a.chart,c=b.renderer,d=a.options,e=a.isLog,f=a.isLinked,g=a.tickPositions,h=a.axisTitle,i=a.stacks,j=a.ticks,k=a.minorTicks,l=a.alternateBands,m=d.stackLabels,p=d.alternateGridColor,q=a.tickmarkOffset,o=d.lineWidth,r=b.hasRendered&&u(a.oldMin)&&!isNaN(a.oldMin);B=a.hasData;var s,w,t=a.showAxis;if(n([j,k,l],function(a){for(var b in a)a[b].isActive=!1}),(B||f)&&(a.minorTickInterval&&!a.categories&&n(a.getMinorTickPositions(),function(b){k[b]||(k[b]=new Ma(a,b,"minor")),r&&k[b].isNew&&k[b].render(null,!0),k[b].render(null,!1,1)}),g.length&&(n(g.slice(1).concat([g[0]]),function(b,c){c=c===g.length-1?0:c+1,(!f||b>=a.min&&b<=a.max)&&(j[b]||(j[b]=new Ma(a,b)),r&&j[b].isNew&&j[b].render(c,!0),j[b].render(c,!1,1))}),q&&0===a.min&&(j[-1]||(j[-1]=new Ma(a,-1,null,!0)),j[-1].render(-1))),p&&n(g,function(b,c){c%2===0&&b<a.max&&(l[b]||(l[b]=new vb(a)),s=b+q,w=g[c+1]!==v?g[c+1]+q:a.max,l[b].options={from:e?fa(s):s,to:e?fa(w):w,color:p},l[b].render(),l[b].isActive=!0)}),a._addedPlotLB||(n((d.plotLines||[]).concat(d.plotBands||[]),function(b){a.addPlotBandOrLine(b)}),a._addedPlotLB=!0)),n([j,k,l],function(a){var c,d,e=[],f=Fa?Fa.duration||500:0,g=function(){for(d=e.length;d--;)a[e[d]]&&!a[e[d]].isActive&&(a[e[d]].destroy(),delete a[e[d]])};for(c in a)a[c].isActive||(a[c].render(c,!1,0),a[c].isActive=!1,e.push(c));a!==l&&b.hasRendered&&f?f&&setTimeout(g,f):g()}),o&&(B=a.getLinePath(o),a.axisLine?a.axisLine.animate({d:B}):a.axisLine=c.path(B).attr({stroke:d.lineColor,"stroke-width":o,zIndex:7}).add(a.axisGroup),a.axisLine[t?"show":"hide"]()),h&&t&&(h[h.isNew?"attr":"animate"](a.getTitlePosition()),h.isNew=!1),m&&m.enabled){var x,y,d=a.stackTotalGroup;d||(a.stackTotalGroup=d=c.g("stack-labels").attr({visibility:"visible",zIndex:6}).add()),d.translate(b.plotLeft,b.plotTop);for(x in i)for(y in c=i[x])c[y].render(d)}a.isDirty=!1},removePlotBandOrLine:function(a){for(var b=this.plotLinesAndBands,c=this.options,d=this.userOptions,e=b.length;e--;)b[e].id===a&&b[e].destroy();n([c.plotLines||[],d.plotLines||[],c.plotBands||[],d.plotBands||[]],function(b){for(e=b.length;e--;)b[e].id===a&&ga(b,b[e])})},setTitle:function(a,b){this.update({title:a},b)},redraw:function(){var a=this.chart.pointer;a.reset&&a.reset(!0),this.render(),n(this.plotLinesAndBands,function(a){a.render()}),n(this.series,function(a){a.isDirty=!0})},buildStacks:function(){var a=this.series,b=a.length;if(!this.isXAxis){for(;b--;)a[b].setStackedPoints();if(this.usePercentage)for(b=0;b<a.length;b++)a[b].setPercentStacks()}},setCategories:function(a,b){this.update({categories:a},b)},destroy:function(a){var d,b=this,c=b.stacks,e=b.plotLinesAndBands;a||$(b);for(d in c)Ka(c[d]),c[d]=null;for(n([b.ticks,b.minorTicks,b.alternateBands],function(a){Ka(a)}),a=e.length;a--;)e[a].destroy();n("stackTotalGroup,axisLine,axisGroup,gridGroup,labelGroup,axisTitle".split(","),function(a){b[a]&&(b[a]=b[a].destroy())})}},wb.prototype={init:function(a,b){var c=b.borderWidth,d=b.style,e=y(d.padding);this.chart=a,this.options=b,this.crosshairs=[],this.now={x:0,y:0},this.isHidden=!0,this.label=a.renderer.label("",0,0,b.shape,null,null,b.useHTML,null,"tooltip").attr({padding:e,fill:b.backgroundColor,"stroke-width":c,r:b.borderRadius,zIndex:8}).css(d).css({padding:0}).add().attr({y:-999}),ca||this.label.shadow(b.shadow),this.shared=b.shared},destroy:function(){n(this.crosshairs,function(a){a&&a.destroy()}),this.label&&(this.label=this.label.destroy()),clearTimeout(this.hideTimer),clearTimeout(this.tooltipTimeout)},move:function(a,b,c,d){var e=this,f=e.now,g=e.options.animation!==!1&&!e.isHidden;s(f,{x:g?(2*f.x+a)/3:a,y:g?(f.y+b)/2:b,anchorX:g?(2*f.anchorX+c)/3:c,anchorY:g?(f.anchorY+d)/2:d}),e.label.attr(f),g&&(M(a-f.x)>1||M(b-f.y)>1)&&(clearTimeout(this.tooltipTimeout),this.tooltipTimeout=setTimeout(function(){e&&e.move(a,b,c,d)},32))},hide:function(){var b,a=this;clearTimeout(this.hideTimer),this.isHidden||(b=this.chart.hoverPoints,this.hideTimer=setTimeout(function(){a.label.fadeOut(),a.isHidden=!0},o(this.options.hideDelay,500)),b&&n(b,function(a){a.setState()}),this.chart.hoverPoints=null)},hideCrosshairs:function(){n(this.crosshairs,function(a){a&&a.hide()})},getAnchor:function(a,b){var c,i,d=this.chart,e=d.inverted,f=d.plotTop,g=0,h=0,a=ja(a);return c=a[0].tooltipPos,this.followPointer&&b&&(b.chartX===v&&(b=d.pointer.normalize(b)),c=[b.chartX-d.plotLeft,b.chartY-f]),c||(n(a,function(a){i=a.series.yAxis,g+=a.plotX,h+=(a.plotLow?(a.plotLow+a.plotHigh)/2:a.plotY)+(!e&&i?i.top-f:0)}),g/=a.length,h/=a.length,c=[e?d.plotWidth-h:g,this.shared&&!e&&a.length>1&&b?b.chartY-f:e?d.plotHeight-g:h]),Na(c,t)},getPosition:function(a,b,c){var l,d=this.chart,e=d.plotLeft,f=d.plotTop,g=d.plotWidth,h=d.plotHeight,i=o(this.options.distance,12),j=c.plotX,c=c.plotY,d=j+e+(d.inverted?i:-a-i),k=c-b+f+15;return 7>d&&(d=e+r(j,0)+i),d+a>e+g&&(d-=d+a-(e+g),k=c-b+f-i,l=!0),f+5>k&&(k=f+5,l&&c>=k&&k+b>=c&&(k=c+f+i)),k+b>f+h&&(k=r(f,f+h-b-i)),{x:d,y:k}},defaultFormatter:function(a){var d,b=this.points||ja(this),c=b[0].series;return d=[c.tooltipHeaderFormatter(b[0])],n(b,function(a){c=a.series,d.push(c.tooltipFormatter&&c.tooltipFormatter(a)||a.point.tooltipFormatter(c.tooltipOptions.pointFormat))}),d.push(a.options.footerFormat||""),d.join("")},refresh:function(a,b){var f,g,i,c=this.chart,d=this.label,e=this.options,h={},j=[];i=e.formatter||this.defaultFormatter;var k,h=c.hoverPoints,l=e.crosshairs,m=this.shared;if(clearTimeout(this.hideTimer),this.followPointer=ja(a)[0].series.tooltipOptions.followPointer,g=this.getAnchor(a,b),f=g[0],g=g[1],!m||a.series&&a.series.noSharedTooltip?h=a.getLabelConfig():(c.hoverPoints=a,h&&n(h,function(a){a.setState()}),n(a,function(a){a.setState("hover"),j.push(a.getLabelConfig())}),h={x:a[0].category,y:a[0].y},h.points=j,a=a[0]),i=i.call(h,this),h=a.series,i===!1?this.hide():(this.isHidden&&(Wa(d),d.attr("opacity",1).show()),d.attr({text:i}),k=e.borderColor||a.color||h.color||"#606060",d.attr({stroke:k}),this.updatePosition({plotX:f,plotY:g}),this.isHidden=!1),l)for(l=ja(l),d=l.length;d--;)m=a.series,e=m[d?"yAxis":"xAxis"],l[d]&&e&&(h=d?o(a.stackY,a.y):a.x,e.isLog&&(h=ma(h)),1===d&&m.modifyValue&&(h=m.modifyValue(h)),e=e.getPlotLinePath(h,1),this.crosshairs[d]?this.crosshairs[d].attr({d:e,visibility:"visible"}):(h={"stroke-width":l[d].width||1,stroke:l[d].color||"#C0C0C0",zIndex:l[d].zIndex||2},l[d].dashStyle&&(h.dashstyle=l[d].dashStyle),this.crosshairs[d]=c.renderer.path(e).attr(h).add()));A(c,"tooltipRefresh",{text:i,x:f+c.plotLeft,y:g+c.plotTop,borderColor:k})},updatePosition:function(a){var b=this.chart,c=this.label,c=(this.options.positioner||this.getPosition).call(this,c.width,c.height,a);this.move(t(c.x),t(c.y),a.plotX+b.plotLeft,a.plotY+b.plotTop)}},xb.prototype={init:function(a,b){var f,c=b.chart,d=c.events,e=ca?"":c.zoomType,c=a.inverted;this.options=b,this.chart=a,this.zoomX=f=/x/.test(e),this.zoomY=e=/y/.test(e),this.zoomHor=f&&!c||e&&c,this.zoomVert=e&&!c||f&&c,this.runChartClick=d&&!!d.click,this.pinchDown=[],this.lastValidTouch={},b.tooltip.enabled&&(a.tooltip=new wb(a,b.tooltip)),this.setDOMEvents()},normalize:function(a,b){var c,d,a=a||N.event;return a.target||(a.target=a.srcElement),a=Xb(a),d=a.touches?a.touches.item(0):a,b||(this.chartPosition=b=Wb(this.chart.container)),d.pageX===v?(c=r(a.x,a.clientX-b.left),d=a.y):(c=d.pageX-b.left,d=d.pageY-b.top),s(a,{chartX:t(c),chartY:t(d)})},getCoordinates:function(a){var b={xAxis:[],yAxis:[]};return n(this.chart.axes,function(c){b[c.isXAxis?"xAxis":"yAxis"].push({axis:c,value:c.toValue(a[c.horiz?"chartX":"chartY"])})}),b},getIndex:function(a){var b=this.chart;return b.inverted?b.plotHeight+b.plotTop-a.chartY:a.chartX-b.plotLeft},runPointActions:function(a){var e,h,i,b=this.chart,c=b.series,d=b.tooltip,f=b.hoverPoint,g=b.hoverSeries,j=b.chartWidth,k=this.getIndex(a);if(d&&this.options.tooltip.shared&&(!g||!g.noSharedTooltip)){for(e=[],h=c.length,i=0;h>i;i++)c[i].visible&&c[i].options.enableMouseTracking!==!1&&!c[i].noSharedTooltip&&c[i].tooltipPoints.length&&(b=c[i].tooltipPoints[k])&&b.series&&(b._dist=M(k-b.clientX),j=J(j,b._dist),e.push(b));for(h=e.length;h--;)e[h]._dist>j&&e.splice(h,1);e.length&&e[0].clientX!==this.hoverX&&(d.refresh(e,a),this.hoverX=e[0].clientX)}g&&g.tracker?(b=g.tooltipPoints[k])&&b!==f&&b.onMouseOver(a):d&&d.followPointer&&!d.isHidden&&(a=d.getAnchor([{}],a),d.updatePosition({plotX:a[0],plotY:a[1]}))},reset:function(a){var b=this.chart,c=b.hoverSeries,d=b.hoverPoint,e=b.tooltip,b=e&&e.shared?b.hoverPoints:d;(a=a&&e&&b)&&ja(b)[0].plotX===v&&(a=!1),a?e.refresh(b):(d&&d.onMouseOut(),c&&c.onMouseOut(),e&&(e.hide(),e.hideCrosshairs()),this.hoverX=null)},scaleGroups:function(a,b){var d,c=this.chart;n(c.series,function(e){d=a||e.getPlotBox(),e.xAxis&&e.xAxis.zoomEnabled&&(e.group.attr(d),e.markerGroup&&(e.markerGroup.attr(d),e.markerGroup.clip(b?c.clipRect:null)),e.dataLabelsGroup&&e.dataLabelsGroup.attr(d))}),c.clipRect.attr(b||c.clipBox)},pinchTranslate:function(a,b,c,d,e,f,g,h){a&&this.pinchTranslateDirection(!0,c,d,e,f,g,h),b&&this.pinchTranslateDirection(!1,c,d,e,f,g,h)},pinchTranslateDirection:function(a,b,c,d,e,f,g,h){var q,o,y,i=this.chart,j=a?"x":"y",k=a?"X":"Y",l="chart"+k,m=a?"width":"height",p=i["plot"+(a?"Left":"Top")],n=h||1,r=i.inverted,t=i.bounds[a?"h":"v"],u=1===b.length,s=b[0][l],v=c[0][l],w=!u&&b[1][l],x=!u&&c[1][l],c=function(){!u&&M(s-w)>20&&(n=h||M(v-x)/M(s-w)),o=(p-v)/n+s,q=i["plot"+(a?"Width":"Height")]/n};c(),b=o,b<t.min?(b=t.min,y=!0):b+q>t.max&&(b=t.max-q,y=!0),y?(v-=.8*(v-g[j][0]),u||(x-=.8*(x-g[j][1])),c()):g[j]=[v,x],r||(f[j]=o-p,f[m]=q),f=r?1/n:n,e[m]=q,e[j]=b,d[r?a?"scaleY":"scaleX":"scale"+k]=n,d["translate"+k]=f*p+(v-f*s)},pinch:function(a){var b=this,c=b.chart,d=b.pinchDown,e=c.tooltip&&c.tooltip.options.followTouchMove,f=a.touches,g=f.length,h=b.lastValidTouch,i=b.zoomHor||b.pinchHor,j=b.zoomVert||b.pinchVert,k=i||j,l=b.selectionMarker,m={},p=1===g&&(b.inClass(a.target,"highcharts-tracker")&&c.runTrackerClick||c.runChartClick),q={};(k||e)&&!p&&a.preventDefault(),Na(f,function(a){return b.normalize(a)}),"touchstart"===a.type?(n(f,function(a,b){d[b]={chartX:a.chartX,chartY:a.chartY}}),h.x=[d[0].chartX,d[1]&&d[1].chartX],h.y=[d[0].chartY,d[1]&&d[1].chartY],n(c.axes,function(a){if(a.zoomEnabled){var b=c.bounds[a.horiz?"h":"v"],d=a.minPixelPadding,e=a.toPixels(a.dataMin),f=a.toPixels(a.dataMax),g=J(e,f),e=r(e,f);b.min=J(a.pos,g-d),b.max=r(a.pos+a.len,e+d)}})):d.length&&(l||(b.selectionMarker=l=s({destroy:oa},c.plotBox)),b.pinchTranslate(i,j,d,f,m,l,q,h),b.hasPinched=k,b.scaleGroups(m,q),!k&&e&&1===g&&this.runPointActions(b.normalize(a)))},dragStart:function(a){var b=this.chart;b.mouseIsDown=a.type,b.cancelClick=!1,b.mouseDownX=this.mouseDownX=a.chartX,b.mouseDownY=this.mouseDownY=a.chartY},drag:function(a){var l,b=this.chart,c=b.options.chart,d=a.chartX,e=a.chartY,f=this.zoomHor,g=this.zoomVert,h=b.plotLeft,i=b.plotTop,j=b.plotWidth,k=b.plotHeight,m=this.mouseDownX,p=this.mouseDownY;h>d?d=h:d>h+j&&(d=h+j),i>e?e=i:e>i+k&&(e=i+k),this.hasDragged=Math.sqrt(Math.pow(m-d,2)+Math.pow(p-e,2)),this.hasDragged>10&&(l=b.isInsidePlot(m-h,p-i),b.hasCartesianSeries&&(this.zoomX||this.zoomY)&&l&&!this.selectionMarker&&(this.selectionMarker=b.renderer.rect(h,i,f?1:j,g?1:k,0).attr({fill:c.selectionMarkerFill||"rgba(69,114,167,0.25)",zIndex:7}).add()),this.selectionMarker&&f&&(d-=m,this.selectionMarker.attr({width:M(d),x:(d>0?0:d)+m})),this.selectionMarker&&g&&(d=e-p,this.selectionMarker.attr({height:M(d),y:(d>0?0:d)+p})),l&&!this.selectionMarker&&c.panning&&b.pan(a,c.panning))},drop:function(a){var b=this.chart,c=this.hasPinched;if(this.selectionMarker){var h,d={xAxis:[],yAxis:[],originalEvent:a.originalEvent||a},e=this.selectionMarker,f=e.x,g=e.y;(this.hasDragged||c)&&(n(b.axes,function(a){if(a.zoomEnabled){var b=a.horiz,c=a.toValue(b?f:g),b=a.toValue(b?f+e.width:g+e.height);!isNaN(c)&&!isNaN(b)&&(d[a.xOrY+"Axis"].push({axis:a,min:J(c,b),max:r(c,b)}),h=!0)}}),h&&A(b,"selection",d,function(a){b.zoom(s(a,c?{animation:!1}:null))})),this.selectionMarker=this.selectionMarker.destroy(),c&&this.scaleGroups()}b&&(I(b.container,{cursor:b._cursor}),b.cancelClick=this.hasDragged>10,b.mouseIsDown=this.hasDragged=this.hasPinched=!1,this.pinchDown=[])},onContainerMouseDown:function(a){a=this.normalize(a),a.preventDefault&&a.preventDefault(),this.dragStart(a)},onDocumentMouseUp:function(a){this.drop(a)},onDocumentMouseMove:function(a){var b=this.chart,c=this.chartPosition,d=b.hoverSeries,a=this.normalize(a,c);c&&d&&!this.inClass(a.target,"highcharts-tracker")&&!b.isInsidePlot(a.chartX-b.plotLeft,a.chartY-b.plotTop)&&this.reset()},onContainerMouseLeave:function(){this.reset(),this.chartPosition=null},onContainerMouseMove:function(a){var b=this.chart,a=this.normalize(a);a.returnValue=!1,"mousedown"===b.mouseIsDown&&this.drag(a),(this.inClass(a.target,"highcharts-tracker")||b.isInsidePlot(a.chartX-b.plotLeft,a.chartY-b.plotTop))&&!b.openMenu&&this.runPointActions(a)},inClass:function(a,b){for(var c;a;){if(c=w(a,"class")){if(-1!==c.indexOf(b))return!0;if(-1!==c.indexOf("highcharts-container"))return!1}a=a.parentNode}},onTrackerMouseOut:function(a){var b=this.chart.hoverSeries;!b||b.options.stickyTracking||this.inClass(a.toElement||a.relatedTarget,"highcharts-tooltip")||b.onMouseOut()},onContainerClick:function(a){var g,h,i,b=this.chart,c=b.hoverPoint,d=b.plotLeft,e=b.plotTop,f=b.inverted,a=this.normalize(a);a.cancelBubble=!0,b.cancelClick||(c&&this.inClass(a.target,"highcharts-tracker")?(g=this.chartPosition,h=c.plotX,i=c.plotY,s(c,{pageX:g.left+d+(f?b.plotWidth-i:h),pageY:g.top+e+(f?b.plotHeight-h:i)}),A(c.series,"click",s(a,{point:c})),b.hoverPoint&&c.firePointEvent("click",a)):(s(a,this.getCoordinates(a)),b.isInsidePlot(a.chartX-d,a.chartY-e)&&A(b,"click",a)))},onContainerTouchStart:function(a){var b=this.chart;1===a.touches.length?(a=this.normalize(a),b.isInsidePlot(a.chartX-b.plotLeft,a.chartY-b.plotTop)?(this.runPointActions(a),this.pinch(a)):this.reset()):2===a.touches.length&&this.pinch(a)},onContainerTouchMove:function(a){(1===a.touches.length||2===a.touches.length)&&this.pinch(a)},onDocumentTouchEnd:function(a){this.drop(a)},setDOMEvents:function(){var c,a=this,b=a.chart.container;this._events=c=[[b,"onmousedown","onContainerMouseDown"],[b,"onmousemove","onContainerMouseMove"],[b,"onclick","onContainerClick"],[b,"mouseleave","onContainerMouseLeave"],[z,"mousemove","onDocumentMouseMove"],[z,"mouseup","onDocumentMouseUp"]],jb&&c.push([b,"ontouchstart","onContainerTouchStart"],[b,"ontouchmove","onContainerTouchMove"],[z,"touchend","onDocumentTouchEnd"]),n(c,function(b){a["_"+b[2]]=function(c){a[b[2]](c)},0===b[1].indexOf("on")?b[0][b[1]]=a["_"+b[2]]:K(b[0],b[1],a["_"+b[2]])})},destroy:function(){var a=this;n(a._events,function(b){0===b[1].indexOf("on")?b[0][b[1]]=null:$(b[0],b[1],a["_"+b[2]])}),delete a._events,clearInterval(a.tooltipTimeout)}},fb.prototype={init:function(a,b){var c=this,d=b.itemStyle,e=o(b.padding,8),f=b.itemMarginTop||0;this.options=b,b.enabled&&(c.baseline=y(d.fontSize)+3+f,c.itemStyle=d,c.itemHiddenStyle=x(d,b.itemHiddenStyle),c.itemMarginTop=f,c.padding=e,c.initialItemX=e,c.initialItemY=e-5,c.maxItemWidth=0,c.chart=a,c.itemHeight=0,c.lastLineHeight=0,c.render(),K(c.chart,"endResize",function(){c.positionCheckboxes()}))},colorizeItem:function(a,b){var j,c=this.options,d=a.legendItem,e=a.legendLine,f=a.legendSymbol,g=this.itemHiddenStyle.color,c=b?c.itemStyle.color:g,h=b?a.color:g,g=a.options&&a.options.marker,i={stroke:h,fill:h};if(d&&d.css({fill:c,color:c}),e&&e.attr({stroke:h}),f){if(g&&f.isMarker)for(j in g=a.convertAttribs(g))d=g[j],d!==v&&(i[j]=d);f.attr(i)}},positionItem:function(a){var b=this.options,c=b.symbolPadding,b=!b.rtl,d=a._legendItemPos,e=d[0],d=d[1],f=a.checkbox;a.legendGroup&&a.legendGroup.translate(b?e:this.legendWidth-e-2*c-4,d),f&&(f.x=e,f.y=d)},destroyItem:function(a){var b=a.checkbox;n(["legendItem","legendLine","legendSymbol","legendGroup"],function(b){a[b]&&(a[b]=a[b].destroy())}),b&&Ta(a.checkbox)},destroy:function(){var a=this.group,b=this.box;b&&(this.box=b.destroy()),a&&(this.group=a.destroy())},positionCheckboxes:function(a){var c,b=this.group.alignAttr,d=this.clipHeight||this.legendHeight;b&&(c=b.translateY,n(this.allItems,function(e){var g,f=e.checkbox;f&&(g=c+f.y+(a||0)+3,I(f,{left:b.translateX+e.legendItemWidth+f.x-20+"px",top:g+"px",display:g>c-6&&c+d-6>g?"":S}))}))},renderTitle:function(){var a=this.padding,b=this.options.title,c=0;b.text&&(this.title||(this.title=this.chart.renderer.label(b.text,a-3,a-4,null,null,null,null,null,"legend-title").attr({zIndex:1}).css(b.style).add(this.group)),a=this.title.getBBox(),c=a.height,this.offsetWidth=a.width,this.contentGroup.attr({translateY:c})),this.titleHeight=c},renderItem:function(a){var C,b=this,c=b.chart,d=c.renderer,e=b.options,f="horizontal"===e.layout,g=e.symbolWidth,h=e.symbolPadding,i=b.itemStyle,j=b.itemHiddenStyle,k=b.padding,l=f?o(e.itemDistance,8):0,m=!e.rtl,p=e.width,q=e.itemMarginBottom||0,n=b.itemMarginTop,B=b.initialItemX,t=a.legendItem,u=a.series||a,s=u.options,v=s.showCheckbox,w=e.useHTML;!t&&(a.legendGroup=d.g("legend-item").attr({zIndex:1}).add(b.scrollGroup),u.drawLegendSymbol(b,a),a.legendItem=t=d.text(e.labelFormat?Ca(e.labelFormat,a):e.labelFormatter.call(a),m?g+h:-h,b.baseline,w).css(x(a.visible?i:j)).attr({align:m?"left":"right",zIndex:2}).add(a.legendGroup),(w?t:a.legendGroup).on("mouseover",function(){a.setState("hover"),t.css(b.options.itemHoverStyle)}).on("mouseout",function(){t.css(a.visible?i:j),a.setState()}).on("click",function(b){var c=function(){a.setVisible()},b={browserEvent:b};a.firePointEvent?a.firePointEvent("legendItemClick",b,c):A(a,"legendItemClick",b,c)}),b.colorizeItem(a,a.visible),s&&v)&&(a.checkbox=U("input",{type:"checkbox",checked:a.selected,defaultChecked:a.selected},e.itemCheckboxStyle,c.container),K(a.checkbox,"click",function(b){A(a,"checkboxClick",{checked:b.target.checked},function(){a.select()})})),d=t.getBBox(),C=a.legendItemWidth=e.itemWidth||g+h+d.width+l+(v?20:0),e=C,b.itemHeight=g=d.height,f&&b.itemX-B+e>(p||c.chartWidth-2*k-B)&&(b.itemX=B,b.itemY+=n+b.lastLineHeight+q,b.lastLineHeight=0),b.maxItemWidth=r(b.maxItemWidth,e),b.lastItemY=n+b.itemY+q,b.lastLineHeight=r(g,b.lastLineHeight),a._legendItemPos=[b.itemX,b.itemY],f?b.itemX+=e:(b.itemY+=n+g+q,b.lastLineHeight=g),b.offsetWidth=p||r((f?b.itemX-B-l:e)+k,b.offsetWidth)},render:function(){var e,f,g,h,a=this,b=a.chart,c=b.renderer,d=a.group,i=a.box,j=a.options,k=a.padding,l=j.borderWidth,m=j.backgroundColor;a.itemX=a.initialItemX,a.itemY=a.initialItemY,a.offsetWidth=0,a.lastItemY=0,d||(a.group=d=c.g("legend").attr({zIndex:7}).add(),a.contentGroup=c.g().attr({zIndex:1}).add(d),a.scrollGroup=c.g().add(a.contentGroup)),a.renderTitle(),e=[],n(b.series,function(a){var b=a.options;o(b.showInLegend,b.linkedTo===v?v:!1,!0)&&(e=e.concat(a.legendItems||("point"===b.legendType?a.data:a)))}),Kb(e,function(a,b){return(a.options&&a.options.legendIndex||0)-(b.options&&b.options.legendIndex||0)}),j.reversed&&e.reverse(),a.allItems=e,a.display=f=!!e.length,n(e,function(b){a.renderItem(b)}),g=j.width||a.offsetWidth,h=a.lastItemY+a.lastLineHeight+a.titleHeight,h=a.handleOverflow(h),(l||m)&&(g+=k,h+=k,i?g>0&&h>0&&(i[i.isNew?"attr":"animate"](i.crisp(null,null,null,g,h)),i.isNew=!1):(a.box=i=c.rect(0,0,g,h,j.borderRadius,l||0).attr({stroke:j.borderColor,"stroke-width":l||0,fill:m||S}).add(d).shadow(j.shadow),i.isNew=!0),i[f?"show":"hide"]()),a.legendWidth=g,a.legendHeight=h,n(e,function(b){a.positionItem(b)}),f&&d.align(s({width:g,height:h},j),!0,"spacingBox"),b.isResizing||this.positionCheckboxes()},handleOverflow:function(a){var b=this,c=this.chart,d=c.renderer,e=this.options,f=e.y,f=c.spacingBox.height+("top"===e.verticalAlign?-f:f)-this.padding,g=e.maxHeight,h=this.clipRect,i=e.navigation,j=o(i.animation,!0),k=i.arrowSize||12,l=this.nav;return"horizontal"===e.layout&&(f/=2),g&&(f=J(f,g)),a>f&&!e.useHTML?(this.clipHeight=c=f-20-this.titleHeight,this.pageCount=wa(a/c),this.currentPage=o(this.currentPage,1),this.fullHeight=a,h||(h=b.clipRect=d.clipRect(0,0,9999,0),b.contentGroup.clip(h)),h.attr({height:c}),l||(this.nav=l=d.g().attr({zIndex:1}).add(this.group),this.up=d.symbol("triangle",0,0,k,k).on("click",function(){b.scroll(-1,j)}).add(l),this.pager=d.text("",15,10).css(i.style).add(l),this.down=d.symbol("triangle-down",0,0,k,k).on("click",function(){b.scroll(1,j)}).add(l)),b.scroll(0),a=f):l&&(h.attr({height:c.chartHeight}),l.hide(),this.scrollGroup.attr({translateY:1}),this.clipHeight=0),a},scroll:function(a,b){var c=this.pageCount,d=this.currentPage+a,e=this.clipHeight,f=this.options.navigation,g=f.activeColor,h=f.inactiveColor,f=this.pager,i=this.padding;d>c&&(d=c),d>0&&(b!==v&&La(b,this.chart),this.nav.attr({translateX:i,translateY:e+7+this.titleHeight,visibility:"visible"}),this.up.attr({fill:1===d?h:g}).css({cursor:1===d?"default":"pointer"}),f.attr({text:d+"/"+this.pageCount}),this.down.attr({x:18+this.pager.getBBox().width,fill:d===c?h:g}).css({cursor:d===c?"default":"pointer"}),e=-J(e*(d-1),this.fullHeight-e+i)+1,this.scrollGroup.animate({translateY:e}),f.attr({text:d+"/"+c}),this.currentPage=d,this.positionCheckboxes(e))}},/Trident\/7\.0/.test(na)&&mb(fb.prototype,"positionItem",function(a,b){var c=this,d=function(){a.call(c,b)};c.chart.renderer.forExport?d():setTimeout(d)}),yb.prototype={init:function(a,b){var c,d=a.series;a.series=null,c=x(L,a),c.series=a.series=d,d=c.chart,this.margin=this.splashArray("margin",d),this.spacing=this.splashArray("spacing",d);var e=d.events;this.bounds={h:{},v:{}},this.callback=b,this.isResizing=0,this.options=c,this.axes=[],this.series=[],this.hasCartesianSeries=d.showAxes;var g,f=this;if(f.index=Ga.length,Ga.push(f),d.reflow!==!1&&K(f,"load",function(){f.initReflow()}),e)for(g in e)K(f,g,e[g]);f.xAxis=[],f.yAxis=[],f.animation=ca?!1:o(d.animation,!0),f.pointCount=0,f.counters=new Jb,f.firstRender()},initSeries:function(a){var b=this.options.chart;return(b=X[a.type||b.type||b.defaultSeriesType])||ka(17,!0),b=new b,b.init(this,a),b},addSeries:function(a,b,c){var d,e=this;return a&&(b=o(b,!0),A(e,"addSeries",{options:a},function(){d=e.initSeries(a),e.isDirtyLegend=!0,e.linkSeries(),b&&e.redraw(c)})),d},addAxis:function(a,b,c,d){var e=b?"xAxis":"yAxis",f=this.options;new eb(this,x(a,{index:this[e].length,isX:b})),f[e]=ja(f[e]||{}),f[e].push(a),o(c,!0)&&this.redraw(d)},isInsidePlot:function(a,b,c){var d=c?b:a,a=c?a:b;return d>=0&&d<=this.plotWidth&&a>=0&&a<=this.plotHeight},adjustTickAmounts:function(){this.options.chart.alignTicks!==!1&&n(this.axes,function(a){a.adjustTickAmount()}),this.maxTicks=null},redraw:function(a){var g,h,b=this.axes,c=this.series,d=this.pointer,e=this.legend,f=this.isDirtyLegend,i=this.isDirtyBox,j=c.length,k=j,l=this.renderer,m=l.isHidden(),p=[];for(La(a,this),m&&this.cloneRenderTo(),this.layOutTitles();k--;)if(a=c[k],a.options.stacking&&(g=!0,a.isDirty)){h=!0;break}if(h)for(k=j;k--;)a=c[k],a.options.stacking&&(a.isDirty=!0);n(c,function(a){a.isDirty&&"point"===a.options.legendType&&(f=!0)}),f&&e.options.enabled&&(e.render(),this.isDirtyLegend=!1),g&&this.getStacks(),this.hasCartesianSeries&&(this.isResizing||(this.maxTicks=null,n(b,function(a){a.setScale()})),this.adjustTickAmounts(),this.getMargins(),n(b,function(a){a.isDirty&&(i=!0)}),n(b,function(a){a.isDirtyExtremes&&(a.isDirtyExtremes=!1,p.push(function(){A(a,"afterSetExtremes",s(a.eventArgs,a.getExtremes())),delete a.eventArgs})),(i||g)&&a.redraw()})),i&&this.drawChartBox(),n(c,function(a){a.isDirty&&a.visible&&(!a.isCartesian||a.xAxis)&&a.redraw()}),d&&d.reset&&d.reset(!0),l.draw(),A(this,"redraw"),m&&this.cloneRenderTo(!0),n(p,function(a){a.call()})},showLoading:function(a){var b=this.options,c=this.loadingDiv,d=b.loading;c||(this.loadingDiv=c=U(Ea,{className:"highcharts-loading"},s(d.style,{zIndex:10,display:S}),this.container),this.loadingSpan=U("span",null,d.labelStyle,c)),this.loadingSpan.innerHTML=a||b.lang.loading,this.loadingShown||(I(c,{opacity:0,display:"",left:this.plotLeft+"px",top:this.plotTop+"px",width:this.plotWidth+"px",height:this.plotHeight+"px"}),Bb(c,{opacity:d.style.opacity},{duration:d.showDuration||0}),this.loadingShown=!0)},hideLoading:function(){var a=this.options,b=this.loadingDiv;b&&Bb(b,{opacity:0},{duration:a.loading.hideDuration||100,complete:function(){I(b,{display:S})}}),this.loadingShown=!1},get:function(a){var d,e,b=this.axes,c=this.series;for(d=0;d<b.length;d++)if(b[d].options.id===a)return b[d];for(d=0;d<c.length;d++)if(c[d].options.id===a)return c[d];for(d=0;d<c.length;d++)for(e=c[d].points||[],b=0;b<e.length;b++)if(e[b].id===a)return e[b];return null},getAxes:function(){var a=this,b=this.options,c=b.xAxis=ja(b.xAxis||{}),b=b.yAxis=ja(b.yAxis||{});n(c,function(a,b){a.index=b,a.isX=!0}),n(b,function(a,b){a.index=b}),c=c.concat(b),n(c,function(b){new eb(a,b)}),a.adjustTickAmounts()},getSelectedPoints:function(){var a=[];return n(this.series,function(b){a=a.concat(ub(b.points||[],function(a){return a.selected}))}),a},getSelectedSeries:function(){return ub(this.series,function(a){return a.selected})},getStacks:function(){var a=this;n(a.yAxis,function(a){a.stacks&&a.hasVisibleSeries&&(a.oldStacks=a.stacks)}),n(a.series,function(b){!b.options.stacking||b.visible!==!0&&a.options.chart.ignoreHiddenSeries!==!1||(b.stackKey=b.type+o(b.options.stack,""))})},showResetZoom:function(){var a=this,b=L.lang,c=a.options.chart.resetZoomButton,d=c.theme,e=d.states,f="chart"===c.relativeTo?null:"plotBox";this.resetZoomButton=a.renderer.button(b.resetZoom,null,null,function(){a.zoomOut()},d,e&&e.hover).attr({align:c.position.align,title:b.resetZoomTitle}).add().align(c.position,!1,f)},zoomOut:function(){var a=this;A(a,"selection",{resetSelection:!0},function(){a.zoom()})},zoom:function(a){var b,e,c=this.pointer,d=!1;!a||a.resetSelection?n(this.axes,function(a){b=a.zoom()}):n(a.xAxis.concat(a.yAxis),function(a){var e=a.axis,h=e.isXAxis;(c[h?"zoomX":"zoomY"]||c[h?"pinchX":"pinchY"])&&(b=e.zoom(a.min,a.max),e.displayBtn&&(d=!0))}),e=this.resetZoomButton,d&&!e?this.showResetZoom():!d&&T(e)&&(this.resetZoomButton=e.destroy()),b&&this.redraw(o(this.options.chart.animation,a&&a.animation,this.pointCount<100))},pan:function(a,b){var e,c=this,d=c.hoverPoints;d&&n(d,function(a){a.setState()}),n("xy"===b?[1,0]:[1],function(b){var d=a[b?"chartX":"chartY"],h=c[b?"xAxis":"yAxis"][0],i=c[b?"mouseDownX":"mouseDownY"],j=(h.pointRange||0)/2,k=h.getExtremes(),l=h.toValue(i-d,!0)+j,i=h.toValue(i+c[b?"plotWidth":"plotHeight"]-d,!0)-j;h.series.length&&l>J(k.dataMin,k.min)&&i<r(k.dataMax,k.max)&&(h.setExtremes(l,i,!1,!1,{trigger:"pan"}),e=!0),c[b?"mouseDownX":"mouseDownY"]=d}),e&&c.redraw(!1),I(c.container,{cursor:"move"})},setTitle:function(a,b){var f,e,c=this,d=c.options;e=d.title=x(d.title,a),f=d.subtitle=x(d.subtitle,b),d=f,n([["title",a,e],["subtitle",b,d]],function(a){var b=a[0],d=c[b],e=a[1],a=a[2];d&&e&&(c[b]=d=d.destroy()),a&&a.text&&!d&&(c[b]=c.renderer.text(a.text,0,0,a.useHTML).attr({align:a.align,"class":"highcharts-"+b,zIndex:a.zIndex||4}).css(a.style).add())}),c.layOutTitles()},layOutTitles:function(){var a=0,b=this.title,c=this.subtitle,d=this.options,e=d.title,d=d.subtitle,f=this.spacingBox.width-44;!b||(b.css({width:(e.width||f)+"px"}).align(s({y:15},e),!1,"spacingBox"),e.floating||e.verticalAlign)||(a=b.getBBox().height,a>=18&&25>=a&&(a=15)),c&&(c.css({width:(d.width||f)+"px"}).align(s({y:a+e.margin},d),!1,"spacingBox"),!d.floating&&!d.verticalAlign&&(a=wa(a+c.getBBox().height))),this.titleOffset=a},getChartSize:function(){var a=this.options.chart,b=this.renderToClone||this.renderTo;this.containerWidth=kb(b,"width"),this.containerHeight=kb(b,"height"),this.chartWidth=r(0,a.width||this.containerWidth||600),this.chartHeight=r(0,o(a.height,this.containerHeight>19?this.containerHeight:400))},cloneRenderTo:function(a){var b=this.renderToClone,c=this.container;a?b&&(this.renderTo.appendChild(c),Ta(b),delete this.renderToClone):(c&&c.parentNode===this.renderTo&&this.renderTo.removeChild(c),this.renderToClone=b=this.renderTo.cloneNode(0),I(b,{position:"absolute",top:"-9999px",display:"block"}),z.body.appendChild(b),c&&b.appendChild(c))},getContainer:function(){var a,c,d,e,b=this.options.chart;this.renderTo=a=b.renderTo,e="highcharts-"+zb++,ea(a)&&(this.renderTo=a=z.getElementById(a)),a||ka(13,!0),c=y(w(a,"data-highcharts-chart")),!isNaN(c)&&Ga[c]&&Ga[c].destroy(),w(a,"data-highcharts-chart",this.index),a.innerHTML="",a.offsetWidth||this.cloneRenderTo(),this.getChartSize(),c=this.chartWidth,d=this.chartHeight,this.container=a=U(Ea,{className:"highcharts-container"+(b.className?" "+b.className:""),id:e},s({position:"relative",overflow:"hidden",width:c+"px",height:d+"px",textAlign:"left",lineHeight:"normal",zIndex:0,"-webkit-tap-highlight-color":"rgba(0,0,0,0)"},b.style),this.renderToClone||a),this._cursor=a.style.cursor,this.renderer=b.forExport?new za(a,c,d,!0):new Va(a,c,d),ca&&this.renderer.create(this,a,c,d)},getMargins:function(){var b,a=this.spacing,c=this.legend,d=this.margin,e=this.options.legend,f=o(e.margin,10),g=e.x,h=e.y,i=e.align,j=e.verticalAlign,k=this.titleOffset;this.resetMargins(),b=this.axisOffset,k&&!u(d[0])&&(this.plotTop=r(this.plotTop,k+this.options.title.margin+a[0])),c.display&&!e.floating&&("right"===i?u(d[1])||(this.marginRight=r(this.marginRight,c.legendWidth-g+f+a[1])):"left"===i?u(d[3])||(this.plotLeft=r(this.plotLeft,c.legendWidth+g+f+a[3])):"top"===j?u(d[0])||(this.plotTop=r(this.plotTop,c.legendHeight+h+f+a[0])):"bottom"!==j||u(d[2])||(this.marginBottom=r(this.marginBottom,c.legendHeight-h+f+a[2]))),this.extraBottomMargin&&(this.marginBottom+=this.extraBottomMargin),this.extraTopMargin&&(this.plotTop+=this.extraTopMargin),this.hasCartesianSeries&&n(this.axes,function(a){a.getOffset()}),u(d[3])||(this.plotLeft+=b[3]),u(d[0])||(this.plotTop+=b[0]),u(d[2])||(this.marginBottom+=b[2]),u(d[1])||(this.marginRight+=b[1]),this.setChartSize()},initReflow:function(){function a(a){var g=c.width||kb(d,"width"),h=c.height||kb(d,"height"),a=a?a.target:N;b.hasUserSize||!g||!h||a!==N&&a!==z||((g!==b.containerWidth||h!==b.containerHeight)&&(clearTimeout(e),b.reflowTimeout=e=setTimeout(function(){b.container&&(b.setSize(g,h,!1),b.hasUserSize=null)},100)),b.containerWidth=g,b.containerHeight=h)}var e,b=this,c=b.options.chart,d=b.renderTo;b.reflow=a,K(N,"resize",a),K(b,"destroy",function(){$(N,"resize",a)})},setSize:function(a,b,c){var e,f,g,d=this;d.isResizing+=1,g=function(){d&&A(d,"endResize",null,function(){d.isResizing-=1})},La(c,d),d.oldChartHeight=d.chartHeight,d.oldChartWidth=d.chartWidth,u(a)&&(d.chartWidth=e=r(0,t(a)),d.hasUserSize=!!e),u(b)&&(d.chartHeight=f=r(0,t(b))),I(d.container,{width:e+"px",height:f+"px"}),d.setChartSize(!0),d.renderer.setSize(e,f,c),d.maxTicks=null,n(d.axes,function(a){a.isDirty=!0,a.setScale()
}),n(d.series,function(a){a.isDirty=!0}),d.isDirtyLegend=!0,d.isDirtyBox=!0,d.getMargins(),d.redraw(c),d.oldChartHeight=null,A(d,"resize"),Fa===!1?g():setTimeout(g,Fa&&Fa.duration||500)},setChartSize:function(a){var i,j,k,l,b=this.inverted,c=this.renderer,d=this.chartWidth,e=this.chartHeight,f=this.options.chart,g=this.spacing,h=this.clipOffset;this.plotLeft=i=t(this.plotLeft),this.plotTop=j=t(this.plotTop),this.plotWidth=k=r(0,t(d-i-this.marginRight)),this.plotHeight=l=r(0,t(e-j-this.marginBottom)),this.plotSizeX=b?l:k,this.plotSizeY=b?k:l,this.plotBorderWidth=f.plotBorderWidth||0,this.spacingBox=c.spacingBox={x:g[3],y:g[0],width:d-g[3]-g[1],height:e-g[0]-g[2]},this.plotBox=c.plotBox={x:i,y:j,width:k,height:l},d=2*P(this.plotBorderWidth/2),b=wa(r(d,h[3])/2),c=wa(r(d,h[0])/2),this.clipBox={x:b,y:c,width:P(this.plotSizeX-r(d,h[1])/2-b),height:P(this.plotSizeY-r(d,h[2])/2-c)},a||n(this.axes,function(a){a.setAxisSize(),a.setAxisTranslation()})},resetMargins:function(){var a=this.spacing,b=this.margin;this.plotTop=o(b[0],a[0]),this.marginRight=o(b[1],a[1]),this.marginBottom=o(b[2],a[2]),this.plotLeft=o(b[3],a[3]),this.axisOffset=[0,0,0,0],this.clipOffset=[0,0,0,0]},drawChartBox:function(){var p,a=this.options.chart,b=this.renderer,c=this.chartWidth,d=this.chartHeight,e=this.chartBackground,f=this.plotBackground,g=this.plotBorder,h=this.plotBGImage,i=a.borderWidth||0,j=a.backgroundColor,k=a.plotBackgroundColor,l=a.plotBackgroundImage,m=a.plotBorderWidth||0,q=this.plotLeft,o=this.plotTop,n=this.plotWidth,r=this.plotHeight,t=this.plotBox,u=this.clipRect,s=this.clipBox;p=i+(a.shadow?8:0),(i||j)&&(e?e.animate(e.crisp(null,null,null,c-p,d-p)):(e={fill:j||S},i&&(e.stroke=a.borderColor,e["stroke-width"]=i),this.chartBackground=b.rect(p/2,p/2,c-p,d-p,a.borderRadius,i).attr(e).add().shadow(a.shadow))),k&&(f?f.animate(t):this.plotBackground=b.rect(q,o,n,r,0).attr({fill:k}).add().shadow(a.plotShadow)),l&&(h?h.animate(t):this.plotBGImage=b.image(l,q,o,n,r).add()),u?u.animate({width:s.width,height:s.height}):this.clipRect=b.clipRect(s),m&&(g?g.animate(g.crisp(null,q,o,n,r)):this.plotBorder=b.rect(q,o,n,r,0,-m).attr({stroke:a.plotBorderColor,"stroke-width":m,zIndex:1}).add()),this.isDirtyBox=!1},propFromSeries:function(){var c,e,f,a=this,b=a.options.chart,d=a.options.series;n(["inverted","angular","polar"],function(g){for(c=X[b.type||b.defaultSeriesType],f=a[g]||b[g]||c&&c.prototype[g],e=d&&d.length;!f&&e--;)(c=X[d[e].type])&&c.prototype[g]&&(f=!0);a[g]=f})},linkSeries:function(){var a=this,b=a.series;n(b,function(a){a.linkedSeries.length=0}),n(b,function(b){var d=b.options.linkedTo;ea(d)&&(d=":previous"===d?a.series[b.index-1]:a.get(d))&&(d.linkedSeries.push(b),b.linkedParent=d)})},render:function(){var g,a=this,b=a.axes,c=a.renderer,d=a.options,e=d.labels,f=d.credits;a.setTitle(),a.legend=new fb(a,d.legend),a.getStacks(),n(b,function(a){a.setScale()}),a.getMargins(),a.maxTicks=null,n(b,function(a){a.setTickPositions(!0),a.setMaxTicks()}),a.adjustTickAmounts(),a.getMargins(),a.drawChartBox(),a.hasCartesianSeries&&n(b,function(a){a.render()}),a.seriesGroup||(a.seriesGroup=c.g("series-group").attr({zIndex:3}).add()),n(a.series,function(a){a.translate(),a.setTooltipPoints(),a.render()}),e.items&&n(e.items,function(b){var d=s(e.style,b.style),f=y(d.left)+a.plotLeft,g=y(d.top)+a.plotTop+12;delete d.left,delete d.top,c.text(b.html,f,g).attr({zIndex:2}).css(d).add()}),f.enabled&&!a.credits&&(g=f.href,a.credits=c.text(f.text,0,0).on("click",function(){g&&(location.href=g)}).attr({align:f.position.align,zIndex:8}).css(f.style).add().align(f.position)),a.hasRendered=!0},destroy:function(){var e,a=this,b=a.axes,c=a.series,d=a.container,f=d&&d.parentNode;for(A(a,"destroy"),Ga[a.index]=v,a.renderTo.removeAttribute("data-highcharts-chart"),$(a),e=b.length;e--;)b[e]=b[e].destroy();for(e=c.length;e--;)c[e]=c[e].destroy();n("title,subtitle,chartBackground,plotBackground,plotBGImage,plotBorder,seriesGroup,clipRect,credits,pointer,scroller,rangeSelector,legend,resetZoomButton,tooltip,renderer".split(","),function(b){var c=a[b];c&&c.destroy&&(a[b]=c.destroy())}),d&&(d.innerHTML="",$(d),f&&Ta(d));for(e in a)delete a[e]},isReadyToRender:function(){var a=this;return!W&&N==N.top&&"complete"!==z.readyState||ca&&!N.canvg?(ca?Tb.push(function(){a.firstRender()},a.options.global.canvasToolsURL):z.attachEvent("onreadystatechange",function(){z.detachEvent("onreadystatechange",a.firstRender),"complete"===z.readyState&&a.firstRender()}),!1):!0},firstRender:function(){var a=this,b=a.options,c=a.callback;a.isReadyToRender()&&(a.getContainer(),A(a,"init"),a.resetMargins(),a.setChartSize(),a.propFromSeries(),a.getAxes(),n(b.series||[],function(b){a.initSeries(b)}),a.linkSeries(),A(a,"beforeRender"),a.pointer=new xb(a,b),a.render(),a.renderer.draw(),c&&c.apply(a,[a]),n(a.callbacks,function(b){b.apply(a,[a])}),a.cloneRenderTo(!0),A(a,"load"))},splashArray:function(a,b){var c=b[a],c=T(c)?c:[c,c,c,c];return[o(b[a+"Top"],c[0]),o(b[a+"Right"],c[1]),o(b[a+"Bottom"],c[2]),o(b[a+"Left"],c[3])]}},yb.prototype.callbacks=[];var Pa=function(){};Pa.prototype={init:function(a,b,c){return this.series=a,this.applyOptions(b,c),this.pointAttr={},a.options.colorByPoint&&(b=a.options.colors||a.chart.options.colors,this.color=this.color||b[a.colorCounter++],a.colorCounter===b.length)&&(a.colorCounter=0),a.chart.pointCount++,this},applyOptions:function(a,b){var c=this.series,d=c.pointValKey,a=Pa.prototype.optionsToObject.call(this,a);return s(this,a),this.options=this.options?s(this.options,a):a,d&&(this.y=this[d]),this.x===v&&c&&(this.x=b===v?c.autoIncrement():b),this},optionsToObject:function(a){var b={},c=this.series,d=c.pointArrayMap||["y"],e=d.length,f=0,g=0;if("number"==typeof a||null===a)b[d[0]]=a;else if(Ia(a))for(a.length>e&&(c=typeof a[0],"string"===c?b.name=a[0]:"number"===c&&(b.x=a[0]),f++);e>g;)b[d[g++]]=a[f++];else"object"==typeof a&&(b=a,a.dataLabels&&(c._hasPointLabels=!0),a.marker&&(c._hasPointMarkers=!0));return b},destroy:function(){var c,a=this.series.chart,b=a.hoverPoints;a.pointCount--,b&&(this.setState(),ga(b,this),!b.length)&&(a.hoverPoints=null),this===a.hoverPoint&&this.onMouseOut(),(this.graphic||this.dataLabel)&&($(this),this.destroyElements()),this.legendItem&&a.legend.destroyItem(this);for(c in this)this[c]=null},destroyElements:function(){for(var b,a="graphic,dataLabel,dataLabelUpper,group,connector,shadowGroup".split(","),c=6;c--;)b=a[c],this[b]&&(this[b]=this[b].destroy())},getLabelConfig:function(){return{x:this.category,y:this.y,key:this.name||this.category,series:this.series,point:this,percentage:this.percentage,total:this.total||this.stackTotal}},select:function(a,b){var c=this,d=c.series,e=d.chart,a=o(a,!c.selected);c.firePointEvent(a?"select":"unselect",{accumulate:b},function(){c.selected=c.options.selected=a,d.options.data[pa(c,d.data)]=c.options,c.setState(a&&"select"),b||n(e.getSelectedPoints(),function(a){a.selected&&a!==c&&(a.selected=a.options.selected=!1,d.options.data[pa(a,d.data)]=a.options,a.setState(""),a.firePointEvent("unselect"))})})},onMouseOver:function(a){var b=this.series,c=b.chart,d=c.tooltip,e=c.hoverPoint;e&&e!==this&&e.onMouseOut(),this.firePointEvent("mouseOver"),d&&(!d.shared||b.noSharedTooltip)&&d.refresh(this,a),this.setState("hover"),c.hoverPoint=this},onMouseOut:function(){var a=this.series.chart,b=a.hoverPoints;b&&-1!==pa(this,b)||(this.firePointEvent("mouseOut"),this.setState(),a.hoverPoint=null)},tooltipFormatter:function(a){var b=this.series,c=b.tooltipOptions,d=o(c.valueDecimals,""),e=c.valuePrefix||"",f=c.valueSuffix||"";return n(b.pointArrayMap||["y"],function(b){b="{point."+b,(e||f)&&(a=a.replace(b+"}",e+b+"}"+f)),a=a.replace(b+"}",b+":,."+d+"f}")}),Ca(a,{point:this,series:this.series})},update:function(a,b,c){var g,d=this,e=d.series,f=d.graphic,h=e.data,i=e.chart,j=e.options,b=o(b,!0);d.firePointEvent("update",{options:a},function(){d.applyOptions(a),T(a)&&(e.getAttribs(),f)&&(a&&a.marker&&a.marker.symbol?d.graphic=f.destroy():f.attr(d.pointAttr[d.state||""])),g=pa(d,h),e.xData[g]=d.x,e.yData[g]=e.toYData?e.toYData(d):d.y,e.zData[g]=d.z,j.data[g]=d.options,e.isDirty=e.isDirtyData=!0,!e.fixedBox&&e.hasCartesianSeries&&(i.isDirtyBox=!0),"point"===j.legendType&&i.legend.destroyItem(d),b&&i.redraw(c)})},remove:function(a,b){var g,c=this,d=c.series,e=d.points,f=d.chart,h=d.data;La(b,f),a=o(a,!0),c.firePointEvent("remove",null,function(){g=pa(c,h),h.length===e.length&&e.splice(g,1),h.splice(g,1),d.options.data.splice(g,1),d.xData.splice(g,1),d.yData.splice(g,1),d.zData.splice(g,1),c.destroy(),d.isDirty=!0,d.isDirtyData=!0,a&&f.redraw()})},firePointEvent:function(a,b,c){var d=this,e=this.series.options;(e.point.events[a]||d.options&&d.options.events&&d.options.events[a])&&this.importEvents(),"click"===a&&e.allowPointSelect&&(c=function(a){d.select(null,a.ctrlKey||a.metaKey||a.shiftKey)}),A(this,a,b,c)},importEvents:function(){if(!this.hasImportedEvents){var b,a=x(this.series.options.point,this.options).events;this.events=a;for(b in a)K(this,b,a[b]);this.hasImportedEvents=!0}},setState:function(a){var b=this.plotX,c=this.plotY,d=this.series,e=d.options.states,f=Z[d.type].marker&&d.options.marker,g=f&&!f.enabled,h=f&&f.states[a],i=h&&h.enabled===!1,j=d.stateMarkerGraphic,k=this.marker||{},l=d.chart,m=this.pointAttr,a=a||"";a===this.state||this.selected&&"select"!==a||e[a]&&e[a].enabled===!1||a&&(i||g&&!h.enabled)||a&&k.states&&k.states[a]&&k.states[a].enabled===!1||(this.graphic?(e=f&&this.graphic.symbolName&&m[a].r,this.graphic.attr(x(m[a],e?{x:b-e,y:c-e,width:2*e,height:2*e}:{}))):(a&&h&&(e=h.radius,k=k.symbol||d.symbol,j&&j.currentSymbol!==k&&(j=j.destroy()),j?j.attr({x:b-e,y:c-e}):(d.stateMarkerGraphic=j=l.renderer.symbol(k,b-e,c-e,2*e,2*e).attr(m[a]).add(d.markerGroup),j.currentSymbol=k)),j&&j[a&&l.isInsidePlot(b,c)?"show":"hide"]()),this.state=a)}};var Q=function(){};Q.prototype={isCartesian:!0,type:"line",pointClass:Pa,sorted:!0,requireSorting:!0,pointAttrToOptions:{stroke:"lineColor","stroke-width":"lineWidth",fill:"fillColor",r:"radius"},colorCounter:0,init:function(a,b){var c,d,e=a.series;this.chart=a,this.options=b=this.setOptions(b),this.linkedSeries=[],this.bindAxes(),s(this,{name:b.name,state:"",pointAttr:{},visible:b.visible!==!1,selected:b.selected===!0}),ca&&(b.animation=!1),d=b.events;for(c in d)K(this,c,d[c]);(d&&d.click||b.point&&b.point.events&&b.point.events.click||b.allowPointSelect)&&(a.runTrackerClick=!0),this.getColor(),this.getSymbol(),this.setData(b.data,!1),this.isCartesian&&(a.hasCartesianSeries=!0),e.push(this),this._i=e.length-1,Kb(e,function(a,b){return o(a.options.index,a._i)-o(b.options.index,a._i)}),n(e,function(a,b){a.index=b,a.name=a.name||"Series "+(b+1)})},bindAxes:function(){var d,a=this,b=a.options,c=a.chart;a.isCartesian&&n(["xAxis","yAxis"],function(e){n(c[e],function(c){d=c.options,(b[e]===d.index||b[e]!==v&&b[e]===d.id||b[e]===v&&0===d.index)&&(c.series.push(a),a[e]=c,c.isDirty=!0)}),a[e]||ka(18,!0)})},autoIncrement:function(){var a=this.options,b=this.xIncrement,b=o(b,a.pointStart,0);return this.pointInterval=o(this.pointInterval,a.pointInterval,1),this.xIncrement=b+this.pointInterval,b},getSegments:function(){var c,a=-1,b=[],d=this.points,e=d.length;if(e)if(this.options.connectNulls){for(c=e;c--;)null===d[c].y&&d.splice(c,1);d.length&&(b=[d])}else n(d,function(c,g){null===c.y?(g>a+1&&b.push(d.slice(a+1,g)),a=g):g===e-1&&b.push(d.slice(a+1,g+1))});this.segments=b},setOptions:function(a){var b=this.chart.options,c=b.plotOptions,d=c[this.type];return this.userOptions=a,a=x(d,c.series,a),this.tooltipOptions=x(b.tooltip,a.tooltip),null===d.marker&&delete a.marker,a},getColor:function(){var e,a=this.options,b=this.userOptions,c=this.chart.options.colors,d=this.chart.counters;e=a.color||Z[this.type].color,e||a.colorByPoint||(u(b._colorIndex)?a=b._colorIndex:(b._colorIndex=d.color,a=d.color++),e=c[a]),this.color=e,d.wrapColor(c.length)},getSymbol:function(){var a=this.userOptions,b=this.options.marker,c=this.chart,d=c.options.symbols,c=c.counters;this.symbol=b.symbol,this.symbol||(u(a._symbolIndex)?a=a._symbolIndex:(a._symbolIndex=c.symbol,a=c.symbol++),this.symbol=d[a]),/^url/.test(this.symbol)&&(b.radius=0),c.wrapSymbol(d.length)},drawLegendSymbol:function(a){var e,b=this.options,c=b.marker,d=a.options;e=d.symbolWidth;var f=this.chart.renderer,g=this.legendGroup,a=a.baseline-t(.3*f.fontMetrics(d.itemStyle.fontSize).b);b.lineWidth&&(d={"stroke-width":b.lineWidth},b.dashStyle&&(d.dashstyle=b.dashStyle),this.legendLine=f.path(["M",0,a,"L",e,a]).attr(d).add(g)),c&&c.enabled&&(b=c.radius,this.legendSymbol=e=f.symbol(this.symbol,e/2-b,a-b,2*b,2*b).add(g),e.isMarker=!0)},addPoint:function(a,b,c,d){var r,e=this.options,f=this.data,g=this.graph,h=this.area,i=this.chart,j=this.xData,k=this.yData,l=this.zData,m=this.xAxis&&this.xAxis.names,p=g&&g.shift||0,q=e.data;if(La(d,i),c&&n([g,h,this.graphNeg,this.areaNeg],function(a){a&&(a.shift=p+1)}),h&&(h.isArea=!0),b=o(b,!0),d={series:this},this.pointClass.prototype.applyOptions.apply(d,[a]),g=d.x,h=j.length,this.requireSorting&&g<j[h-1])for(r=!0;h&&j[h-1]>g;)h--;j.splice(h,0,g),k.splice(h,0,this.toYData?this.toYData(d):d.y),l.splice(h,0,d.z),m&&(m[g]=d.name),q.splice(h,0,a),r&&(this.data.splice(h,0,null),this.processData()),"point"===e.legendType&&this.generatePoints(),c&&(f[0]&&f[0].remove?f[0].remove(!1):(f.shift(),j.shift(),k.shift(),l.shift(),q.shift())),this.isDirtyData=this.isDirty=!0,b&&(this.getAttribs(),i.redraw())},setData:function(a,b){var i,c=this.points,d=this.options,e=this.chart,f=null,g=this.xAxis,h=g&&g.names;this.xIncrement=null,this.pointRange=g&&g.categories?1:d.pointRange,this.colorCounter=0;var j=[],k=[],l=[],m=a?a.length:[];i=o(d.turboThreshold,1e3);var p=this.pointArrayMap,p=p&&p.length,q=!!this.toYData;if(i&&m>i){for(i=0;null===f&&m>i;)f=a[i],i++;if(ra(f)){for(h=o(d.pointStart,0),d=o(d.pointInterval,1),i=0;m>i;i++)j[i]=h,k[i]=a[i],h+=d;this.xIncrement=h}else if(Ia(f))if(p)for(i=0;m>i;i++)d=a[i],j[i]=d[0],k[i]=d.slice(1,p+1);else for(i=0;m>i;i++)d=a[i],j[i]=d[0],k[i]=d[1];else ka(12)}else for(i=0;m>i;i++)a[i]!==v&&(d={series:this},this.pointClass.prototype.applyOptions.apply(d,[a[i]]),j[i]=d.x,k[i]=q?this.toYData(d):d.y,l[i]=d.z,h&&d.name)&&(h[d.x]=d.name);for(ea(k[0])&&ka(14,!0),this.data=[],this.options.data=a,this.xData=j,this.yData=k,this.zData=l,i=c&&c.length||0;i--;)c[i]&&c[i].destroy&&c[i].destroy();g&&(g.minRange=g.userMinRange),this.isDirty=this.isDirtyData=e.isDirtyBox=!0,o(b,!0)&&e.redraw(!1)},remove:function(a,b){var c=this,d=c.chart,a=o(a,!0);c.isRemoving||(c.isRemoving=!0,A(c,"remove",null,function(){c.destroy(),d.isDirtyLegend=d.isDirtyBox=!0,d.linkSeries(),a&&d.redraw(b)})),c.isRemoving=!1},processData:function(a){var e,b=this.xData,c=this.yData,d=b.length;e=0;var f,g,h=this.xAxis,i=this.options,j=i.cropThreshold,k=this.isCartesian;if(k&&!this.isDirty&&!h.isDirty&&!this.yAxis.isDirty&&!a)return!1;for(k&&this.sorted&&(!j||d>j||this.forceCrop)&&(a=h.min,h=h.max,b[d-1]<a||b[0]>h?(b=[],c=[]):(b[0]<a||b[d-1]>h)&&(e=this.cropData(this.xData,this.yData,a,h),b=e.xData,c=e.yData,e=e.start,f=!0)),h=b.length-1;h>=0;h--)d=b[h]-b[h-1],d>0&&(g===v||g>d)?g=d:0>d&&this.requireSorting&&ka(15);this.cropped=f,this.cropStart=e,this.processedXData=b,this.processedYData=c,null===i.pointRange&&(this.pointRange=g||1),this.closestPointRange=g},cropData:function(a,b,c,d){var i,e=a.length,f=0,g=e,h=o(this.cropShoulder,1);for(i=0;e>i;i++)if(a[i]>=c){f=r(0,i-h);break}for(;e>i;i++)if(a[i]>d){g=i+h;break}return{xData:a.slice(f,g),yData:b.slice(f,g),start:f,end:g}},generatePoints:function(){var c,i,k,m,a=this.options.data,b=this.data,d=this.processedXData,e=this.processedYData,f=this.pointClass,g=d.length,h=this.cropStart||0,j=this.hasGroupedData,l=[];for(b||j||(b=[],b.length=a.length,b=this.data=b),m=0;g>m;m++)i=h+m,j?l[m]=(new f).init(this,[d[m]].concat(ja(e[m]))):(b[i]?k=b[i]:a[i]!==v&&(b[i]=k=(new f).init(this,a[i],d[m])),l[m]=k);if(b&&(g!==(c=b.length)||j))for(m=0;c>m;m++)m===h&&!j&&(m+=g),b[m]&&(b[m].destroyElements(),b[m].plotX=v);this.data=b,this.points=l},setStackedPoints:function(){if(this.options.stacking&&(this.visible===!0||this.chart.options.chart.ignoreHiddenSeries===!1)){var p,q,o,n,t,a=this.processedXData,b=this.processedYData,c=[],d=b.length,e=this.options,f=e.threshold,g=e.stack,e=e.stacking,h=this.stackKey,i="-"+h,j=this.negStacks,k=this.yAxis,l=k.stacks,m=k.oldStacks;for(o=0;d>o;o++)n=a[o],t=b[o],q=(p=j&&f>t)?i:h,l[q]||(l[q]={}),l[q][n]||(m[q]&&m[q][n]?(l[q][n]=m[q][n],l[q][n].total=null):l[q][n]=new Mb(k,k.options.stackLabels,p,n,g,e)),q=l[q][n],q.points[this.index]=[q.cum||0],"percent"===e?(p=p?h:i,j&&l[p]&&l[p][n]?(p=l[p][n],q.total=p.total=r(p.total,q.total)+M(t)||0):q.total+=M(t)||0):q.total+=t||0,q.cum=(q.cum||0)+(t||0),q.points[this.index].push(q.cum),c[o]=q.cum;"percent"===e&&(k.usePercentage=!0),this.stackedYData=c,k.oldStacks={}}},setPercentStacks:function(){var a=this,b=a.stackKey,c=a.yAxis.stacks;n([b,"-"+b],function(b){for(var d,f,g,e=a.xData.length;e--;)f=a.xData[e],d=(g=c[b]&&c[b][f])&&g.points[a.index],(f=d)&&(g=g.total?100/g.total:0,f[0]=ia(f[0]*g),f[1]=ia(f[1]*g),a.stackedYData[e]=f[1])})},getExtremes:function(){var i,j,k,l,a=this.yAxis,b=this.processedXData,c=this.stackedYData||this.processedYData,d=c.length,e=[],f=0,g=this.xAxis.getExtremes(),h=g.min,g=g.max;for(l=0;d>l;l++)if(j=b[l],k=c[l],i=null!==k&&k!==v&&(!a.isLog||k.length||k>0),j=this.getExtremesFromAll||this.cropped||(b[l+1]||j)>=h&&(b[l-1]||j)<=g,i&&j)if(i=k.length)for(;i--;)null!==k[i]&&(e[f++]=k[i]);else e[f++]=k;this.dataMin=o(void 0,Ja(e)),this.dataMax=o(void 0,ua(e))},translate:function(){this.processedXData||this.processData(),this.generatePoints();for(var a=this.options,b=a.stacking,c=this.xAxis,d=c.categories,e=this.yAxis,f=this.points,g=f.length,h=!!this.modifyValue,i=a.pointPlacement,j="between"===i||ra(i),k=a.threshold,a=0;g>a;a++){var l=f[a],m=l.x,p=l.y,q=l.low,n=e.stacks[(this.negStacks&&k>p?"-":"")+this.stackKey];e.isLog&&0>=p&&(l.y=p=null),l.plotX=c.translate(m,0,0,0,1,i,"flags"===this.type),b&&this.visible&&n&&n[m]&&(n=n[m],p=n.points[this.index],q=p[0],p=p[1],0===q&&(q=o(k,e.min)),e.isLog&&0>=q&&(q=null),l.total=l.stackTotal=n.total,l.percentage="percent"===b&&l.y/n.total*100,l.stackY=p,n.setOffset(this.pointXOffset||0,this.barW||0)),l.yBottom=u(q)?e.translate(q,0,1,0,1):null,h&&(p=this.modifyValue(p,l)),l.plotY="number"==typeof p&&1/0!==p?e.translate(p,0,1,0,1):v,l.clientX=j?c.translate(m,0,0,0,1):l.plotX,l.negative=l.y<(k||0),l.category=d&&d[l.x]!==v?d[l.x]:l.x}this.getSegments()},setTooltipPoints:function(a){var c,d,h,i,b=[],e=this.xAxis,f=e&&e.getExtremes(),g=e?e.tooltipLen||e.len:this.chart.plotSizeX,j=[];if(this.options.enableMouseTracking!==!1){for(a&&(this.tooltipPoints=null),n(this.segments||this.points,function(a){b=b.concat(a)}),e&&e.reversed&&(b=b.reverse()),this.orderTooltipPoints&&this.orderTooltipPoints(b),a=b.length,i=0;a>i;i++)if(e=b[i],c=e.x,c>=f.min&&c<=f.max)for(h=b[i+1],c=d===v?0:d+1,d=b[i+1]?J(r(0,P((e.clientX+(h?h.wrappedClientX||h.clientX:g))/2)),g):g;c>=0&&d>=c;)j[c++]=e;this.tooltipPoints=j}},tooltipHeaderFormatter:function(a){var g,b=this.tooltipOptions,c=b.xDateFormat,d=b.dateTimeLabelFormats,e=this.xAxis,f=e&&"datetime"===e.options.type,b=b.headerFormat,e=e&&e.closestPointRange;if(f&&!c)if(e){for(g in D)if(D[g]>=e){c=d[g];break}}else c=d.day;return f&&c&&ra(a.key)&&(b=b.replace("{point.key}","{point.key:"+c+"}")),Ca(b,{point:a,series:this})},onMouseOver:function(){var a=this.chart,b=a.hoverSeries;b&&b!==this&&b.onMouseOut(),this.options.events.mouseOver&&A(this,"mouseOver"),this.setState("hover"),a.hoverSeries=this},onMouseOut:function(){var a=this.options,b=this.chart,c=b.tooltip,d=b.hoverPoint;d&&d.onMouseOut(),this&&a.events.mouseOut&&A(this,"mouseOut"),c&&!a.stickyTracking&&(!c.shared||this.noSharedTooltip)&&c.hide(),this.setState(),b.hoverSeries=null},animate:function(a){var e,b=this,c=b.chart,d=c.renderer;e=b.options.animation;var h,f=c.clipBox,g=c.inverted;e&&!T(e)&&(e=Z[b.type].animation),h="_sharedClip"+e.duration+e.easing,a?(a=c[h],e=c[h+"m"],a||(c[h]=a=d.clipRect(s(f,{width:0})),c[h+"m"]=e=d.clipRect(-99,g?-c.plotLeft:-c.plotTop,99,g?c.chartWidth:c.chartHeight)),b.group.clip(a),b.markerGroup.clip(e),b.sharedClipKey=h):((a=c[h])&&(a.animate({width:c.plotSizeX},e),c[h+"m"].animate({width:c.plotSizeX+99},e)),b.animate=null,b.animationTimeout=setTimeout(function(){b.afterAnimate()},e.duration))},afterAnimate:function(){var a=this.chart,b=this.sharedClipKey,c=this.group;c&&this.options.clip!==!1&&(c.clip(a.clipRect),this.markerGroup.clip()),setTimeout(function(){b&&a[b]&&(a[b]=a[b].destroy(),a[b+"m"]=a[b+"m"].destroy())},100)},drawPoints:function(){var a,d,e,f,g,h,i,j,k,m,b=this.points,c=this.chart,l=this.options.marker,n=this.markerGroup;if(l.enabled||this._hasPointMarkers)for(f=b.length;f--;)g=b[f],d=P(g.plotX),e=g.plotY,k=g.graphic,i=g.marker||{},a=l.enabled&&i.enabled===v||i.enabled,m=c.isInsidePlot(t(d),e,c.inverted),a&&e!==v&&!isNaN(e)&&null!==g.y?(a=g.pointAttr[g.selected?"select":""],h=a.r,i=o(i.symbol,this.symbol),j=0===i.indexOf("url"),k?k.attr({visibility:m?W?"inherit":"visible":"hidden"}).animate(s({x:d-h,y:e-h},k.symbolName?{width:2*h,height:2*h}:{})):m&&(h>0||j)&&(g.graphic=c.renderer.symbol(i,d-h,e-h,2*h,2*h).attr(a).add(n))):k&&(g.graphic=k.destroy())},convertAttribs:function(a,b,c,d){var f,g,e=this.pointAttrToOptions,h={},a=a||{},b=b||{},c=c||{},d=d||{};for(f in e)g=e[f],h[f]=o(a[g],b[f],c[f],d[f]);return h},getAttribs:function(){var f,k,q,a=this,b=a.options,c=Z[a.type].marker?b.marker:b,d=c.states,e=d.hover,g=a.color,h={stroke:g,fill:g},i=a.points||[],j=[],l=a.pointAttrToOptions,m=b.negativeColor,p=c.lineColor;for(b.marker?(e.radius=e.radius||c.radius+2,e.lineWidth=e.lineWidth||c.lineWidth+1):e.color=e.color||qa(e.color||g).brighten(e.brightness).get(),j[""]=a.convertAttribs(c,h),n(["hover","select"],function(b){j[b]=a.convertAttribs(d[b],j[""])}),a.pointAttr=j,g=i.length;g--;){if(h=i[g],(c=h.options&&h.options.marker||h.options)&&c.enabled===!1&&(c.radius=0),h.negative&&m&&(h.color=h.fillColor=m),f=b.colorByPoint||h.color,h.options)for(q in l)u(c[l[q]])&&(f=!0);f?(c=c||{},k=[],d=c.states||{},f=d.hover=d.hover||{},b.marker||(f.color=qa(f.color||h.color).brighten(f.brightness||e.brightness).get()),k[""]=a.convertAttribs(s({color:h.color,fillColor:h.color,lineColor:null===p?h.color:v},c),j[""]),k.hover=a.convertAttribs(d.hover,j.hover,k[""]),k.select=a.convertAttribs(d.select,j.select,k[""])):k=j,h.pointAttr=k}},update:function(a,b){var f,c=this.chart,d=this.type,e=X[d].prototype,a=x(this.userOptions,{animation:!1,index:this.index,pointStart:this.xData[0]},{data:this.options.data},a);this.remove(!1);for(f in e)e.hasOwnProperty(f)&&(this[f]=v);s(this,X[a.type||d].prototype),this.init(c,a),o(b,!0)&&c.redraw(!1)},destroy:function(){var d,e,g,h,i,a=this,b=a.chart,c=/AppleWebKit\/533/.test(na),f=a.data||[];for(A(a,"destroy"),$(a),n(["xAxis","yAxis"],function(b){(i=a[b])&&(ga(i.series,a),i.isDirty=i.forceRedraw=!0,i.stacks={})}),a.legendItem&&a.chart.legend.destroyItem(a),e=f.length;e--;)(g=f[e])&&g.destroy&&g.destroy();a.points=null,clearTimeout(a.animationTimeout),n("area,graph,dataLabelsGroup,group,markerGroup,tracker,graphNeg,areaNeg,posClip,negClip".split(","),function(b){a[b]&&(d=c&&"group"===b?"hide":"destroy",a[b][d]())}),b.hoverSeries===a&&(b.hoverSeries=null),ga(b.series,a);for(h in a)delete a[h]},drawDataLabels:function(){var e,f,g,h,a=this,b=a.options,c=b.cursor,d=b.dataLabels,b=a.points;(d.enabled||a._hasPointLabels)&&(a.dlProcessOptions&&a.dlProcessOptions(d),h=a.plotGroup("dataLabelsGroup","data-labels",a.visible?"visible":"hidden",d.zIndex||6),f=d,n(b,function(b){var j,l,m,k=b.dataLabel,n=b.connector,q=!0;if(e=b.options&&b.options.dataLabels,j=o(e&&e.enabled,f.enabled),k&&!j)b.dataLabel=k.destroy();else if(j){if(d=x(f,e),j=d.rotation,l=b.getLabelConfig(),g=d.format?Ca(d.format,l):d.formatter.call(l,d),d.style.color=o(d.color,d.style.color,a.color,"black"),k)u(g)?(k.attr({text:g}),q=!1):(b.dataLabel=k=k.destroy(),n&&(b.connector=n.destroy()));else if(u(g)){k={fill:d.backgroundColor,stroke:d.borderColor,"stroke-width":d.borderWidth,r:d.borderRadius||0,rotation:j,padding:d.padding,zIndex:1};for(m in k)k[m]===v&&delete k[m];k=b.dataLabel=a.chart.renderer[j?"text":"label"](g,0,-999,null,null,null,d.useHTML).attr(k).css(s(d.style,c&&{cursor:c})).add(h).shadow(d.shadow)}k&&a.alignDataLabel(b,k,d,null,q)}}))},alignDataLabel:function(a,b,c,d,e){var f=this.chart,g=f.inverted,h=o(a.plotX,-999),i=o(a.plotY,-999),j=b.getBBox();(a=this.visible&&f.isInsidePlot(a.plotX,a.plotY,g))&&(d=s({x:g?f.plotWidth-i:h,y:t(g?f.plotHeight-h:i),width:0,height:0},d),s(c,{width:j.width,height:j.height}),c.rotation?(g={align:c.align,x:d.x+c.x+d.width/2,y:d.y+c.y+d.height/2},b[e?"attr":"animate"](g)):(b.align(c,null,d),g=b.alignAttr,"justify"===o(c.overflow,"justify")?this.justifyDataLabel(b,c,g,j,d,e):o(c.crop,!0)&&(a=f.isInsidePlot(g.x,g.y)&&f.isInsidePlot(g.x+j.width,g.y+j.height)))),a||b.attr({y:-999})},justifyDataLabel:function(a,b,c,d,e,f){var j,k,g=this.chart,h=b.align,i=b.verticalAlign;j=c.x,0>j&&("right"===h?b.align="left":b.x=-j,k=!0),j=c.x+d.width,j>g.plotWidth&&("left"===h?b.align="right":b.x=g.plotWidth-j,k=!0),j=c.y,0>j&&("bottom"===i?b.verticalAlign="top":b.y=-j,k=!0),j=c.y+d.height,j>g.plotHeight&&("top"===i?b.verticalAlign="bottom":b.y=g.plotHeight-j,k=!0),k&&(a.placed=!f,a.align(b,null,e))},getSegmentPath:function(a){var b=this,c=[],d=b.options.step;return n(a,function(e,f){var i,g=e.plotX,h=e.plotY;b.getPointSpline?c.push.apply(c,b.getPointSpline(a,e,f)):(c.push(f?"L":"M"),d&&f&&(i=a[f-1],"right"===d?c.push(i.plotX,h):"center"===d?c.push((i.plotX+g)/2,i.plotY,(i.plotX+g)/2,h):c.push(g,i.plotY)),c.push(e.plotX,e.plotY))}),c},getGraphPath:function(){var c,a=this,b=[],d=[];return n(a.segments,function(e){c=a.getSegmentPath(e),e.length>1?b=b.concat(c):d.push(e[0])}),a.singlePoints=d,a.graphPath=b},drawGraph:function(){var a=this,b=this.options,c=[["graph",b.lineColor||this.color]],d=b.lineWidth,e=b.dashStyle,f="square"!==b.linecap,g=this.getGraphPath(),h=b.negativeColor;h&&c.push(["graphNeg",h]),n(c,function(c,h){var k=c[0],l=a[k];l?(Wa(l),l.animate({d:g})):d&&g.length&&(l={stroke:c[1],"stroke-width":d,zIndex:1},e?l.dashstyle=e:f&&(l["stroke-linecap"]=l["stroke-linejoin"]="round"),a[k]=a.chart.renderer.path(g).attr(l).add(a.group).shadow(!h&&b.shadow))})},clipNeg:function(){var e,a=this.options,b=this.chart,c=b.renderer,d=a.negativeColor||a.negativeFillColor,f=this.graph,g=this.area,h=this.posClip,i=this.negClip;e=b.chartWidth;var j=b.chartHeight,k=r(e,j),l=this.yAxis;d&&(f||g)&&(d=t(l.toPixels(a.threshold||0,!0)),a={x:0,y:0,width:k,height:d},k={x:0,y:d,width:k,height:k},b.inverted&&(a.height=k.y=b.plotWidth-d,c.isVML&&(a={x:b.plotWidth-d-b.plotLeft,y:0,width:e,height:j},k={x:d+b.plotLeft-e,y:0,width:b.plotLeft+d,height:e})),l.reversed?(b=k,e=a):(b=a,e=k),h?(h.animate(b),i.animate(e)):(this.posClip=h=c.clipRect(b),this.negClip=i=c.clipRect(e),f&&this.graphNeg&&(f.clip(h),this.graphNeg.clip(i)),g&&(g.clip(h),this.areaNeg.clip(i))))},invertGroups:function(){function a(){var a={width:b.yAxis.len,height:b.xAxis.len};n(["group","markerGroup"],function(c){b[c]&&b[c].attr(a).invert()})}var b=this,c=b.chart;b.xAxis&&(K(c,"resize",a),K(b,"destroy",function(){$(c,"resize",a)}),a(),b.invertGroups=a)},plotGroup:function(a,b,c,d,e){var f=this[a],g=!f;return g&&(this[a]=f=this.chart.renderer.g(b).attr({visibility:c,zIndex:d||.1}).add(e)),f[g?"attr":"animate"](this.getPlotBox()),f},getPlotBox:function(){return{translateX:this.xAxis?this.xAxis.left:this.chart.plotLeft,translateY:this.yAxis?this.yAxis.top:this.chart.plotTop,scaleX:1,scaleY:1}},render:function(){var b,a=this.chart,c=this.options,d=c.animation&&!!this.animate&&a.renderer.isSVG,e=this.visible?"visible":"hidden",f=c.zIndex,g=this.hasRendered,h=a.seriesGroup;b=this.plotGroup("group","series",e,f,h),this.markerGroup=this.plotGroup("markerGroup","markers",e,f,h),d&&this.animate(!0),this.getAttribs(),b.inverted=this.isCartesian?a.inverted:!1,this.drawGraph&&(this.drawGraph(),this.clipNeg()),this.drawDataLabels(),this.drawPoints(),this.options.enableMouseTracking!==!1&&this.drawTracker(),a.inverted&&this.invertGroups(),c.clip!==!1&&!this.sharedClipKey&&!g&&b.clip(a.clipRect),d?this.animate():g||this.afterAnimate(),this.isDirty=this.isDirtyData=!1,this.hasRendered=!0},redraw:function(){var a=this.chart,b=this.isDirtyData,c=this.group,d=this.xAxis,e=this.yAxis;c&&(a.inverted&&c.attr({width:a.plotWidth,height:a.plotHeight}),c.animate({translateX:o(d&&d.left,a.plotLeft),translateY:o(e&&e.top,a.plotTop)})),this.translate(),this.setTooltipPoints(!0),this.render(),b&&A(this,"updatedData")},setState:function(a){var b=this.options,c=this.graph,d=this.graphNeg,e=b.states,b=b.lineWidth,a=a||"";this.state!==a&&(this.state=a,e[a]&&e[a].enabled===!1||(a&&(b=e[a].lineWidth||b+1),c&&!c.dashstyle&&(a={"stroke-width":b},c.attr(a),d&&d.attr(a))))},setVisible:function(a,b){var f,c=this,d=c.chart,e=c.legendItem,g=d.options.chart.ignoreHiddenSeries,h=c.visible;f=(c.visible=a=c.userOptions.visible=a===v?!h:a)?"show":"hide",n(["group","dataLabelsGroup","markerGroup","tracker"],function(a){c[a]&&c[a][f]()}),d.hoverSeries===c&&c.onMouseOut(),e&&d.legend.colorizeItem(c,a),c.isDirty=!0,c.options.stacking&&n(d.series,function(a){a.options.stacking&&a.visible&&(a.isDirty=!0)}),n(c.linkedSeries,function(b){b.setVisible(a,!1)}),g&&(d.isDirtyBox=!0),b!==!1&&d.redraw(),A(c,f)},show:function(){this.setVisible(!0)},hide:function(){this.setVisible(!1)},select:function(a){this.selected=a=a===v?!this.selected:a,this.checkbox&&(this.checkbox.checked=a),A(this,a?"select":"unselect")},drawTracker:function(){var m,a=this,b=a.options,c=b.trackByArea,d=[].concat(c?a.areaPath:a.graphPath),e=d.length,f=a.chart,g=f.pointer,h=f.renderer,i=f.options.tooltip.snap,j=a.tracker,k=b.cursor,l=k&&{cursor:k},k=a.singlePoints,p=function(){f.hoverSeries!==a&&a.onMouseOver()};if(e&&!c)for(m=e+1;m--;)"M"===d[m]&&d.splice(m+1,0,d[m+1]-i,d[m+2],"L"),(m&&"M"===d[m]||m===e)&&d.splice(m,0,"L",d[m-2]+i,d[m-1]);for(m=0;m<k.length;m++)e=k[m],d.push("M",e.plotX-i,e.plotY,"L",e.plotX+i,e.plotY);j?j.attr({d:d}):(a.tracker=h.path(d).attr({"stroke-linejoin":"round",visibility:a.visible?"visible":"hidden",stroke:Qb,fill:c?Qb:S,"stroke-width":b.lineWidth+(c?0:2*i),zIndex:2}).add(a.group),n([a.tracker,a.markerGroup],function(a){a.addClass("highcharts-tracker").on("mouseover",p).on("mouseout",function(a){g.onTrackerMouseOut(a)}).css(l),jb&&a.on("touchstart",p)}))}},G=ha(Q),X.line=G,Z.area=x(Y,{threshold:0}),G=ha(Q,{type:"area",getSegments:function(){var h,i,l,m,p,a=[],b=[],c=[],d=this.xAxis,e=this.yAxis,f=e.stacks[this.stackKey],g={},j=this.points,k=this.options.connectNulls;if(this.options.stacking&&!this.cropped){for(m=0;m<j.length;m++)g[j[m].x]=j[m];for(p in f)null!==f[p].total&&c.push(+p);c.sort(function(a,b){return a-b}),n(c,function(a){(!k||g[a]&&null!==g[a].y)&&(g[a]?b.push(g[a]):(h=d.translate(a),l=f[a].percent?f[a].total?100*f[a].cum/f[a].total:0:f[a].cum,i=e.toPixels(l,!0),b.push({y:null,plotX:h,clientX:h,plotY:i,yBottom:i,onMouseOver:oa})))}),b.length&&a.push(b)}else Q.prototype.getSegments.call(this),a=this.segments;this.segments=a},getSegmentPath:function(a){var d,b=Q.prototype.getSegmentPath.call(this,a),c=[].concat(b),e=this.options;d=b.length;var g,f=this.yAxis.getThreshold(e.threshold);if(3===d&&c.push("L",b[1],b[2]),e.stacking&&!this.closedStacks)for(d=a.length-1;d>=0;d--)g=o(a[d].yBottom,f),d<a.length-1&&e.step&&c.push(a[d+1].plotX,g),c.push(a[d].plotX,g);else this.closeSegment(c,a,f);return this.areaPath=this.areaPath.concat(c),b},closeSegment:function(a,b,c){a.push("L",b[b.length-1].plotX,c,"L",b[0].plotX,c)},drawGraph:function(){this.areaPath=[],Q.prototype.drawGraph.apply(this);var a=this,b=this.areaPath,c=this.options,d=c.negativeColor,e=c.negativeFillColor,f=[["area",this.color,c.fillColor]];(d||e)&&f.push(["areaNeg",d,e]),n(f,function(d){var e=d[0],f=a[e];f?f.animate({d:b}):a[e]=a.chart.renderer.path(b).attr({fill:o(d[2],qa(d[1]).setOpacity(o(c.fillOpacity,.75)).get()),zIndex:0}).add(a.group)
})},drawLegendSymbol:function(a,b){b.legendSymbol=this.chart.renderer.rect(0,a.baseline-11,a.options.symbolWidth,12,2).attr({zIndex:3}).add(b.legendGroup)}}),X.area=G,Z.spline=x(Y),F=ha(Q,{type:"spline",getPointSpline:function(a,b,c){var h,i,j,k,d=b.plotX,e=b.plotY,f=a[c-1],g=a[c+1];if(f&&g){a=f.plotY,j=g.plotX;var l,g=g.plotY;h=(1.5*d+f.plotX)/2.5,i=(1.5*e+a)/2.5,j=(1.5*d+j)/2.5,k=(1.5*e+g)/2.5,l=(k-i)*(j-d)/(j-h)+e-k,i+=l,k+=l,i>a&&i>e?(i=r(a,e),k=2*e-i):a>i&&e>i&&(i=J(a,e),k=2*e-i),k>g&&k>e?(k=r(g,e),i=2*e-k):g>k&&e>k&&(k=J(g,e),i=2*e-k),b.rightContX=j,b.rightContY=k}return c?(b=["C",f.rightContX||f.plotX,f.rightContY||f.plotY,h||d,i||e,d,e],f.rightContX=f.rightContY=null):b=["M",d,e],b}}),X.spline=F,Z.areaspline=x(Z.area),la=G.prototype,F=ha(F,{type:"areaspline",closedStacks:!0,getSegmentPath:la.getSegmentPath,closeSegment:la.closeSegment,drawGraph:la.drawGraph,drawLegendSymbol:la.drawLegendSymbol}),X.areaspline=F,Z.column=x(Y,{borderColor:"#FFFFFF",borderWidth:1,borderRadius:0,groupPadding:.2,marker:null,pointPadding:.1,minPointLength:0,cropThreshold:50,pointRange:null,states:{hover:{brightness:.1,shadow:!1},select:{color:"#C0C0C0",borderColor:"#000000",shadow:!1}},dataLabels:{align:null,verticalAlign:null,y:null},stickyTracking:!1,threshold:0}),F=ha(Q,{type:"column",pointAttrToOptions:{stroke:"borderColor","stroke-width":"borderWidth",fill:"color",r:"borderRadius"},cropShoulder:0,trackerGroups:["group","dataLabelsGroup"],negStacks:!0,init:function(){Q.prototype.init.apply(this,arguments);var a=this,b=a.chart;b.hasRendered&&n(b.series,function(b){b.type===a.type&&(b.isDirty=!0)})},getColumnMetrics:function(){var f,h,a=this,b=a.options,c=a.xAxis,d=a.yAxis,e=c.reversed,g={},i=0;b.grouping===!1?i=1:n(a.chart.series,function(b){var c=b.options,e=b.yAxis;b.type===a.type&&b.visible&&d.len===e.len&&d.pos===e.pos&&(c.stacking?(f=b.stackKey,g[f]===v&&(g[f]=i++),h=g[f]):c.grouping!==!1&&(h=i++),b.columnIndex=h)});var c=J(M(c.transA)*(c.ordinalSlope||b.pointRange||c.closestPointRange||1),c.len),j=c*b.groupPadding,k=(c-2*j)/i,l=b.pointWidth,b=u(l)?(k-l)/2:k*b.pointPadding,l=o(l,k-2*b);return a.columnMetrics={width:l,offset:b+(j+((e?i-(a.columnIndex||0):a.columnIndex)||0)*k-c/2)*(e?-1:1)}},translate:function(){var a=this.chart,b=this.options,c=b.borderWidth,d=this.yAxis,e=this.translatedThreshold=d.getThreshold(b.threshold),f=o(b.minPointLength,5),b=this.getColumnMetrics(),g=b.width,h=this.barW=wa(r(g,1+2*c)),i=this.pointXOffset=b.offset,j=-(c%2?.5:0),k=c%2?.5:1;a.renderer.isVML&&a.inverted&&(k+=1),Q.prototype.translate.apply(this),n(this.points,function(a){var v,b=o(a.yBottom,e),c=J(r(-999-b,a.plotY),d.len+999+b),n=a.plotX+i,u=h,s=J(c,b),c=r(c,b)-s;M(c)<f&&f&&(c=f,s=t(M(s-e)>f?b-f:e-(d.translate(a.y,0,1,0,1)<=e?f:0))),a.barX=n,a.pointWidth=g,b=M(n)<.5,u=t(n+u)+j,n=t(n)+j,u-=n,v=M(s)<.5,c=t(s+c)+k,s=t(s)+k,c-=s,b&&(n+=1,u-=1),v&&(s-=1,c+=1),a.shapeType="rect",a.shapeArgs={x:n,y:s,width:u,height:c}})},getSymbol:oa,drawLegendSymbol:G.prototype.drawLegendSymbol,drawGraph:oa,drawPoints:function(){var d,a=this,b=a.options,c=a.chart.renderer;n(a.points,function(e){var f=e.plotY,g=e.graphic;f===v||isNaN(f)||null===e.y?g&&(e.graphic=g.destroy()):(d=e.shapeArgs,g?(Wa(g),g.animate(x(d))):e.graphic=c[e.shapeType](d).attr(e.pointAttr[e.selected?"select":""]).add(a.group).shadow(b.shadow,null,b.stacking&&!b.borderRadius))})},drawTracker:function(){var a=this,b=a.chart,c=b.pointer,d=a.options.cursor,e=d&&{cursor:d},f=function(c){var e,d=c.target;for(b.hoverSeries!==a&&a.onMouseOver();d&&!e;)e=d.point,d=d.parentNode;e!==v&&e!==b.hoverPoint&&e.onMouseOver(c)};n(a.points,function(a){a.graphic&&(a.graphic.element.point=a),a.dataLabel&&(a.dataLabel.element.point=a)}),a._hasTracking||(n(a.trackerGroups,function(b){a[b]&&(a[b].addClass("highcharts-tracker").on("mouseover",f).on("mouseout",function(a){c.onTrackerMouseOut(a)}).css(e),jb)&&a[b].on("touchstart",f)}),a._hasTracking=!0)},alignDataLabel:function(a,b,c,d,e){var f=this.chart,g=f.inverted,h=a.dlBox||a.shapeArgs,i=a.below||a.plotY>o(this.translatedThreshold,f.plotSizeY),j=o(c.inside,!!this.options.stacking);h&&(d=x(h),g&&(d={x:f.plotWidth-d.y-d.height,y:f.plotHeight-d.x-d.width,width:d.height,height:d.width}),!j)&&(g?(d.x+=i?0:d.width,d.width=0):(d.y+=i?d.height:0,d.height=0)),c.align=o(c.align,!g||j?"center":i?"right":"left"),c.verticalAlign=o(c.verticalAlign,g||j?"middle":i?"top":"bottom"),Q.prototype.alignDataLabel.call(this,a,b,c,d,e)},animate:function(a){var b=this.yAxis,c=this.options,d=this.chart.inverted,e={};W&&(a?(e.scaleY=.001,a=J(b.pos+b.len,r(b.pos,b.toPixels(c.threshold))),d?e.translateX=a-b.len:e.translateY=a,this.group.attr(e)):(e.scaleY=1,e[d?"translateX":"translateY"]=b.pos,this.group.animate(e,this.options.animation),this.animate=null))},remove:function(){var a=this,b=a.chart;b.hasRendered&&n(b.series,function(b){b.type===a.type&&(b.isDirty=!0)}),Q.prototype.remove.apply(a,arguments)}}),X.column=F,Z.bar=x(Z.column),la=ha(F,{type:"bar",inverted:!0}),X.bar=la,Z.scatter=x(Y,{lineWidth:0,tooltip:{headerFormat:'<span style="font-size: 10px; color:{series.color}">{series.name}</span><br/>',pointFormat:"x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>",followPointer:!0},stickyTracking:!1}),la=ha(Q,{type:"scatter",sorted:!1,requireSorting:!1,noSharedTooltip:!0,trackerGroups:["markerGroup"],takeOrdinalPosition:!1,drawTracker:F.prototype.drawTracker,setTooltipPoints:oa}),X.scatter=la,Z.pie=x(Y,{borderColor:"#FFFFFF",borderWidth:1,center:[null,null],clip:!1,colorByPoint:!0,dataLabels:{distance:30,enabled:!0,formatter:function(){return this.point.name}},ignoreHiddenPoint:!0,legendType:"point",marker:null,size:null,showInLegend:!1,slicedOffset:10,states:{hover:{brightness:.1,shadow:!1}},stickyTracking:!1,tooltip:{followPointer:!0}}),Y={type:"pie",isCartesian:!1,pointClass:ha(Pa,{init:function(){Pa.prototype.init.apply(this,arguments);var b,a=this;return a.y<0&&(a.y=null),s(a,{visible:a.visible!==!1,name:o(a.name,"Slice")}),b=function(b){a.slice("select"===b.type)},K(a,"select",b),K(a,"unselect",b),a},setVisible:function(a){var e,b=this,c=b.series,d=c.chart;b.visible=b.options.visible=a=a===v?!b.visible:a,c.options.data[pa(b,c.data)]=b.options,e=a?"show":"hide",n(["graphic","dataLabel","connector","shadowGroup"],function(a){b[a]&&b[a][e]()}),b.legendItem&&d.legend.colorizeItem(b,a),!c.isDirty&&c.options.ignoreHiddenPoint&&(c.isDirty=!0,d.redraw())},slice:function(a,b,c){var d=this.series;La(c,d.chart),o(b,!0),this.sliced=this.options.sliced=a=u(a)?a:!this.sliced,d.options.data[pa(this,d.data)]=this.options,a=a?this.slicedTranslation:{translateX:0,translateY:0},this.graphic.animate(a),this.shadowGroup&&this.shadowGroup.animate(a)}}),requireSorting:!1,noSharedTooltip:!0,trackerGroups:["group","dataLabelsGroup"],pointAttrToOptions:{stroke:"borderColor","stroke-width":"borderWidth",fill:"color"},getColor:oa,animate:function(a){var b=this,c=b.points,d=b.startAngleRad;a||(n(c,function(a){var c=a.graphic,a=a.shapeArgs;c&&(c.attr({r:b.center[3]/2,start:d,end:d}),c.animate({r:a.r,start:a.start,end:a.end},b.options.animation))}),b.animate=null)},setData:function(a,b){Q.prototype.setData.call(this,a,!1),this.processData(),this.generatePoints(),o(b,!0)&&this.chart.redraw()},generatePoints:function(){var a,c,d,e,b=0,f=this.options.ignoreHiddenPoint;for(Q.prototype.generatePoints.call(this),c=this.points,d=c.length,a=0;d>a;a++)e=c[a],b+=f&&!e.visible?0:e.y;for(this.total=b,a=0;d>a;a++)e=c[a],e.percentage=b>0?e.y/b*100:0,e.total=b},getCenter:function(){var d,h,a=this.options,b=this.chart,c=2*(a.slicedOffset||0),e=b.plotWidth-2*c,f=b.plotHeight-2*c,b=a.center,a=[o(b[0],"50%"),o(b[1],"50%"),a.size||"100%",a.innerSize||0],g=J(e,f);return Na(a,function(a,b){return h=/%$/.test(a),d=2>b||2===b&&h,(h?[e,f,g,g][b]*y(a)/100:a)+(d?c:0)})},translate:function(a){this.generatePoints();var f,g,h,m,o,b=0,c=this.options,d=c.slicedOffset,e=d+c.borderWidth,i=c.startAngle||0,j=this.startAngleRad=xa/180*(i-90),i=(this.endAngleRad=xa/180*((c.endAngle||i+360)-90))-j,k=this.points,l=c.dataLabels.distance,c=c.ignoreHiddenPoint,n=k.length;for(a||(this.center=a=this.getCenter()),this.getX=function(b,c){return h=R.asin((b-a[1])/(a[2]/2+l)),a[0]+(c?-1:1)*V(h)*(a[2]/2+l)},m=0;n>m;m++)o=k[m],f=j+b*i,(!c||o.visible)&&(b+=o.percentage/100),g=j+b*i,o.shapeType="arc",o.shapeArgs={x:a[0],y:a[1],r:a[2]/2,innerR:a[3]/2,start:t(1e3*f)/1e3,end:t(1e3*g)/1e3},h=(g+f)/2,h>.75*i&&(h-=2*xa),o.slicedTranslation={translateX:t(V(h)*d),translateY:t(ba(h)*d)},f=V(h)*a[2]/2,g=ba(h)*a[2]/2,o.tooltipPos=[a[0]+.7*f,a[1]+.7*g],o.half=-xa/2>h||h>xa/2?1:0,o.angle=h,e=J(e,l/2),o.labelPos=[a[0]+f+V(h)*l,a[1]+g+ba(h)*l,a[0]+f+V(h)*e,a[1]+g+ba(h)*e,a[0]+f,a[1]+g,0>l?"center":o.half?"right":"left",h]},setTooltipPoints:oa,drawGraph:null,drawPoints:function(){var c,d,f,g,a=this,b=a.chart.renderer,e=a.options.shadow;e&&!a.shadowGroup&&(a.shadowGroup=b.g("shadow").add(a.group)),n(a.points,function(h){d=h.graphic,g=h.shapeArgs,f=h.shadowGroup,e&&!f&&(f=h.shadowGroup=b.g("shadow").add(a.shadowGroup)),c=h.sliced?h.slicedTranslation:{translateX:0,translateY:0},f&&f.attr(c),d?d.animate(s(g,c)):h.graphic=d=b.arc(g).setRadialReference(a.center).attr(h.pointAttr[h.selected?"select":""]).attr({"stroke-linejoin":"round"}).attr(c).add(a.group).shadow(e,f),h.visible===!1&&h.setVisible(!1)})},sortByAngle:function(a,b){a.sort(function(a,d){return void 0!==a.angle&&(d.angle-a.angle)*b})},drawDataLabels:function(){var c,i,j,s,v,w,x,z,A,E,H,C,a=this,b=a.data,d=a.chart,e=a.options.dataLabels,f=o(e.connectorPadding,10),g=o(e.connectorWidth,1),h=d.plotWidth,d=d.plotHeight,k=o(e.softConnector,!0),l=e.distance,m=a.center,p=m[2]/2,q=m[1],u=l>0,y=[[],[]],D=[0,0,0,0],J=function(a,b){return b.y-a.y};if(a.visible&&(e.enabled||a._hasPointLabels)){for(Q.prototype.drawDataLabels.apply(a),n(b,function(a){a.dataLabel&&y[a.half].push(a)}),H=0;!x&&b[H];)x=b[H]&&b[H].dataLabel&&(b[H].dataLabel.getBBox().height||21),H++;for(H=2;H--;){var F,b=[],I=[],G=y[H],K=G.length;if(a.sortByAngle(G,H-.5),l>0){for(C=q-p-l;q+p+l>=C;C+=x)b.push(C);if(v=b.length,K>v){for(c=[].concat(G),c.sort(J),C=K;C--;)c[C].rank=C;for(C=K;C--;)G[C].rank>=v&&G.splice(C,1);K=G.length}for(C=0;K>C;C++){c=G[C],w=c.labelPos,c=9999;var N,L;for(L=0;v>L;L++)N=M(b[L]-w[1]),c>N&&(c=N,F=L);if(C>F&&null!==b[C])F=C;else for(K-C+F>v&&null!==b[C]&&(F=v-K+C);null===b[F];)F++;I.push({i:F,y:b[F]}),b[F]=null}I.sort(J)}for(C=0;K>C;C++)c=G[C],w=c.labelPos,s=c.dataLabel,E=c.visible===!1?"hidden":"visible",c=w[1],l>0?(v=I.pop(),F=v.i,A=v.y,(c>A&&null!==b[F+1]||A>c&&null!==b[F-1])&&(A=c)):A=c,z=e.justify?m[0]+(H?-1:1)*(p+l):a.getX(0===F||F===b.length-1?c:A,H),s._attr={visibility:E,align:w[6]},s._pos={x:z+e.x+({left:f,right:-f}[w[6]]||0),y:A+e.y-10},s.connX=z,s.connY=A,null===this.options.size&&(v=s.width,f>z-v?D[3]=r(t(v-z+f),D[3]):z+v>h-f&&(D[1]=r(t(z+v-h+f),D[1])),0>A-x/2?D[0]=r(t(-A+x/2),D[0]):A+x/2>d&&(D[2]=r(t(A+x/2-d),D[2])))}(0===ua(D)||this.verifyDataLabelOverflow(D))&&(this.placeDataLabels(),u&&g&&n(this.points,function(b){i=b.connector,w=b.labelPos,(s=b.dataLabel)&&s._pos?(E=s._attr.visibility,z=s.connX,A=s.connY,j=k?["M",z+("left"===w[6]?5:-5),A,"C",z,A,2*w[2]-w[4],2*w[3]-w[5],w[2],w[3],"L",w[4],w[5]]:["M",z+("left"===w[6]?5:-5),A,"L",w[2],w[3],"L",w[4],w[5]],i?(i.animate({d:j}),i.attr("visibility",E)):b.connector=i=a.chart.renderer.path(j).attr({"stroke-width":g,stroke:e.connectorColor||b.color||"#606060",visibility:E}).add(a.group)):i&&(b.connector=i.destroy())}))}},verifyDataLabelOverflow:function(a){var f,b=this.center,c=this.options,d=c.center,e=c=c.minSize||80;return null!==d[0]?e=r(b[2]-r(a[1],a[3]),c):(e=r(b[2]-a[1]-a[3],c),b[0]+=(a[3]-a[1])/2),null!==d[1]?e=r(J(e,b[2]-r(a[0],a[2])),c):(e=r(J(e,b[2]-a[0]-a[2]),c),b[1]+=(a[0]-a[2])/2),e<b[2]?(b[2]=e,this.translate(b),n(this.points,function(a){a.dataLabel&&(a.dataLabel._pos=null)}),this.drawDataLabels()):f=!0,f},placeDataLabels:function(){n(this.points,function(a){var b,a=a.dataLabel;a&&((b=a._pos)?(a.attr(a._attr),a[a.moved?"animate":"attr"](b),a.moved=!0):a&&a.attr({y:-999}))})},alignDataLabel:oa,drawTracker:F.prototype.drawTracker,drawLegendSymbol:G.prototype.drawLegendSymbol,getSymbol:oa},Y=ha(Q,Y),X.pie=Y,s(Highcharts,{Axis:eb,Chart:yb,Color:qa,Legend:fb,Pointer:xb,Point:Pa,Tick:Ma,Tooltip:wb,Renderer:Va,Series:Q,SVGElement:va,SVGRenderer:za,arrayMin:Ja,arrayMax:ua,charts:Ga,dateFormat:Ya,format:Ca,pathAnim:Ab,getOptions:function(){return L},hasBidiBug:Ub,isTouchDevice:Ob,numberFormat:Aa,seriesTypes:X,setOptions:function(a){return L=x(L,a),Lb(),L},addEvent:K,removeEvent:$,createElement:U,discardElement:Ta,css:I,each:n,extend:s,map:Na,merge:x,pick:o,splat:ja,extendClass:ha,pInt:y,wrap:mb,svg:W,canvas:ca,vml:!W&&!ca,product:"Highcharts",version:"3.0.7"})}(),function(window,document,$,undefined){"use strict";var H=$("html"),W=$(window),D=$(document),F=$.fancybox=function(){F.open.apply(this,arguments)},IE=navigator.userAgent.match(/msie/i),didUpdate=null,isTouch=document.createTouch!==undefined,isQuery=function(obj){return obj&&obj.hasOwnProperty&&obj instanceof $},isString=function(str){return str&&"string"===$.type(str)},isPercentage=function(str){return isString(str)&&str.indexOf("%")>0},isScrollable=function(el){return el&&!(el.style.overflow&&"hidden"===el.style.overflow)&&(el.clientWidth&&el.scrollWidth>el.clientWidth||el.clientHeight&&el.scrollHeight>el.clientHeight)},getScalar=function(orig,dim){var value=parseInt(orig,10)||0;return dim&&isPercentage(orig)&&(value=F.getViewport()[dim]/100*value),Math.ceil(value)},getValue=function(value,dim){return getScalar(value,dim)+"px"};$.extend(F,{version:"2.1.5",defaults:{padding:15,margin:20,width:800,height:600,minWidth:100,minHeight:100,maxWidth:9999,maxHeight:9999,pixelRatio:1,autoSize:!0,autoHeight:!1,autoWidth:!1,autoResize:!0,autoCenter:!isTouch,fitToView:!0,aspectRatio:!1,topRatio:.5,leftRatio:.5,scrolling:"auto",wrapCSS:"",arrows:!0,closeBtn:!0,closeClick:!1,nextClick:!1,mouseWheel:!0,autoPlay:!1,playSpeed:3e3,preload:3,modal:!1,loop:!0,ajax:{dataType:"html",headers:{"X-fancyBox":!0}},iframe:{scrolling:"auto",preload:!0},swf:{wmode:"transparent",allowfullscreen:"true",allowscriptaccess:"always"},keys:{next:{13:"left",34:"up",39:"left",40:"up"},prev:{8:"right",33:"down",37:"right",38:"down"},close:[27],play:[32],toggle:[70]},direction:{next:"left",prev:"right"},scrollOutside:!0,index:0,type:null,href:null,content:null,title:null,tpl:{wrap:'<div class="fancybox-wrap" tabIndex="-1"><div class="fancybox-skin"><div class="fancybox-outer"><div class="fancybox-inner"></div></div></div></div>',image:'<img class="fancybox-image" src="{href}" alt="" />',iframe:'<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen'+(IE?' allowtransparency="true"':"")+"></iframe>",error:'<p class="fancybox-error">The requested content cannot be loaded.<br/>Please try again later.</p>',closeBtn:'<a title="Close" class="fancybox-item fancybox-close" href="javascript:;"></a>',next:'<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>',prev:'<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>'},openEffect:"fade",openSpeed:250,openEasing:"swing",openOpacity:!0,openMethod:"zoomIn",closeEffect:"fade",closeSpeed:250,closeEasing:"swing",closeOpacity:!0,closeMethod:"zoomOut",nextEffect:"elastic",nextSpeed:250,nextEasing:"swing",nextMethod:"changeIn",prevEffect:"elastic",prevSpeed:250,prevEasing:"swing",prevMethod:"changeOut",helpers:{overlay:!0,title:!0},onCancel:$.noop,beforeLoad:$.noop,afterLoad:$.noop,beforeShow:$.noop,afterShow:$.noop,beforeChange:$.noop,beforeClose:$.noop,afterClose:$.noop},group:{},opts:{},previous:null,coming:null,current:null,isActive:!1,isOpen:!1,isOpened:!1,wrap:null,skin:null,outer:null,inner:null,player:{timer:null,isActive:!1},ajaxLoad:null,imgPreload:null,transitions:{},helpers:{},open:function(group,opts){return group&&($.isPlainObject(opts)||(opts={}),!1!==F.close(!0))?($.isArray(group)||(group=isQuery(group)?$(group).get():[group]),$.each(group,function(i,element){var href,title,content,type,rez,hrefParts,selector,obj={};"object"===$.type(element)&&(element.nodeType&&(element=$(element)),isQuery(element)?(obj={href:element.data("fancybox-href")||element.attr("href"),title:element.data("fancybox-title")||element.attr("title"),isDom:!0,element:element},$.metadata&&$.extend(!0,obj,element.metadata())):obj=element),href=opts.href||obj.href||(isString(element)?element:null),title=opts.title!==undefined?opts.title:obj.title||"",content=opts.content||obj.content,type=content?"html":opts.type||obj.type,!type&&obj.isDom&&(type=element.data("fancybox-type"),type||(rez=element.prop("class").match(/fancybox\.(\w+)/),type=rez?rez[1]:null)),isString(href)&&(type||(F.isImage(href)?type="image":F.isSWF(href)?type="swf":"#"===href.charAt(0)?type="inline":isString(element)&&(type="html",content=element)),"ajax"===type&&(hrefParts=href.split(/\s+/,2),href=hrefParts.shift(),selector=hrefParts.shift())),content||("inline"===type?href?content=$(isString(href)?href.replace(/.*(?=#[^\s]+$)/,""):href):obj.isDom&&(content=element):"html"===type?content=href:type||href||!obj.isDom||(type="inline",content=element)),$.extend(obj,{href:href,type:type,content:content,title:title,selector:selector}),group[i]=obj}),F.opts=$.extend(!0,{},F.defaults,opts),opts.keys!==undefined&&(F.opts.keys=opts.keys?$.extend({},F.defaults.keys,opts.keys):!1),F.group=group,F._start(F.opts.index)):void 0},cancel:function(){var coming=F.coming;coming&&!1!==F.trigger("onCancel")&&(F.hideLoading(),F.ajaxLoad&&F.ajaxLoad.abort(),F.ajaxLoad=null,F.imgPreload&&(F.imgPreload.onload=F.imgPreload.onerror=null),coming.wrap&&coming.wrap.stop(!0,!0).trigger("onReset").remove(),F.coming=null,F.current||F._afterZoomOut(coming))},close:function(event){F.cancel(),!1!==F.trigger("beforeClose")&&(F.unbindEvents(),F.isActive&&(F.isOpen&&event!==!0?(F.isOpen=F.isOpened=!1,F.isClosing=!0,$(".fancybox-item, .fancybox-nav").remove(),F.wrap.stop(!0,!0).removeClass("fancybox-opened"),F.transitions[F.current.closeMethod]()):($(".fancybox-wrap").stop(!0).trigger("onReset").remove(),F._afterZoomOut())))},play:function(action){var clear=function(){clearTimeout(F.player.timer)},set=function(){clear(),F.current&&F.player.isActive&&(F.player.timer=setTimeout(F.next,F.current.playSpeed))},stop=function(){clear(),D.unbind(".player"),F.player.isActive=!1,F.trigger("onPlayEnd")},start=function(){F.current&&(F.current.loop||F.current.index<F.group.length-1)&&(F.player.isActive=!0,D.bind({"onCancel.player beforeClose.player":stop,"onUpdate.player":set,"beforeLoad.player":clear}),set(),F.trigger("onPlayStart"))};action===!0||!F.player.isActive&&action!==!1?start():stop()},next:function(direction){var current=F.current;current&&(isString(direction)||(direction=current.direction.next),F.jumpto(current.index+1,direction,"next"))},prev:function(direction){var current=F.current;current&&(isString(direction)||(direction=current.direction.prev),F.jumpto(current.index-1,direction,"prev"))},jumpto:function(index,direction,router){var current=F.current;current&&(index=getScalar(index),F.direction=direction||current.direction[index>=current.index?"next":"prev"],F.router=router||"jumpto",current.loop&&(0>index&&(index=current.group.length+index%current.group.length),index%=current.group.length),current.group[index]!==undefined&&(F.cancel(),F._start(index)))},reposition:function(e,onlyAbsolute){var pos,current=F.current,wrap=current?current.wrap:null;wrap&&(pos=F._getPosition(onlyAbsolute),e&&"scroll"===e.type?(delete pos.position,wrap.stop(!0,!0).animate(pos,200)):(wrap.css(pos),current.pos=$.extend({},current.dim,pos)))},update:function(e){var type=e&&e.type,anyway=!type||"orientationchange"===type;anyway&&(clearTimeout(didUpdate),didUpdate=null),F.isOpen&&!didUpdate&&(didUpdate=setTimeout(function(){var current=F.current;current&&!F.isClosing&&(F.wrap.removeClass("fancybox-tmp"),(anyway||"load"===type||"resize"===type&&current.autoResize)&&F._setDimension(),"scroll"===type&&current.canShrink||F.reposition(e),F.trigger("onUpdate"),didUpdate=null)},anyway&&!isTouch?0:300))},toggle:function(action){F.isOpen&&(F.current.fitToView="boolean"===$.type(action)?action:!F.current.fitToView,isTouch&&(F.wrap.removeAttr("style").addClass("fancybox-tmp"),F.trigger("onUpdate")),F.update())},hideLoading:function(){D.unbind(".loading"),$("#fancybox-loading").remove()},showLoading:function(){var el,viewport;F.hideLoading(),el=$('<div id="fancybox-loading"><div></div></div>').click(F.cancel).appendTo("body"),D.bind("keydown.loading",function(e){27===(e.which||e.keyCode)&&(e.preventDefault(),F.cancel())}),F.defaults.fixed||(viewport=F.getViewport(),el.css({position:"absolute",top:.5*viewport.h+viewport.y,left:.5*viewport.w+viewport.x}))},getViewport:function(){var locked=F.current&&F.current.locked||!1,rez={x:W.scrollLeft(),y:W.scrollTop()};return locked?(rez.w=locked[0].clientWidth,rez.h=locked[0].clientHeight):(rez.w=isTouch&&window.innerWidth?window.innerWidth:W.width(),rez.h=isTouch&&window.innerHeight?window.innerHeight:W.height()),rez},unbindEvents:function(){F.wrap&&isQuery(F.wrap)&&F.wrap.unbind(".fb"),D.unbind(".fb"),W.unbind(".fb")},bindEvents:function(){var keys,current=F.current;current&&(W.bind("orientationchange.fb"+(isTouch?"":" resize.fb")+(current.autoCenter&&!current.locked?" scroll.fb":""),F.update),keys=current.keys,keys&&D.bind("keydown.fb",function(e){var code=e.which||e.keyCode,target=e.target||e.srcElement;return 27===code&&F.coming?!1:(e.ctrlKey||e.altKey||e.shiftKey||e.metaKey||target&&(target.type||$(target).is("[contenteditable]"))||$.each(keys,function(i,val){return current.group.length>1&&val[code]!==undefined?(F[i](val[code]),e.preventDefault(),!1):$.inArray(code,val)>-1?(F[i](),e.preventDefault(),!1):void 0}),void 0)}),$.fn.mousewheel&&current.mouseWheel&&F.wrap.bind("mousewheel.fb",function(e,delta,deltaX,deltaY){for(var target=e.target||null,parent=$(target),canScroll=!1;parent.length&&!(canScroll||parent.is(".fancybox-skin")||parent.is(".fancybox-wrap"));)canScroll=isScrollable(parent[0]),parent=$(parent).parent();0===delta||canScroll||F.group.length>1&&!current.canShrink&&(deltaY>0||deltaX>0?F.prev(deltaY>0?"down":"left"):(0>deltaY||0>deltaX)&&F.next(0>deltaY?"up":"right"),e.preventDefault())}))},trigger:function(event,o){var ret,obj=o||F.coming||F.current;if(obj){if($.isFunction(obj[event])&&(ret=obj[event].apply(obj,Array.prototype.slice.call(arguments,1))),ret===!1)return!1;obj.helpers&&$.each(obj.helpers,function(helper,opts){opts&&F.helpers[helper]&&$.isFunction(F.helpers[helper][event])&&F.helpers[helper][event]($.extend(!0,{},F.helpers[helper].defaults,opts),obj)}),D.trigger(event)}},isImage:function(str){return isString(str)&&str.match(/(^data:image\/.*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg)((\?|#).*)?$)/i)},isSWF:function(str){return isString(str)&&str.match(/\.(swf)((\?|#).*)?$/i)},_start:function(index){var obj,href,type,margin,padding,coming={};if(index=getScalar(index),obj=F.group[index]||null,!obj)return!1;if(coming=$.extend(!0,{},F.opts,obj),margin=coming.margin,padding=coming.padding,"number"===$.type(margin)&&(coming.margin=[margin,margin,margin,margin]),"number"===$.type(padding)&&(coming.padding=[padding,padding,padding,padding]),coming.modal&&$.extend(!0,coming,{closeBtn:!1,closeClick:!1,nextClick:!1,arrows:!1,mouseWheel:!1,keys:null,helpers:{overlay:{closeClick:!1}}}),coming.autoSize&&(coming.autoWidth=coming.autoHeight=!0),"auto"===coming.width&&(coming.autoWidth=!0),"auto"===coming.height&&(coming.autoHeight=!0),coming.group=F.group,coming.index=index,F.coming=coming,!1===F.trigger("beforeLoad"))return F.coming=null,void 0;if(type=coming.type,href=coming.href,!type)return F.coming=null,F.current&&F.router&&"jumpto"!==F.router?(F.current.index=index,F[F.router](F.direction)):!1;if(F.isActive=!0,("image"===type||"swf"===type)&&(coming.autoHeight=coming.autoWidth=!1,coming.scrolling="visible"),"image"===type&&(coming.aspectRatio=!0),"iframe"===type&&isTouch&&(coming.scrolling="scroll"),coming.wrap=$(coming.tpl.wrap).addClass("fancybox-"+(isTouch?"mobile":"desktop")+" fancybox-type-"+type+" fancybox-tmp "+coming.wrapCSS).appendTo(coming.parent||"body"),$.extend(coming,{skin:$(".fancybox-skin",coming.wrap),outer:$(".fancybox-outer",coming.wrap),inner:$(".fancybox-inner",coming.wrap)}),$.each(["Top","Right","Bottom","Left"],function(i,v){coming.skin.css("padding"+v,getValue(coming.padding[i]))}),F.trigger("onReady"),"inline"===type||"html"===type){if(!coming.content||!coming.content.length)return F._error("content")}else if(!href)return F._error("href");"image"===type?F._loadImage():"ajax"===type?F._loadAjax():"iframe"===type?F._loadIframe():F._afterLoad()},_error:function(type){$.extend(F.coming,{type:"html",autoWidth:!0,autoHeight:!0,minWidth:0,minHeight:0,scrolling:"no",hasError:type,content:F.coming.tpl.error}),F._afterLoad()},_loadImage:function(){var img=F.imgPreload=new Image;img.onload=function(){this.onload=this.onerror=null,F.coming.width=this.width/F.opts.pixelRatio,F.coming.height=this.height/F.opts.pixelRatio,F._afterLoad()},img.onerror=function(){this.onload=this.onerror=null,F._error("image")},img.src=F.coming.href,img.complete!==!0&&F.showLoading()},_loadAjax:function(){var coming=F.coming;F.showLoading(),F.ajaxLoad=$.ajax($.extend({},coming.ajax,{url:coming.href,error:function(jqXHR,textStatus){F.coming&&"abort"!==textStatus?F._error("ajax",jqXHR):F.hideLoading()},success:function(data,textStatus){"success"===textStatus&&(coming.content=data,F._afterLoad())}}))},_loadIframe:function(){var coming=F.coming,iframe=$(coming.tpl.iframe.replace(/\{rnd\}/g,(new Date).getTime())).attr("scrolling",isTouch?"auto":coming.iframe.scrolling).attr("src",coming.href);$(coming.wrap).bind("onReset",function(){try{$(this).find("iframe").hide().attr("src","//about:blank").end().empty()}catch(e){}}),coming.iframe.preload&&(F.showLoading(),iframe.one("load",function(){$(this).data("ready",1),isTouch||$(this).bind("load.fb",F.update),$(this).parents(".fancybox-wrap").width("100%").removeClass("fancybox-tmp").show(),F._afterLoad()})),coming.content=iframe.appendTo(coming.inner),coming.iframe.preload||F._afterLoad()},_preloadImages:function(){var item,i,group=F.group,current=F.current,len=group.length,cnt=current.preload?Math.min(current.preload,len-1):0;for(i=1;cnt>=i;i+=1)item=group[(current.index+i)%len],"image"===item.type&&item.href&&((new Image).src=item.href)},_afterLoad:function(){var current,content,type,scrolling,href,embed,coming=F.coming,previous=F.current,placeholder="fancybox-placeholder";if(F.hideLoading(),coming&&F.isActive!==!1){if(!1===F.trigger("afterLoad",coming,previous))return coming.wrap.stop(!0).trigger("onReset").remove(),F.coming=null,void 0;switch(previous&&(F.trigger("beforeChange",previous),previous.wrap.stop(!0).removeClass("fancybox-opened").find(".fancybox-item, .fancybox-nav").remove()),F.unbindEvents(),current=coming,content=coming.content,type=coming.type,scrolling=coming.scrolling,$.extend(F,{wrap:current.wrap,skin:current.skin,outer:current.outer,inner:current.inner,current:current,previous:previous}),href=current.href,type){case"inline":case"ajax":case"html":current.selector?content=$("<div>").html(content).find(current.selector):isQuery(content)&&(content.data(placeholder)||content.data(placeholder,$('<div class="'+placeholder+'"></div>').insertAfter(content).hide()),content=content.show().detach(),current.wrap.bind("onReset",function(){$(this).find(content).length&&content.hide().replaceAll(content.data(placeholder)).data(placeholder,!1)}));break;case"image":content=current.tpl.image.replace("{href}",href);break;case"swf":content='<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="'+href+'"></param>',embed="",$.each(current.swf,function(name,val){content+='<param name="'+name+'" value="'+val+'"></param>',embed+=" "+name+'="'+val+'"'}),content+='<embed src="'+href+'" type="application/x-shockwave-flash" width="100%" height="100%"'+embed+"></embed></object>"}isQuery(content)&&content.parent().is(current.inner)||current.inner.append(content),F.trigger("beforeShow"),current.inner.css("overflow","yes"===scrolling?"scroll":"no"===scrolling?"hidden":scrolling),F._setDimension(),F.reposition(),F.isOpen=!1,F.coming=null,F.bindEvents(),F.isOpened?previous.prevMethod&&F.transitions[previous.prevMethod]():$(".fancybox-wrap").not(current.wrap).stop(!0).trigger("onReset").remove(),F.transitions[F.isOpened?current.nextMethod:current.openMethod](),F._preloadImages()}},_setDimension:function(){var wPadding,hPadding,wSpace,hSpace,origWidth,origHeight,origMaxWidth,origMaxHeight,ratio,width_,height_,maxWidth_,maxHeight_,iframe,body,viewport=F.getViewport(),steps=0,canShrink=!1,canExpand=!1,wrap=F.wrap,skin=F.skin,inner=F.inner,current=F.current,width=current.width,height=current.height,minWidth=current.minWidth,minHeight=current.minHeight,maxWidth=current.maxWidth,maxHeight=current.maxHeight,scrolling=current.scrolling,scrollOut=current.scrollOutside?current.scrollbarWidth:0,margin=current.margin,wMargin=getScalar(margin[1]+margin[3]),hMargin=getScalar(margin[0]+margin[2]);if(wrap.add(skin).add(inner).width("auto").height("auto").removeClass("fancybox-tmp"),wPadding=getScalar(skin.outerWidth(!0)-skin.width()),hPadding=getScalar(skin.outerHeight(!0)-skin.height()),wSpace=wMargin+wPadding,hSpace=hMargin+hPadding,origWidth=isPercentage(width)?(viewport.w-wSpace)*getScalar(width)/100:width,origHeight=isPercentage(height)?(viewport.h-hSpace)*getScalar(height)/100:height,"iframe"===current.type){if(iframe=current.content,current.autoHeight&&1===iframe.data("ready"))try{iframe[0].contentWindow.document.location&&(inner.width(origWidth).height(9999),body=iframe.contents().find("body"),scrollOut&&body.css("overflow-x","hidden"),origHeight=body.outerHeight(!0))}catch(e){}}else(current.autoWidth||current.autoHeight)&&(inner.addClass("fancybox-tmp"),current.autoWidth||inner.width(origWidth),current.autoHeight||inner.height(origHeight),current.autoWidth&&(origWidth=inner.width()),current.autoHeight&&(origHeight=inner.height()),inner.removeClass("fancybox-tmp"));if(width=getScalar(origWidth),height=getScalar(origHeight),ratio=origWidth/origHeight,minWidth=getScalar(isPercentage(minWidth)?getScalar(minWidth,"w")-wSpace:minWidth),maxWidth=getScalar(isPercentage(maxWidth)?getScalar(maxWidth,"w")-wSpace:maxWidth),minHeight=getScalar(isPercentage(minHeight)?getScalar(minHeight,"h")-hSpace:minHeight),maxHeight=getScalar(isPercentage(maxHeight)?getScalar(maxHeight,"h")-hSpace:maxHeight),origMaxWidth=maxWidth,origMaxHeight=maxHeight,current.fitToView&&(maxWidth=Math.min(viewport.w-wSpace,maxWidth),maxHeight=Math.min(viewport.h-hSpace,maxHeight)),maxWidth_=viewport.w-wMargin,maxHeight_=viewport.h-hMargin,current.aspectRatio?(width>maxWidth&&(width=maxWidth,height=getScalar(width/ratio)),height>maxHeight&&(height=maxHeight,width=getScalar(height*ratio)),minWidth>width&&(width=minWidth,height=getScalar(width/ratio)),minHeight>height&&(height=minHeight,width=getScalar(height*ratio))):(width=Math.max(minWidth,Math.min(width,maxWidth)),current.autoHeight&&"iframe"!==current.type&&(inner.width(width),height=inner.height()),height=Math.max(minHeight,Math.min(height,maxHeight))),current.fitToView)if(inner.width(width).height(height),wrap.width(width+wPadding),width_=wrap.width(),height_=wrap.height(),current.aspectRatio)for(;(width_>maxWidth_||height_>maxHeight_)&&width>minWidth&&height>minHeight&&!(steps++>19);)height=Math.max(minHeight,Math.min(maxHeight,height-10)),width=getScalar(height*ratio),minWidth>width&&(width=minWidth,height=getScalar(width/ratio)),width>maxWidth&&(width=maxWidth,height=getScalar(width/ratio)),inner.width(width).height(height),wrap.width(width+wPadding),width_=wrap.width(),height_=wrap.height();
else width=Math.max(minWidth,Math.min(width,width-(width_-maxWidth_))),height=Math.max(minHeight,Math.min(height,height-(height_-maxHeight_)));scrollOut&&"auto"===scrolling&&origHeight>height&&maxWidth_>width+wPadding+scrollOut&&(width+=scrollOut),inner.width(width).height(height),wrap.width(width+wPadding),width_=wrap.width(),height_=wrap.height(),canShrink=(width_>maxWidth_||height_>maxHeight_)&&width>minWidth&&height>minHeight,canExpand=current.aspectRatio?origMaxWidth>width&&origMaxHeight>height&&origWidth>width&&origHeight>height:(origMaxWidth>width||origMaxHeight>height)&&(origWidth>width||origHeight>height),$.extend(current,{dim:{width:getValue(width_),height:getValue(height_)},origWidth:origWidth,origHeight:origHeight,canShrink:canShrink,canExpand:canExpand,wPadding:wPadding,hPadding:hPadding,wrapSpace:height_-skin.outerHeight(!0),skinSpace:skin.height()-height}),!iframe&&current.autoHeight&&height>minHeight&&maxHeight>height&&!canExpand&&inner.height("auto")},_getPosition:function(onlyAbsolute){var current=F.current,viewport=F.getViewport(),margin=current.margin,width=F.wrap.width()+margin[1]+margin[3],height=F.wrap.height()+margin[0]+margin[2],rez={position:"absolute",top:margin[0],left:margin[3]};return current.autoCenter&&current.fixed&&!onlyAbsolute&&height<=viewport.h&&width<=viewport.w?rez.position="fixed":current.locked||(rez.top+=viewport.y,rez.left+=viewport.x),rez.top=getValue(Math.max(rez.top,rez.top+(viewport.h-height)*current.topRatio)),rez.left=getValue(Math.max(rez.left,rez.left+(viewport.w-width)*current.leftRatio)),rez},_afterZoomIn:function(){var current=F.current;current&&(F.isOpen=F.isOpened=!0,F.wrap.css("overflow","visible").addClass("fancybox-opened"),F.update(),(current.closeClick||current.nextClick&&F.group.length>1)&&F.inner.css("cursor","pointer").bind("click.fb",function(e){$(e.target).is("a")||$(e.target).parent().is("a")||(e.preventDefault(),F[current.closeClick?"close":"next"]())}),current.closeBtn&&$(current.tpl.closeBtn).appendTo(F.skin).bind("click.fb",function(e){e.preventDefault(),F.close()}),current.arrows&&F.group.length>1&&((current.loop||current.index>0)&&$(current.tpl.prev).appendTo(F.outer).bind("click.fb",F.prev),(current.loop||current.index<F.group.length-1)&&$(current.tpl.next).appendTo(F.outer).bind("click.fb",F.next)),F.trigger("afterShow"),current.loop||current.index!==current.group.length-1?F.opts.autoPlay&&!F.player.isActive&&(F.opts.autoPlay=!1,F.play()):F.play(!1))},_afterZoomOut:function(obj){obj=obj||F.current,$(".fancybox-wrap").trigger("onReset").remove(),$.extend(F,{group:{},opts:{},router:!1,current:null,isActive:!1,isOpened:!1,isOpen:!1,isClosing:!1,wrap:null,skin:null,outer:null,inner:null}),F.trigger("afterClose",obj)}}),F.transitions={getOrigPosition:function(){var current=F.current,element=current.element,orig=current.orig,pos={},width=50,height=50,hPadding=current.hPadding,wPadding=current.wPadding,viewport=F.getViewport();return!orig&&current.isDom&&element.is(":visible")&&(orig=element.find("img:first"),orig.length||(orig=element)),isQuery(orig)?(pos=orig.offset(),orig.is("img")&&(width=orig.outerWidth(),height=orig.outerHeight())):(pos.top=viewport.y+(viewport.h-height)*current.topRatio,pos.left=viewport.x+(viewport.w-width)*current.leftRatio),("fixed"===F.wrap.css("position")||current.locked)&&(pos.top-=viewport.y,pos.left-=viewport.x),pos={top:getValue(pos.top-hPadding*current.topRatio),left:getValue(pos.left-wPadding*current.leftRatio),width:getValue(width+wPadding),height:getValue(height+hPadding)}},step:function(now,fx){var ratio,padding,value,prop=fx.prop,current=F.current,wrapSpace=current.wrapSpace,skinSpace=current.skinSpace;("width"===prop||"height"===prop)&&(ratio=fx.end===fx.start?1:(now-fx.start)/(fx.end-fx.start),F.isClosing&&(ratio=1-ratio),padding="width"===prop?current.wPadding:current.hPadding,value=now-padding,F.skin[prop](getScalar("width"===prop?value:value-wrapSpace*ratio)),F.inner[prop](getScalar("width"===prop?value:value-wrapSpace*ratio-skinSpace*ratio)))},zoomIn:function(){var current=F.current,startPos=current.pos,effect=current.openEffect,elastic="elastic"===effect,endPos=$.extend({opacity:1},startPos);delete endPos.position,elastic?(startPos=this.getOrigPosition(),current.openOpacity&&(startPos.opacity=.1)):"fade"===effect&&(startPos.opacity=.1),F.wrap.css(startPos).animate(endPos,{duration:"none"===effect?0:current.openSpeed,easing:current.openEasing,step:elastic?this.step:null,complete:F._afterZoomIn})},zoomOut:function(){var current=F.current,effect=current.closeEffect,elastic="elastic"===effect,endPos={opacity:.1};elastic&&(endPos=this.getOrigPosition(),current.closeOpacity&&(endPos.opacity=.1)),F.wrap.animate(endPos,{duration:"none"===effect?0:current.closeSpeed,easing:current.closeEasing,step:elastic?this.step:null,complete:F._afterZoomOut})},changeIn:function(){var field,current=F.current,effect=current.nextEffect,startPos=current.pos,endPos={opacity:1},direction=F.direction,distance=200;startPos.opacity=.1,"elastic"===effect&&(field="down"===direction||"up"===direction?"top":"left","down"===direction||"right"===direction?(startPos[field]=getValue(getScalar(startPos[field])-distance),endPos[field]="+="+distance+"px"):(startPos[field]=getValue(getScalar(startPos[field])+distance),endPos[field]="-="+distance+"px")),"none"===effect?F._afterZoomIn():F.wrap.css(startPos).animate(endPos,{duration:current.nextSpeed,easing:current.nextEasing,complete:F._afterZoomIn})},changeOut:function(){var previous=F.previous,effect=previous.prevEffect,endPos={opacity:.1},direction=F.direction,distance=200;"elastic"===effect&&(endPos["down"===direction||"up"===direction?"top":"left"]=("up"===direction||"left"===direction?"-":"+")+"="+distance+"px"),previous.wrap.animate(endPos,{duration:"none"===effect?0:previous.prevSpeed,easing:previous.prevEasing,complete:function(){$(this).trigger("onReset").remove()}})}},F.helpers.overlay={defaults:{closeClick:!0,speedOut:200,showEarly:!0,css:{},locked:!isTouch,fixed:!0},overlay:null,fixed:!1,el:$("html"),create:function(opts){opts=$.extend({},this.defaults,opts),this.overlay&&this.close(),this.overlay=$('<div class="fancybox-overlay"></div>').appendTo(F.coming?F.coming.parent:opts.parent),this.fixed=!1,opts.fixed&&F.defaults.fixed&&(this.overlay.addClass("fancybox-overlay-fixed"),this.fixed=!0)},open:function(opts){var that=this;opts=$.extend({},this.defaults,opts),this.overlay?this.overlay.unbind(".overlay").width("auto").height("auto"):this.create(opts),this.fixed||(W.bind("resize.overlay",$.proxy(this.update,this)),this.update()),opts.closeClick&&this.overlay.bind("click.overlay",function(e){return $(e.target).hasClass("fancybox-overlay")?(F.isActive?F.close():that.close(),!1):void 0}),this.overlay.css(opts.css).show()},close:function(){var scrollV,scrollH;W.unbind("resize.overlay"),this.el.hasClass("fancybox-lock")&&($(".fancybox-margin").removeClass("fancybox-margin"),scrollV=W.scrollTop(),scrollH=W.scrollLeft(),this.el.removeClass("fancybox-lock"),W.scrollTop(scrollV).scrollLeft(scrollH)),$(".fancybox-overlay").remove().hide(),$.extend(this,{overlay:null,fixed:!1})},update:function(){var offsetWidth,width="100%";this.overlay.width(width).height("100%"),IE?(offsetWidth=Math.max(document.documentElement.offsetWidth,document.body.offsetWidth),D.width()>offsetWidth&&(width=D.width())):D.width()>W.width()&&(width=D.width()),this.overlay.width(width).height(D.height())},onReady:function(opts,obj){var overlay=this.overlay;$(".fancybox-overlay").stop(!0,!0),overlay||this.create(opts),opts.locked&&this.fixed&&obj.fixed&&(overlay||(this.margin=D.height()>W.height()?$("html").css("margin-right").replace("px",""):!1),obj.locked=this.overlay.append(obj.wrap),obj.fixed=!1),opts.showEarly===!0&&this.beforeShow.apply(this,arguments)},beforeShow:function(opts,obj){var scrollV,scrollH;obj.locked&&(this.margin!==!1&&($("*").filter(function(){return"fixed"===$(this).css("position")&&!$(this).hasClass("fancybox-overlay")&&!$(this).hasClass("fancybox-wrap")}).addClass("fancybox-margin"),this.el.addClass("fancybox-margin")),scrollV=W.scrollTop(),scrollH=W.scrollLeft(),this.el.addClass("fancybox-lock"),W.scrollTop(scrollV).scrollLeft(scrollH)),this.open(opts)},onUpdate:function(){this.fixed||this.update()},afterClose:function(opts){this.overlay&&!F.coming&&this.overlay.fadeOut(opts.speedOut,$.proxy(this.close,this))}},F.helpers.title={defaults:{type:"float",position:"bottom"},beforeShow:function(opts){var title,target,current=F.current,text=current.title,type=opts.type;if($.isFunction(text)&&(text=text.call(current.element,current)),isString(text)&&""!==$.trim(text)){switch(title=$('<div class="fancybox-title fancybox-title-'+type+'-wrap">'+text+"</div>"),type){case"inside":target=F.skin;break;case"outside":target=F.wrap;break;case"over":target=F.inner;break;default:target=F.skin,title.appendTo("body"),IE&&title.width(title.width()),title.wrapInner('<span class="child"></span>'),F.current.margin[2]+=Math.abs(getScalar(title.css("margin-bottom")))}title["top"===opts.position?"prependTo":"appendTo"](target)}}},$.fn.fancybox=function(options){var index,that=$(this),selector=this.selector||"",run=function(e){var relType,relVal,what=$(this).blur(),idx=index;e.ctrlKey||e.altKey||e.shiftKey||e.metaKey||what.is(".fancybox-wrap")||(relType=options.groupAttr||"data-fancybox-group",relVal=what.attr(relType),relVal||(relType="rel",relVal=what.get(0)[relType]),relVal&&""!==relVal&&"nofollow"!==relVal&&(what=selector.length?$(selector):that,what=what.filter("["+relType+'="'+relVal+'"]'),idx=what.index(this)),options.index=idx,F.open(what,options)!==!1&&e.preventDefault())};return options=options||{},index=options.index||0,selector&&options.live!==!1?D.undelegate(selector,"click.fb-start").delegate(selector+":not('.fancybox-item, .fancybox-nav')","click.fb-start",run):that.unbind("click.fb-start").bind("click.fb-start",run),this.filter("[data-fancybox-start=1]").trigger("click"),this},D.ready(function(){var w1,w2;$.scrollbarWidth===undefined&&($.scrollbarWidth=function(){var parent=$('<div style="width:50px;height:50px;overflow:auto"><div/></div>').appendTo("body"),child=parent.children(),width=child.innerWidth()-child.height(99).innerWidth();return parent.remove(),width}),$.support.fixedPosition===undefined&&($.support.fixedPosition=function(){var elem=$('<div style="position:fixed;top:20px;"></div>').appendTo("body"),fixed=20===elem[0].offsetTop||15===elem[0].offsetTop;return elem.remove(),fixed}()),$.extend(F.defaults,{scrollbarWidth:$.scrollbarWidth(),fixed:$.support.fixedPosition,parent:$("body")}),w1=$(window).width(),H.addClass("fancybox-lock-test"),w2=$(window).width(),H.removeClass("fancybox-lock-test"),$("<style type='text/css'>.fancybox-margin{margin-right:"+(w2-w1)+"px;}</style>").appendTo("head")})}(window,document,jQuery),function(window,document,undefined){"use strict";window.slidfast=function(){var options,slidfast=function(startupOptions){return options=startupOptions,new slidfast.core.init},defaultPageID=null,focusPage=null,touchEnabled=!1,singlePageModel=!1,optimizeNetwork=!1,geo={on:!0,track:!1},orientationNav=!1,workers={script:null,threads:null,mycallback:null,obj:null},isReady=!1,flipped=!1,hashNS="";slidfast.core=slidfast.prototype={constructor:slidfast,start:function(){try{options&&(defaultPageID=options.defaultPageID,hashNS=null!==options.hahsNS?options.hashNS:"#sf-",touchEnabled=options.touchEnabled,singlePageModel=options.singlePageModel,optimizeNetwork=options.optimizeNetwork,orientationNav=options.orientationNav,geo=null!==options.geo?options.geo:null,workers=null!==options.workers?options.workers:null)}catch(e){alert("Problem with init. Check your options: "+e)}touchEnabled&&slidfast.ui.Touch(getElement(defaultPageID)),optimizeNetwork?slidfast.network.init():singlePageModel&&slidfast.core.fetchAndCache(!0),orientationNav&&slidfast.orientation.init(),geo&&geo.on&&slidfast.location.init(geo),workers&&null!==workers.script&&slidfast.worker.init(workers),slidfast.core.hideURLBar(),slidfast.core.locationChange()},hideURLBar:function(){setTimeout(scrollTo,0,0,1)},init:function(){return window.addEventListener("load",function(){isReady=!0,slidfast.core.start()},!1),window.addEventListener("hashchange",function(){slidfast.core.locationChange()},!1),slidfast.core},locationChange:function(){},ajax:function(url,callback,async){function init(){return window.XMLHttpRequest?new XMLHttpRequest:window.ActiveXObject?new window.ActiveXObject("Microsoft.XMLHTTP"):void 0}function processRequest(){if(4===req.readyState)if(200===req.status){if(slidfast.html5e.supports_local_storage())try{localStorage[url]=req.responseText}catch(e){"QUOTA_EXCEEDED_ERR"===e.name&&alert("Quota exceeded!")}callback&&callback(req.responseText,url)}else if(localStorage[url])return callback(localStorage[url],url),void 0}var req=init();req.onreadystatechange=processRequest,this.doGet=function(){req.open("GET",url+"?timestamp="+(new Date).getTime(),async),req.send(null)},this.doPost=function(body){req.open("POST",url,async),req.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),req.send(body)}},insertPages:function(text,originalLink){var frame=getFrame();frame.write(text);var i,incomingPages=frame.getElementsByClassName("page"),pageCount=incomingPages.length,onclickHelper=function(e){return function(){slidfast.ui.slideTo(e)}};for(i=0;pageCount>i;i+=1){var newPage=incomingPages[0];newPage.className="page stage-left";var location="back"===newPage.parentNode.id?"back":"front";try{document.getElementById(location).appendChild(document.adoptNode(newPage))}catch(e){}null===originalLink.onclick&&(originalLink.setAttribute("href","#"),originalLink.onclick=onclickHelper(newPage.id))}},cacheExternalImage:function(url){function load(img){var canvas=document.createElement("canvas");canvas.width=img.width,canvas.height=img.height;var ctx=canvas.getContext("2d");ctx.drawImage(img,0,0),img.src=ctx.canvas.toDataURL("image/png")}var img=new Image;return img.crossOrigin="",img.src=url,img.onload=function(){img.complete&&load(img)},img},fetchAndCache:function(async){var i,links=slidfast.core.getUnconvertedLinks(document,"fetch"),insertPage=function(){var text=arguments[0],url=arguments[1];slidfast.core.insertPages(text,url)};for(i=0;i<links.length;i+=1){var ai=new slidfast.core.ajax(links[i],insertPage,async);ai.doGet()}},getUnconvertedLinks:function(node,classname){var i,links=[],pages=node.getElementsByClassName("page");for(i=0;i<pages.length;i+=1){var j,pageLinks=pages[i].getElementsByTagName("a");for(j=0;j<pageLinks.length;j+=1){var link=pageLinks[j];link.hasAttribute("href")&&!/[\#]/g.test(link.href)&&(classname!==undefined?link.className.indexOf(classname)>=0&&links.push(link):classname===undefined&&""===link.className&&links.push(link))}}return links}},slidfast.core.init.prototype=slidfast.core,slidfast.ui=slidfast.prototype={slideTo:function(id,callback){if(focusPage||(focusPage=getElement(defaultPageID)),"string"==typeof id)try{id=getElement(id)}catch(e){console.log("You can't slideTo that element, because it doesn't exist")}var classes;try{classes=id.className.split(" ")}catch(e){console.log("problem with classname on .page: "+id.id)}var stageType=classes.indexOf("stage-left"),front=getElement("front");if(front)for(var frontNodes=front.getElementsByTagName("*"),i=0;i<frontNodes.length;i+=1)id.id===frontNodes[i].id&&flipped&&slidfast.ui.flip();focusPage.className=stageType>0?"page transition stage-right":"page transition stage-left",focusPage=id,focusPage.className="page transition stage-center",slidfast.core.locationChange(focusPage.id),touchEnabled&&slidfast.ui.Touch(focusPage),callback&&setTimeout(callback,500)},flip:function(){var front=document.getElementById("front"),back=document.getElementById("back"),classes=front.className.split(" "),flippedClass=classes.indexOf("flipped");flippedClass>=0?(front.className="normal",back.className="flipped",flipped=!1):(front.className="flipped",back.className="normal",flipped=!0)},Touch:function(page){function pageMove(event){var curTransform=new window.WebKitCSSMatrix(window.getComputedStyle(page).webkitTransform),pagePosition=curTransform.m41;if("touchend"!==event.type){var currentTouch=event.touches[0].clientX;"touchstart"===event.type&&(originalTouch=event.touches[0].clientX,timer=timerStart()),currentPos=currentTouch-originalTouch,0>pagePosition?pagePosition>maxPos?cancel=!0:maxPos=pagePosition:maxPos>pagePosition?cancel=!0:maxPos=pagePosition}else{swipeTime=timerEnd(timer,"numbers2"),currentPos=0;var pageFlipThreshold=75;cancel||(slideDirection=pagePosition>=0?pagePosition>pageFlipThreshold||swipeThreshold>swipeTime?"right":null:swipeThreshold>swipeTime||pageFlipThreshold>pagePosition?"left":null),maxPos=0,cancel=!1}positionPage()}function positionPage(end){page.style.webkitTransform="translate3d("+currentPos+"px, 0, 0)",page.style.WebkitTransition=end?"all .4s ease-out":"all .2s ease-out",page.style.WebkitUserSelect="none"}var swipeTime,timer,maxPos,track=getElement("page-container"),currentPos=page.style.left,originalTouch=0,slideDirection=null,cancel=!1,swipeThreshold=201;track.ontouchstart=function(event){pageMove(event)},track.ontouchmove=function(event){event.preventDefault(),pageMove(event)},track.ontouchend=function(event){pageMove(event),"left"===slideDirection?slidfast.ui.slideTo("products-page"):"right"===slideDirection&&slidfast.ui.slideTo("home-page")},positionPage(!0)}};var disabledLinks;slidfast.network=slidfast.prototype={init:function(){window.addEventListener("load",function(){navigator.onLine?slidfast.network.processOnline():slidfast.network.processOffline()},!1),window.addEventListener("offline",function(e){slidfast.network.processOffline(e.type)},!1),window.addEventListener("online",function(e){slidfast.network.processOnline(e.type)},!1),slidfast.network.setup()},setup:function(){var connection=navigator.connection||{type:"0"};2===connection.type||1===connection.type?slidfast.core.fetchAndCache(!0):3===connection.type?slidfast.core.fetchAndCache(!1):2===connection.type?slidfast.core.fetchAndCache(!1):slidfast.core.fetchAndCache(!0)},processOnline:function(event){function checkAppCache(){window.applicationCache.addEventListener("updateready",function(){window.applicationCache.status===window.applicationCache.UPDATEREADY&&(window.applicationCache.swapCache(),confirm("A new version of this site is available. Load it?")&&window.location.reload())},!1)}if(slidfast.network.setup(),checkAppCache(),event)for(var i=0;i<disabledLinks.length;i+=1)disabledLinks[i].onclick=null},processOffline:function(){slidfast.network.setup(),disabledLinks=slidfast.core.getUnconvertedLinks(document);var i,onclickHelper=function(){return function(){return alert("This app is currently offline and cannot access the hotness!"),!1}};for(i=0;i<disabledLinks.length;i+=1)null===disabledLinks[i].onclick&&(disabledLinks[i].onclick=onclickHelper(disabledLinks[i].href))}};var geolocationID,currentPosition,interval,callback;slidfast.location=slidfast.prototype={init:function(geo){slidfast.html5e.supports_geolocation()?geo.track?(slidfast.location.track(),interval=geo.interval?geo.interval:1e4,callback=geo.callback):currentPosition===undefined&&navigator.geolocation.getCurrentPosition(function(position){currentPosition=position},slidfast.location.error):console.log("Geolocation not supported on this device.")},track:function(){var count=0;geolocationID=window.setInterval(function(){count++,count>3?(window.clearInterval(geolocationID),slidfast.location.track()):navigator.geolocation.getCurrentPosition(slidfast.location.setPosition,slidfast.location.error,{enableHighAccuracy:!0,timeout:1e4})},interval)},setPosition:function(position){currentPosition=position,console.log("position "+position.coords.latitude+" "+position.coords.longitude),callback("position "+position.coords.latitude+" "+position.coords.longitude)},currentPosition:function(){return currentPosition},error:function(error){switch(error.code){case error.TIMEOUT:console.log("Timeout");break;case error.POSITION_UNAVAILABLE:console.log("Position unavailable");break;case error.PERMISSION_DENIED:console.log("Permission denied");break;case error.UNKNOWN_ERROR:console.log("Unknown error")}}},slidfast.orientation=slidfast.prototype={init:function(){slidfast.html5e.supports_orientation&&(focusPage||(focusPage=getElement(defaultPageID)),slidfast.orientation.nav())},nav:function(){function detecttilt(leftToRight){keepgoing&&(leftToRight>30?donav(leftPageState,rightPageState):-30>leftToRight&&donav(rightPageState,leftPageState))}function donav(ps,ops){var page;ps.count<=ps.pageCount+1&&(0===ps.count?(pagehistory.length>0&&(ps.pages=pagehistory,pagehistory=[]),ps.count++):(page=ps.pages.pop(),page!==undefined?(page.className=ps.className,pagehistory.push(page),ps.count++,console.log(ps.count),slideQueue(page)):ops.count=0))}function slideQueue(page){keepgoing=!1,slidfast.ui.slideTo(page,function(){keepgoing=!0})}window.addEventListener("deviceorientation",function(event){var rotateDegrees=event.alpha,leftToRight=event.gamma,frontToBack=event.beta;handleOrientationEvent(frontToBack,leftToRight,rotateDegrees)},!1);var handleOrientationEvent=function(frontToBack,leftToRight){new window.WebKitCSSMatrix(window.getComputedStyle(focusPage).webkitTransform);focusPage.innerHTML=leftToRight,focusPage.style.webkitTransform="translate3d("+5*leftToRight+"px, 0, 0)",focusPage.style.WebkitTransition="all .5s ease-out",detecttilt(leftToRight)},keepgoing=!0,pagehistory=[],pagestate=function(pages,className){var that={};return that.count=0,that.pages=pages,that.pageCount=pages.length,that.className=className,that},allpages=listToArray(document.querySelectorAll(".page")),leftPageState=new pagestate(allpages,"page stage-left"),rightPageState=new pagestate(allpages.slice(),"page stage-right")},motion:function(){function deviceMotionHandler(eventData){var acceleration=eventData.accelerationIncludingGravity,facingUp=("[x "+Math.round(acceleration.x)+", y "+Math.round(acceleration.y)+", z "+Math.round(acceleration.z)+"]",-1);acceleration.z>0&&(facingUp=1);var tiltLR=Math.round(acceleration.x/9.81*-90),tiltFB=Math.round((acceleration.y+9.81)/9.81*90*facingUp),rotation="rotate("+tiltLR+"deg) rotate3d(1,0,0, "+tiltFB+"deg)";focusPage.style.webkitTransform=rotation}slidfast.html5e.supports_motion&&window.addEventListener("devicemotion",deviceMotionHandler,!1)}};var sharedobj={};slidfast.worker=slidfast.prototype={init:function(workers){function Pool(size){var _this=this;this.taskQueue=[],this.workerQueue=[],this.poolSize=size,this.addWorkerTask=function(workerTask){if(_this.workerQueue.length>0){var workerThread=_this.workerQueue.shift();slidfast.worker.obj().index=_this.workerQueue.length,workerThread.run(workerTask)}else _this.taskQueue.push(workerTask)},this.init=function(){for(var i=0;size>i;i++)_this.workerQueue.push(new WorkerThread(_this))},this.freeWorkerThread=function(workerThread){if(_this.taskQueue.length>0){var workerTask=_this.taskQueue.shift();workerThread.run(workerTask)}else _this.taskQueue.push(workerThread)}}function WorkerThread(parentPool){var _this=this;this.parentPool=parentPool,this.workerTask={},this.run=function(workerTask){if(this.workerTask=workerTask,null!==this.workerTask.script){var worker=new Worker(workerTask.script);worker.addEventListener("message",function(event){mycallback(event),_this.parentPool.freeWorkerThread(_this)},!1),worker.postMessage(slidfast.worker.obj())}}}function WorkerTask(script,callback,msg){this.script=script,this.callback=callback,console.log(msg),this.obj=msg}var mycallback=workers.mycallback,pool=new Pool(workers.threads);pool.init();var workerTask=new WorkerTask(workers.script,mycallback,slidfast.worker.obj());pool.addWorkerTask(workerTask),slidfast.worker.obj().foo=10,pool.addWorkerTask(workerTask),slidfast.worker.obj().foo=20,pool.addWorkerTask(workerTask),slidfast.worker.obj().foo=30,pool.addWorkerTask(workerTask)},obj:function(){return sharedobj}},slidfast.html5e=slidfast.prototype={supports_local_storage:function(){try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}},supports_app_cache:function(){try{return"applicationCache"in window&&null!==window.applicationCache}catch(e){return!1}},supports_geolocation:function(){try{return"geolocation"in navigator&&null!==navigator.geolocation}catch(e){return!1}},supports_websocket:function(){try{return"WebSocket"in window&&null!==window.WebSocket}catch(e){return!1}},supports_orientation:function(){try{return"DeviceOrientationEvent"in window&&null!==window.DeviceOrientationEvent}catch(e){return!1}},supports_motion:function(){try{return"DeviceMotionEvent"in window&&null!==window.DeviceMotionEvent}catch(e){return!1}}};var getElement=function(id){return document.querySelector?document.querySelector("#"+id):document.getElementById(id)},timerStart=function(){return(new Date).getTime()},timerEnd=function(start){return(new Date).getTime()-start},listToArray=function(obj){var array=[];return[].forEach.call(obj,function(v,i){array[i]=obj[i]}),array},getFrame=function(){var frame=document.getElementById("temp-frame");return frame||(frame=document.createElement("iframe"),frame.setAttribute("id","temp-frame"),frame.setAttribute("name","temp-frame"),frame.setAttribute("seamless",""),frame.setAttribute("sandbox","allow-same-origin"),frame.style.display="none",document.documentElement.appendChild(frame)),frame.contentDocument};return slidfast}()}(window,document),window.BMAP_AUTHENTIC_KEY="077cf00d4471f3852b96fba32ff879fd",function(){function q(){return function(){}}function ba(a){return function(b){this[a]=b}}function s(a){return function(){return this[a]}}function ca(a){return function(){return a}}function fa(a){return function(){return ea[a].apply(this,arguments)}}function ga(a,b){return ea[a]=b}function y(a,b){if(b=window.event||b,a.clientX=b.clientX||b.pageX,a.clientY=b.clientY||b.pageY,a.offsetX=b.offsetX||b.layerX,a.offsetY=b.offsetY||b.layerY,a.screenX=b.screenX,a.screenY=b.screenY,a.ctrlKey=b.ctrlKey||b.metaKey,a.shiftKey=b.shiftKey,a.altKey=b.altKey,b.touches){a.touches=[];for(var c=0;c<b.touches.length;c++)a.touches.push({clientX:b.touches[c].clientX,clientY:b.touches[c].clientY,screenX:b.touches[c].screenX,screenY:b.touches[c].screenY,pageX:b.touches[c].pageX,pageY:b.touches[c].pageY,target:b.touches[c].target,identifier:b.touches[c].identifier})}if(b.changedTouches)for(a.changedTouches=[],c=0;c<b.changedTouches.length;c++)a.changedTouches.push({clientX:b.changedTouches[c].clientX,clientY:b.changedTouches[c].clientY,screenX:b.changedTouches[c].screenX,screenY:b.changedTouches[c].screenY,pageX:b.changedTouches[c].pageX,pageY:b.changedTouches[c].pageY,target:b.changedTouches[c].target,identifier:b.changedTouches[c].identifier});if(b.targetTouches)for(a.targetTouches=[],c=0;c<b.targetTouches.length;c++)a.targetTouches.push({clientX:b.targetTouches[c].clientX,clientY:b.targetTouches[c].clientY,screenX:b.targetTouches[c].screenX,screenY:b.targetTouches[c].screenY,pageX:b.targetTouches[c].pageX,pageY:b.targetTouches[c].pageY,target:b.targetTouches[c].target,identifier:b.targetTouches[c].identifier});return a.rotation=b.rotation,a.scale=b.scale,a}function qa(a,b){if(a=t.R(a)){var c=this;t.lang.la.call(c),b=b||{},c.F={Fs:200,Eb:i,cp:o,ct:i,gm:o,im:o,gt:i,hm:i,ap:i,ld:25,QK:240,vF:450,mb:C.mb,mc:C.mc,wp:!!b.wp,oc:b.minZoom||1,od:b.maxZoom||18,yb:b.mapType||ra,MM:o,bp:o,Ws:500,NL:b.enableHighResolution!==o,dp:b.enableMapClick!==o,devicePixelRatio:b.devicePixelRatio||window.devicePixelRatio||1,DB:b.vectorMapLevel||12,nc:b.mapStyle||n,jA:b.logoControl===o?o:i,OF:["chrome"]},c.F.nc&&(this.Kz(c.F.nc.controls),this.Lz(c.F.nc.geotableId)),c.F.nc&&c.F.nc.styleId&&c.yz(c.F.nc.styleId),c.F.Cf={dark:{backColor:"#2D2D2D",textColor:"#bfbfbf",iconUrl:"dicons"},normal:{backColor:"#F3F1EC",textColor:"#c61b1b",iconUrl:"icons"},light:{backColor:"#EBF8FC",textColor:"#017fb4",iconUrl:"licons"}},b.enableAutoResize&&(c.F.ap=b.enableAutoResize),t.platform.ik&&1.5<window.devicePixelRatio&&(c.F.devicePixelRatio=1.5);for(var d=c.F.OF,e=0,f=d.length;f>e;e++)if(t.M[d[e]]){c.F.devicePixelRatio=1;break}for(c.xa=a,c.cs(a),a.unselectable="on",a.innerHTML="",a.appendChild(c.ua()),b.size&&this.Ic(b.size),d=c.Fb(),c.width=d.width,c.height=d.height,c.offsetX=0,c.offsetY=0,c.platform=a.firstChild,c.Hd=c.platform.firstChild,c.Hd.style.width=c.width+"px",c.Hd.style.height=c.height+"px",c.Lc={},c.Le=new F(0,0),c.Ob=new F(0,0),c.na=1,c.ac=0,c.Ns=n,c.Ms=n,c.Db="",c.As="",c.rf={},c.rf.custom={},c.ya=0,c.Q=new sa(a,{Uj:"api"}),c.Q.H(),c.Q.Xu(c),b=b||{},d=c.yb=c.F.yb,c.Tc=d.Ni(),d===ta&&ua(5002),(d===va||d===xa)&&ua(5003),d=c.F,d.zB=b.minZoom,d.yB=b.maxZoom,c.Lq(),c.D={Gb:o,kb:0,Cm:0,bA:0,qM:0,ys:o,Ku:-1,yd:[]},c.platform.style.cursor=c.F.mb,e=0;e<B.El.length;e++)B.El[e](c);c.D.Ku=e,c.N(),G.load("map",function(){c.Wb()}),c.F.dp&&(setTimeout(function(){ua("load_mapclick")},1e3),G.load("mapclick",function(){window.MPC_Mgr=new ya(c)},i)),za()&&G.load("oppc",function(){c.Fq()}),H()&&G.load("opmb",function(){c.Fq()}),a=n,c.ms=[]}}function ua(a,b){if(a){var d,b=b||{},c="";for(d in b)c=c+"&"+d+"="+encodeURIComponent(b[d]);var e=function(a){a&&(Ra=i,setTimeout(function(){Sa.src="http://api.map.baidu.com/images/blank.gif?"+a.src},50))},f=function(){var a=Ta.shift();a&&e(a)};d=(1e8*Math.random()).toFixed(0),Ra?Ta.push({src:"product=jsapi&v="+B.version+"&t="+d+"&code="+a+c}):e({src:"product=jsapi&v="+B.version+"&t="+d+"&code="+a+c}),Ua||(t.C(Sa,"load",function(){Ra=o,f()}),t.C(Sa,"error",function(){Ra=o,f()}),Ua=i)}}function Va(a){var b={duration:1e3,ld:30,dh:0,ae:Wa.dA,yu:q()};if(this.be=[],a)for(var c in a)b[c]=a[c];if(this.k=b,Ba(b.dh)){var d=this;setTimeout(function(){d.start()},b.dh)}else b.dh!=Xa&&this.start()}function Ya(a){var b=Ea();b>=a.br?(Ca(a.k.ua)&&a.k.ua(a.k.ae(1)),Ca(a.k.finish)&&a.k.finish(),0<a.be.length&&(b=a.be[0],b.be=[].concat(a.be.slice(1)),b.start())):(a.Vp=a.k.ae((b-a.Bn)/a.k.duration),Ca(a.k.ua)&&a.k.ua(a.Vp),a.gv||(a.Kl=setTimeout(function(){Ya(a)},1e3/a.k.ld)))}function Za(a,b){var c=a.style;c.left=b[0]+"px",c.top=b[1]+"px"}function $a(a){0<t.M.S?a.unselectable="on":a.style.MozUserSelect="none"}function ab(a){return a&&a.parentNode&&11!=a.parentNode.nodeType}function bb(a,b){return t.z.eu(a,"beforeEnd",b),a.lastChild}function cb(a){for(var b={left:0,top:0};a&&a.offsetParent;)b.left+=a.offsetLeft,b.top+=a.offsetTop,a=a.offsetParent;return b}function A(a){a=window.event||a,a.stopPropagation?a.stopPropagation():a.cancelBubble=i}function db(a){return a=window.event||a,a.preventDefault?a.preventDefault():a.returnValue=o,o}function ka(a){return A(a),db(a)}function eb(){var a=document.documentElement,b=document.body;return a&&(a.scrollTop||a.scrollLeft)?[a.scrollTop,a.scrollLeft]:b?[b.scrollTop,b.scrollLeft]:[0,0]}function fb(a,b){return a&&b?Math.round(Math.sqrt(Math.pow(a.x-b.x,2)+Math.pow(a.y-b.y,2))):void 0}function gb(a,b){var d,c=[],b=b||function(a){return a};for(d in a)c.push(d+"="+b(a[d]));return c.join("&")}function J(a,b,c){var d=document.createElement(a);return c&&(d=document.createElementNS(c,a)),t.z.Uu(d,b||{})}function Aa(a){return a.currentStyle?a.currentStyle:a.ownerDocument&&a.ownerDocument.defaultView?a.ownerDocument.defaultView.getComputedStyle(a,n):void 0}function Ca(a){return"function"==typeof a}function Ba(a){return"number"==typeof a}function Da(a){return"string"==typeof a}function hb(a){return"undefined"!=typeof a}function ib(a){return"object"==typeof a}function lb(a){var c,d,f,b="",e="",g="",j=0;if(f=/[^A-Za-z0-9\+\/\=]/g,!a||f.exec(a))return a;a=a.replace(/[^A-Za-z0-9\+\/\=]/g,"");do c=jb.indexOf(a.charAt(j++)),d=jb.indexOf(a.charAt(j++)),f=jb.indexOf(a.charAt(j++)),g=jb.indexOf(a.charAt(j++)),c=c<<2|d>>4,d=(15&d)<<4|f>>2,e=(3&f)<<6|g,b+=String.fromCharCode(c),64!=f&&(b+=String.fromCharCode(d)),64!=g&&(b+=String.fromCharCode(e));while(j<a.length);return b}function H(){return!(!t.platform.BI&&!t.platform.AI&&!t.platform.ik)}function za(){return!(!t.platform.Xz&&!t.platform.CI&&!t.platform.II)
}function Ea(){return(new Date).getTime()}function mb(){var a=document.body.appendChild(J("div"));a.innerHTML='<v:shape id="vml_tester1" adj="1" />';var b=a.firstChild;return b.style?(b.style.behavior="url(#default#VML)",b=b?"object"==typeof b.adj:i,a.parentNode.removeChild(a),b):o}function nb(){return!!document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Shape","1.1")}function ob(){return!!J("canvas").getContext}function La(a,b){if(b){var c=(1e5*Math.random()).toFixed(0);B._rd["_cbk"+c]=function(a){b&&b(a),delete B._rd["_cbk"+c]},a+="&callback=BMap._rd._cbk"+c}var d=J("script",{src:a,type:"text/javascript",charset:"utf-8"});d.addEventListener?d.addEventListener("load",function(a){a=a.target,a.parentNode.removeChild(a)},o):d.attachEvent&&d.attachEvent("onreadystatechange",function(){var a=window.event.srcElement;a&&("loaded"==a.readyState||"complete"==a.readyState)&&a.parentNode.removeChild(a)}),setTimeout(function(){document.getElementsByTagName("head")[0].appendChild(d),d=n},1)}function G(){}function O(a,b){this.x=a||0,this.y=b||0,this.x=this.x,this.y=this.y}function K(a,b){this.width=a||0,this.height=b||0}function Ka(a,b){a&&(this.qb=a,this.L="spot"+Ka.L++,b=b||{},this.lg=b.text||"",this.io=b.offsets?b.offsets.slice(0):[5,5,5,5],this.Qx=b.userData||n,this.uf=b.minZoom||n,this.Td=b.maxZoom||n)}function R(){this.A=n,this.wb="control",this.vb=this.ky=i}function Ma(a){R.call(this),a=a||{},this.k={bf:o,bv:a.showZoomInfo||i,anchor:a.anchor,ga:a.offset,type:a.type},this.defaultAnchor=H()?3:qb,this.defaultOffset=new K(10,10),this.Sb(a.anchor),this.jj(a.type),this.Nd()}function tb(a){R.call(this),a=a||{},this.k={anchor:a.anchor,ga:a.offset,dK:a.showAddressBar,Xy:a.enableAutoLocation,iA:a.locationIcon},this.defaultAnchor=sb,this.defaultOffset=new K(0,4),this.Nd()}function ub(a){R.call(this),a=a||{},this.k={bf:o,anchor:a.anchor,ga:a.offset},this.hb=[],this.defaultAnchor=sb,this.defaultOffset=new K(5,2),this.Sb(a.anchor),this.ky=o,this.Nd()}function Oa(a){R.call(this),a=a||{},this.k={bf:o,size:a.size||new K(150,150),padding:5,za:a.isOpen===i?i:o,OK:4,ga:a.offset,anchor:a.anchor},this.defaultAnchor=3,this.defaultOffset=new K(0,0),this.Wk=this.Xk=13,this.Sb(a.anchor),this.Ic(this.k.size),this.Nd()}function Na(a){R.call(this),a=a||{},this.k={bf:o,color:"black",Tb:"metric",ga:a.offset},this.defaultAnchor=sb,this.defaultOffset=new K(81,18),this.Sb(a.anchor),this.xf={metric:{name:"metric",zy:1,Jz:1e3,uB:"米",vB:"公里"},us:{name:"us",zy:3.2808,Jz:5280,uB:"英尺",vB:"英里"}},this.xf[this.k.Tb]||(this.k.Tb="metric"),this.xx=n,this.dx={},this.Nd()}function Pa(a){R.call(this),a=a||{},this.defaultAnchor=rb,this.defaultOffset=new K(10,10),this.k={bf:o,Xe:[ra,va,xa,ta],type:a.type||wb,ga:a.offset||this.defaultOffset,PL:i},this.Sb(a.anchor),"[object Array]"==Object.prototype.toString.call(a.mapTypes)&&(this.k.Xe=a.mapTypes.slice(0)),this.Nd()}function xb(a){R.call(this),a=a||{},this.k={bf:o,ga:a.offset,anchor:a.anchor},this.fg=o,this.vo=n,this.lx=new yb({Uj:"api"}),this.mx=new zb(n,{Uj:"api"}),this.defaultAnchor=rb,this.defaultOffset=new K(10,10),this.Sb(a.anchor),this.Nd(),ua(5042)}function Ab(a){t.lang.la.call(this),this.k={xa:n,cursor:"default"},this.k=t.extend(this.k,a),this.wb="contextmenu",this.A=n,this.ea=[],this.Ud=[],this.bd=[],this.Vo=this.Wl=n,this.sf=o;var b=this;G.load("menu",function(){b.Wb()})}function Bb(a,b,c){if(a&&Ca(b)){t.lang.la.call(this),this.k={width:100,id:""},c=c||{},this.k.width=1*c.width?c.width:100,this.k.id=c.id?c.id:"",this.lg=a+"",this.kf=b,this.A=n,this.wb="menuitem",this.B=this.mf=n,this.pf=i;var d=this;G.load("menu",function(){d.Wb()})}}function Ia(a,b){a&&!b&&(b=a),this.ed=this.dd=this.hd=this.gd=this.gi=this.Yh=n,a&&(this.gi=new F(a.lng,a.lat),this.Yh=new F(b.lng,b.lat),this.hd=a.lng,this.gd=a.lat,this.ed=b.lng,this.dd=b.lat)}function F(a,b){isNaN(a)&&(a=lb(a),a=isNaN(a)?0:a),Da(a)&&(a=parseFloat(a)),isNaN(b)&&(b=lb(b),b=isNaN(b)?0:b),Da(b)&&(b=parseFloat(b)),this.lng=a,this.lat=b}function Cb(){}function Db(){}function P(){}function Eb(){}function Ja(){this.Is="bj"}function Gb(){this.wb="overlay"}function Q(){t.lang.la.call(this),Gb.call(this),this.map=n,this.vb=i,this.xb=n,this.nw=0}function Hb(){this.map=n,this.fa={},this.ad=[]}function Ib(a){Q.call(this),a=a||{},this.w={strokeColor:a.strokeColor||"#3a6bdb",ef:a.strokeWeight||5,ye:a.strokeOpacity||.65,strokeStyle:a.strokeStyle||"solid",gh:a.enableMassClear===o?o:i,jh:n,Mi:n,Yd:a.enableEditing===i?i:o,uA:15,GK:o,xd:a.enableClicking===o?o:i},0>=this.w.ef&&(this.w.ef=5),(0>this.w.ye||1<this.w.ye)&&(this.w.ye=.65),(0>this.w.Fi||1<this.w.Fi)&&(this.w.Fi=.65),"solid"!=this.w.strokeStyle&&"dashed"!=this.w.strokeStyle&&(this.w.strokeStyle="solid"),this.J=n,this.Gq=new Ia(0,0),this.ud=[],this.pb=[],this.ra={}}function Jb(a){Q.call(this),this.J=this.map=n,this.w={width:0,height:0,ga:new K(0,0),opacity:1,background:"transparent",yp:1,cA:"#000",OI:"solid",O:n},this.TA(a),this.O=this.w.O}function Kb(a,b,c){a&&b&&(this.imageUrl=a,this.size=b,a=new K(Math.floor(b.width/2),Math.floor(b.height/2)),c=c||{},a=c.anchor||a,b=c.imageOffset||new K(0,0),this.imageSize=c.imageSize,this.anchor=a,this.imageOffset=b,this.infoWindowAnchor=c.infoWindowAnchor||this.anchor,this.printImageUrl=c.printImageUrl||"")}function Lb(a,b){t.lang.la.call(this),this.content=a,this.map=n,b=b||{},this.w={width:b.width||0,height:b.height||0,maxWidth:b.maxWidth||600,ga:b.offset||new K(0,0),title:b.title||"",ru:b.maxContent||"",Oe:b.enableMaximize||o,fm:b.enableAutoPan===o?o:i,bt:b.enableCloseOnClick===o?o:i,margin:b.margin||[10,10,40,10],Hs:b.collisions||[[10,10],[10,10],[10,10],[10,10]],qI:o,tM:ca(i),ft:b.enableMessage===o?o:i,message:b.message,ht:b.enableSearchTool===i?i:o,rp:b.headerContent||""},0!=this.w.width&&(220>this.w.width&&(this.w.width=220),730<this.w.width)&&(this.w.width=730),0!=this.w.height&&(60>this.w.height&&(this.w.height=60),650<this.w.height)&&(this.w.height=650),0!=this.w.maxWidth&&(220>this.w.maxWidth&&(this.w.maxWidth=220),730<this.w.maxWidth)&&(this.w.maxWidth=730),this.Cc=o,this.Xf=C.ba,this.Ka=n;var c=this;G.load("infowindow",function(){c.Wb()})}function Mb(a,b){Q.call(this),this.content=a,this.J=this.map=n,b=b||{},this.w={width:0,ga:b.offset||new K(0,0),Bk:{backgroundColor:"#fff",border:"1px solid #f00",padding:"1px",whiteSpace:"nowrap",font:"12px "+C.fontFamily,zIndex:"80",MozUserSelect:"none"},position:b.position||n,gh:b.enableMassClear===o?o:i,xd:i},0>this.w.width&&(this.w.width=0),hb(b.enableClicking)&&(this.w.xd=b.enableClicking),this.O=this.w.position;var c=this;G.load("marker",function(){c.Wb()})}function T(a,b){Q.call(this),b=b||{},this.O=a,this.Tk=this.map=n,this.w={ga:b.offset||new K(0,0),Ve:b.icon||Nb,Dh:Pb,title:b.title||"",label:n,iy:b.baseZIndex||0,xd:i,fN:o,mu:o,gh:b.enableMassClear===o?o:i,Eb:o,MA:b.raiseOnDrag===i?i:o,QA:o,mc:b.draggingCursor||C.mc},b.icon&&!b.shadow&&(this.w.Dh=n),b.enableDragging&&(this.w.Eb=b.enableDragging),hb(b.enableClicking)&&(this.w.xd=b.enableClicking);var c=this;G.load("marker",function(){c.Wb()})}function Qb(a,b){Ib.call(this,b),b=b||{},this.w.Fi=b.fillOpacity?b.fillOpacity:.65,this.w.fillColor=""==b.fillColor?"":b.fillColor?b.fillColor:"#fff",this.Wc(a);var c=this;G.load("poly",function(){c.Wb()})}function Rb(a,b){Ib.call(this,b),this.Il(a);var c=this;G.load("poly",function(){c.Wb()})}function Sb(a,b,c){this.O=a,this.Ca=Math.abs(b),Qb.call(this,[],c)}function Ub(a){this.map=a,this.mk=[],this.$d=[],this.Be=[],this.XF=300,this.Ju=0,this.re={},this.qg={},this.Ze=0,this.hu=i,this.Hy={},this.co=this.bl(1),this.le=this.bl(2),this.xl=this.bl(3),a.platform.appendChild(this.co),a.platform.appendChild(this.le),a.platform.appendChild(this.xl)}function Zb(a,b,c,d,e){this.Xi=a,this.position=c,this.Dn=[],this.name=a.Wt(d,e),this.info=d,this.Ox=e.Bm(),d=J("img"),$a(d),d.ez=o;var f=d.style,a=a.map.ha();f.position="absolute",f.border="none",f.width=a.k.Jb+"px",f.height=a.k.Jb+"px",f.left=c[0]+"px",f.top=c[1]+"px",f.maxWidth="none",this.Va=d,this.src=b,bc&&(this.Va.style.opacity=0);var g=this;this.Va.onload=function(){if(g.loaded=i,g.Xi){var a=g.Xi,b=a.qg;b[g.name]||(a.Ju++,b[g.name]=g),g.Va&&!ab(g.Va)&&e.gb&&(e.gb.appendChild(g.Va),t.M.S<=6&&t.M.S>0&&g.Ox&&(g.Va.style.cssText=g.Va.style.cssText+(';filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="'+g.src+'",sizingMethod=scale);')));var d,c=a.Ju-a.XF;for(d in b){if(0>=c)break;if(!a.re[d]){b[d].Xi=n;var f=b[d].Va;f&&f.parentNode&&(f.parentNode.removeChild(f),ac(f)),f=n,b[d].Va=n,delete b[d],a.Ju--,c--}}bc&&new Va({ld:20,duration:200,ua:function(a){g.Va&&g.Va.style&&(g.Va.style.opacity=1*a)},finish:function(){g.Va&&g.Va.style&&delete g.Va.style.opacity}}),Wb(g)}},this.Va.onerror=function(){if(Wb(g),g.Xi){var a=g.Xi.map.ha();a.k.kt&&(g.error=i,g.Va.src=a.k.kt,g.Va&&!ab(g.Va)&&e.gb.appendChild(g.Va))}},d=n}function Yb(a,b){a.Dn.push(b)}function $b(a){a.Va.src=0<t.M.S&&6>=t.M.S&&a.Ox?C.ba+"blank.gif":""!==a.src&&a.Va.src==a.src?a.src+"&t = "+Date.now():a.src}function Wb(a){for(var b=0;b<a.Dn.length;b++)a.Dn[b]();a.Dn.length=0}function ac(a){if(a){a.onload=a.onerror=n;var c,d,e,b=a.attributes;if(b)for(d=b.length,c=0;d>c;c+=1)e=b[c].name,Ca(a[e])&&(a[e]=n);if(b=a.children)for(d=b.length,c=0;d>c;c+=1)ac(a.children[c])}}function Xb(a,b){a.src=b,$b(a)}function Vb(a){this.ok=a||{},this.oG=this.ok.copyright||n,this.EK=this.ok.transparentPng||o,this.Mo=this.ok.baseLayer||o,this.zIndex=this.ok.zIndex||0,this.L=Vb.RD++}function cc(a,b){ib(a)?b=a||{}:(b=b||{},b.databoxId=a),this.k={Iy:b.databoxId,Qe:b.geotableId,Rp:b.q||"",bn:b.tags||"",filter:b.filter||"",lK:b.styleId||"",mi:b.ak||la,Lo:b.age||36e5,zIndex:11,MI:"VectorCloudLayer",qh:b.hotspotName||"vector_md_"+(1e5*Math.random()).toFixed(0),GF:"LBS云麻点层"},this.kk=i,Vb.call(this,this.k),this.hI="http://api.map.baidu.com/georender/gss/data?",this.AG="http://api.map.baidu.com/geosearch/detail/",this.BG="http://api.map.baidu.com/geosearch/v2/detail/",this.fk={}}function dc(a){a=a||{},this.k=t.extend(a,{zIndex:1,MI:"VectorTrafficLayer",GF:"矢量路况层"}),this.kk=i,Vb.call(this,this.k),this.CK="http://or.map.bdimg.com:8080/gvd/?qt=lgvd&styles=pl&layers=tf",this.jd={0:[2,1354709503,2,2,0,[],0,0],1:[2,1354709503,3,2,0,[],0,0],10:[2,-231722753,2,2,0,[],0,0],11:[2,-231722753,3,2,0,[],0,0],12:[2,-231722753,4,2,0,[],0,0],13:[2,-231722753,5,2,0,[],0,0],14:[2,-231722753,6,2,0,[],0,0],15:[2,-1,4,0,0,[],0,0],16:[2,-1,5.5,0,0,[],0,0],17:[2,-1,7,0,0,[],0,0],18:[2,-1,8.5,0,0,[],0,0],19:[2,-1,10,0,0,[],0,0],2:[2,1354709503,4,2,0,[],0,0],3:[2,1354709503,5,2,0,[],0,0],4:[2,1354709503,6,2,0,[],0,0],5:[2,-6350337,2,2,0,[],0,0],6:[2,-6350337,3,2,0,[],0,0],7:[2,-6350337,4,2,0,[],0,0],8:[2,-6350337,5,2,0,[],0,0],9:[2,-6350337,6,2,0,[],0,0]}}function ec(a){Vb.call(this,a),this.k=a||{},this.Tz=i,this.Ae=new dc,this.Ae.gq=this,this.k.predictDate&&((1>this.k.predictDate.weekday||7<this.k.predictDate.weekday)&&(this.k.predictDate=1),(0>this.k.predictDate.hour||23<this.k.predictDate.hour)&&(this.k.predictDate.hour=0)),this.rF="http://its.map.baidu.com:8002/traffic/"}function Qa(a,b){Vb.call(this);var c=this;this.Tz=i;var d=o;try{document.createElement("canvas").getContext("2d"),d=i}catch(e){d=o}d&&(this.Ae=new cc(a,b),this.Ae.gq=this),ib(a)?b=a||{}:(c.dl=a,b=b||{}),b.geotableId&&(c.he=b.geotableId),b.databoxId&&(c.dl=b.databoxId),c.zc={pI:"http://api.map.baidu.com/georender/gss/image",mI:"http://api.map.baidu.com/georender/gss/data",nI:"http://api.map.baidu.com/geosearch/detail/",oI:"http://api.map.baidu.com/geosearch/v2/detail/",Lo:b.age||36e5,Rp:b.q||"",tK:"png",jM:[5,5,5,5],LI:{backgroundColor:"#FFFFD5",borderColor:"#808080"},mi:b.ak||la,bn:b.tags||"",filter:b.filter||"",qh:b.hotspotName||"tile_md_"+(1e5*Math.random()).toFixed(0)},G.load("clayer",function(){c.wc()})}function fc(a,b,c){this.vl=a,this.tl=b instanceof Vb?[b]:b.slice(0),c=c||{},this.k={uK:c.tips||"",pu:"",oc:c.minZoom||3,od:c.maxZoom||18,kI:c.minZoom||3,jI:c.maxZoom||18,Jb:256,sK:c.textColor||"black",kt:c.errorImageUrl||"",Tc:c.projection||new P},1<=this.tl.length&&(this.tl[0].Mo=i),t.extend(this.k,c)}function V(a,b){t.lang.la.call(this),this.hc={},this.hj(a),b=b||{},b.$=b.renderOptions||{},this.k={$:{wa:b.$.panel||n,map:b.$.map||n,Ke:b.$.autoViewport||i,Nm:b.$.selectFirstResult,wm:b.$.highlightMode,Eb:b.$.enableDragging||o},Jp:b.onSearchComplete||q(),CA:b.onMarkersSet||q(),BA:b.onInfoHtmlSet||q(),DA:b.onResultsHtmlSet||q(),AA:b.onGetBusListComplete||q(),zA:b.onGetBusLineComplete||q(),yA:b.onBusListHtmlSet||q(),xA:b.onBusLineHtmlSet||q(),xu:b.onPolylinesSet||q(),sk:b.reqFrom||""},this.k.$.Ke="undefined"!=typeof b&&"undefined"!=typeof b.renderOptions&&"undefined"!=typeof b.renderOptions.autoViewport?b.renderOptions.autoViewport:i,this.k.$.wa=t.uc(this.k.$.wa)}function Fa(a,b){V.call(this,a,b),b=b||{},b.renderOptions=b.renderOptions||{},this.xk(b.pageCapacity),"undefined"==typeof b.renderOptions.selectFirstResult||b.renderOptions.selectFirstResult?this.dt():this.Qs(),this.fa=[],this.Ld=[],this.Ha=-1,this.pa=[];var c=this;G.load("local",function(){c.Kq()},i)}function Ec(a,b){V.call(this,a,b)}function Fc(a,b){V.call(this,a,b),b=b||{},this.Rm(b.policy),this.xk(b.pageCapacity),this.Yf=tc,this.xn=yc,this.wq=oc,this.fa=[],this.Ha=-1,this.pa=[];var c=this;G.load("route",function(){c.wc()})}function Gc(a,b){V.call(this,a,b),this.fa=[],this.Ha=-1,this.pa=[];var c=this,d=this.k.$;1!=d.wm&&2!=d.wm&&(d.wm=1),this.$q=this.k.$.Eb?i:o,G.load("route",function(){c.wc()}),this.du&&this.du()}function Hc(a,b){Gc.call(this,a,b),b=b||{},this.Rm(b.policy),this.Yf=uc,this.xn=Bc,this.wq=rc}function Ic(a,b){Gc.call(this,a,b),this.Yf=vc,this.xn=Cc,this.wq=qc,this.$q=o}function Jc(a){this.k={},t.extend(this.k,a),this.pa=[];var b=this;G.load("othersearch",function(){b.wc()})}function Geolocation(a){this.k={},t.extend(this.k,a),this.pa=[];var b=this;G.load("othersearch",function(){b.wc()})}function Mc(a){a=a||{},a.$=a.renderOptions||{},this.k={$:{map:a.$.map||n}},this.pa=[];var b=this;G.load("othersearch",function(){b.wc()})}function Nc(){this.pa=[];var a=this;G.load("othersearch",function(){a.wc()})}function Oc(a,b){V.call(this,a,b),this.UB=wc,this.XB=zc,this.TB=xc,this.WB=Ac,this.pa=[];var c=this;G.load("buslinesearch",function(){c.wc()})}function Pc(a){V.call(this,a),a=a||{},this.zc={input:a.input||n,ss:a.baseDom||n,types:a.types||[],Jp:a.onSearchComplete||q()},this.hc.src=a.location||"全国",this.og="",this.ke=n,this.Tw="",this.Fe(),ua(5011);var b=this;G.load("autocomplete",function(){b.wc()})}function sa(a,b){this.B="string"==typeof a?t.R(a):a,this.k={linksControl:i,enableScrollWheelZoom:i,navigationControl:i,panoramaRenderer:"flash",swfSrc:"http://api.map.baidu.com/res/swf/APILoader.swf",visible:i};var c,b=b||{};for(c in b)this.k[c]=b[c];this.Ra={heading:0,pitch:0},this.Zn=[],this.qb=this.Oa=n,this.Fl=this.ll(),this.fa=[],this.Yb=1,this.Al=this.iE=this.Kg="",this.He=[],this.Bl=[];var d=this;za()&&!H()&&"javascript"!=b.panoramaRenderer?G.load("panoramaflash",function(){d.Fe()},i):G.load("panorama",function(){d.Wb()},i),ua(5044,{type:b.panoramaRenderer}),"api"==b.Uj?ua(5036):ua(5039)}function zb(a,b){this.Q=a||n;var c=this;c.Q&&c.N(),G.load("panoramaservice",function(){c.wC()}),"api"==(b||{}).Uj?ua(5037):ua(5040)}function yb(a){Vb.call(this),"api"==(a||{}).Uj?ua(5038):ua(5041)}function S(a,b){for(var c in b)a[c]=b[c]}var aa=void 0,i=!0,n=null,o=!1,ea=[],ha,t=ha=t||{version:"1.3.4"};t.L="$BAIDU$",window[t.L]=window[t.L]||{},t.object=t.object||{},t.extend=t.object.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a},t.z=t.z||{},t.z.R=function(a){return"string"==typeof a||a instanceof String?document.getElementById(a):a&&a.nodeName&&(1==a.nodeType||9==a.nodeType)?a:n},t.R=t.uc=t.z.R,t.z.H=function(a){return a=t.z.R(a),a.style.display="none",a},t.H=t.z.H,t.lang=t.lang||{},t.lang.qe=function(a){return"[object String]"==Object.prototype.toString.call(a)},t.qe=t.lang.qe,t.z.Lg=function(a){return t.lang.qe(a)?document.getElementById(a):a},t.Lg=t.z.Lg,t.z.contains=function(a,b){var c=t.z.Lg,a=c(a),b=c(b);return a.contains?a!=b&&a.contains(b):!!(16&a.compareDocumentPosition(b))},t.M=t.M||{},/msie (\d+\.\d)/i.test(navigator.userAgent)&&(t.M.S=t.S=document.documentMode||+RegExp.$1);var ia={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",rowspan:"rowSpan",valign:"vAlign",usemap:"useMap",frameborder:"frameBorder"};8>t.M.S?(ia["for"]="htmlFor",ia["class"]="className"):(ia.htmlFor="for",ia.className="class"),t.z.Nv=ia,t.z.Tu=function(a,b,c){return a=t.z.R(a),"style"==b?a.style.cssText=c:(b=t.z.Nv[b]||b,a.setAttribute(b,c)),a},t.Tu=t.z.Tu,t.z.Uu=function(a,b){var c,a=t.z.R(a);for(c in b)t.z.Tu(a,c,b[c]);return a},t.Uu=t.z.Uu,t.df=t.df||{},function(){var a=RegExp("(^[\\s\\t\\xa0\\u3000]+)|([\\u3000\\xa0\\s\\t]+$)","g");t.df.trim=function(b){return(""+b).replace(a,"")}}(),t.trim=t.df.trim,t.df.Gi=function(a,b){var a=""+a,c=Array.prototype.slice.call(arguments,1),d=Object.prototype.toString;return c.length?(c=1==c.length?b!==n&&/\[object Array\]|\[object Object\]/.test(d.call(b))?b:c:c,a.replace(/#\{(.+?)\}/g,function(a,b){var g=c[b];return"[object Function]"==d.call(g)&&(g=g(b)),"undefined"==typeof g?"":g})):a},t.Gi=t.df.Gi,t.z.Rb=function(a,b){for(var e,g,a=t.z.R(a),c=a.className.split(/\s+/),d=b.split(/\s+/),f=d.length,j=0;f>j;++j)for(g=0,e=c.length;e>g;++g)if(c[g]==d[j]){c.splice(g,1);break}return a.className=c.join(" "),a},t.Rb=t.z.Rb,t.z.eu=function(a,b,c){var d,a=t.z.R(a);return a.insertAdjacentHTML?a.insertAdjacentHTML(b,c):(d=a.ownerDocument.createRange(),b=b.toUpperCase(),"AFTERBEGIN"==b||"BEFOREEND"==b?(d.selectNodeContents(a),d.collapse("AFTERBEGIN"==b)):(b="BEFOREBEGIN"==b,d[b?"setStartBefore":"setEndAfter"](a),d.collapse(b)),d.insertNode(d.createContextualFragment(c))),a},t.eu=t.z.eu,t.z.show=function(a){return a=t.z.R(a),a.style.display="",a},t.show=t.z.show,t.z.Et=function(a){return a=t.z.R(a),9==a.nodeType?a:a.ownerDocument||a.document},t.z.$a=function(a,b){for(var a=t.z.R(a),c=b.split(/\s+/),d=a.className,e=" "+d+" ",f=0,g=c.length;g>f;f++)e.indexOf(" "+c[f]+" ")<0&&(d+=" "+c[f]);return a.className=d,a},t.$a=t.z.$a,t.z.hs=t.z.hs||{},t.z.ei=t.z.ei||[],t.z.ei.filter=function(a,b,c){for(var f,d=0,e=t.z.ei;f=e[d];d++)(f=f[c])&&(b=f(a,b));return b},t.df.rB=function(a){return a.indexOf("-")<0&&a.indexOf("_")<0?a:a.replace(/[-_][^-_]/g,function(a){return a.charAt(1).toUpperCase()})},t.z.XM=function(a,b){t.z.$t(a,b)?t.z.Rb(a,b):t.z.$a(a,b)},t.z.$t=function(a){if(arguments.length<=0||"function"==typeof a)return this;if(this.size()<=0)return o;var c,a=a.replace(/^\s+/g,"").replace(/\s+$/g,"").replace(/\s+/g," "),b=a.split(" ");return t.forEach(this,function(a){for(var a=a.className,e=0;e<b.length;e++)if(!~(" "+a+" ").indexOf(" "+b[e]+" "))return c=o,void 0;c!==o&&(c=i)}),c},t.z.xg=function(a,b){var c=t.z,a=c.R(a),b=t.df.rB(b),d=a.style[b];if(!d)var e=c.hs[b],d=a.currentStyle||(t.M.S?a.style:getComputedStyle(a,n)),d=e&&e.get?e.get(a,d):d[e||b];return(e=c.ei)&&(d=e.filter(b,d,"get")),d},t.xg=t.z.xg,/opera\/(\d+\.\d)/i.test(navigator.userAgent)&&(t.M.opera=+RegExp.$1),t.M.Wz=/webkit/i.test(navigator.userAgent),t.M.yI=/gecko/i.test(navigator.userAgent)&&!/like gecko/i.test(navigator.userAgent),t.M.lu="CSS1Compat"==document.compatMode,t.z.ca=function(a){var a=t.z.R(a),b=t.z.Et(a),c=t.M,d=t.z.xg;c.yI>0&&b.getBoxObjectFor&&d(a,"position");var f,e={left:0,top:0};if(a==(c.S&&!c.lu?b.body:b.documentElement))return e;if(a.getBoundingClientRect)a=a.getBoundingClientRect(),e.left=Math.floor(a.left)+Math.max(b.documentElement.scrollLeft,b.body.scrollLeft),e.top=Math.floor(a.top)+Math.max(b.documentElement.scrollTop,b.body.scrollTop),e.left=e.left-b.documentElement.clientLeft,e.top=e.top-b.documentElement.clientTop,a=b.body,b=parseInt(d(a,"borderLeftWidth")),d=parseInt(d(a,"borderTopWidth")),c.S&&!c.lu&&(e.left=e.left-(isNaN(b)?2:b),e.top=e.top-(isNaN(d)?2:d));else{f=a;do{if(e.left=e.left+f.offsetLeft,e.top=e.top+f.offsetTop,c.Wz>0&&"fixed"==d(f,"position")){e.left=e.left+b.body.scrollLeft,e.top=e.top+b.body.scrollTop;break}f=f.offsetParent}while(f&&f!=a);for((c.opera>0||c.Wz>0&&"absolute"==d(a,"position"))&&(e.top=e.top-b.body.offsetTop),f=a.offsetParent;f&&f!=b.body;)e.left=e.left-f.scrollLeft,c.opera&&"TR"==f.tagName||(e.top=e.top-f.scrollTop),f=f.offsetParent}return e},/firefox\/(\d+\.\d)/i.test(navigator.userAgent)&&(t.M.Pe=+RegExp.$1);var ja=navigator.userAgent;/(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(ja)&&!/chrome/i.test(ja)&&(t.M.BJ=+(RegExp.$1||RegExp.$2)),/chrome\/(\d+\.\d)/i.test(navigator.userAgent)&&(t.M.uy=+RegExp.$1),t.Mb=t.Mb||{},t.Mb.Xd=function(a,b){var c,d,e=a.length;if("function"==typeof b)for(d=0;e>d&&(c=a[d],c=b.call(a,c,d),c!==o);d++);return a},t.Xd=t.Mb.Xd,t.lang.L=function(){return"TANGRAM__"+(window[t.L]._counter++).toString(36)},window[t.L]._counter=window[t.L]._counter||1,window[t.L]._instances=window[t.L]._instances||{},t.lang.jk=function(a){return"[object Function]"==Object.prototype.toString.call(a)},t.lang.la=function(a){this.L=a||t.lang.L(),window[t.L]._instances[this.L]=this},window[t.L]._instances=window[t.L]._instances||{},t.lang.la.prototype.Df=fa(1),t.lang.la.prototype.toString=function(){return"[object "+(this.hw||"Object")+"]"},t.lang.oq=function(a,b){this.type=a,this.returnValue=i,this.target=b||n,this.currentTarget=n},t.lang.la.prototype.addEventListener=function(a,b,c){if(t.lang.jk(b)){!this.$f&&(this.$f={});var e,d=this.$f;if("string"==typeof c&&c){if(/[^\w\-]/.test(c))throw"nonstandard key:"+c;e=b.Cz=c}0!=a.indexOf("on")&&(a="on"+a),"object"!=typeof d[a]&&(d[a]={}),e=e||t.lang.L(),b.Cz=e,d[a][e]=b}},t.lang.la.prototype.removeEventListener=function(a,b){if(t.lang.jk(b))b=b.Cz;else if(!t.lang.qe(b))return;!this.$f&&(this.$f={}),0!=a.indexOf("on")&&(a="on"+a);var c=this.$f;c[a]&&c[a][b]&&delete c[a][b]},t.lang.la.prototype.dispatchEvent=function(a,b){t.lang.qe(a)&&(a=new t.lang.oq(a)),!this.$f&&(this.$f={});var c,b=b||{};for(c in b)a[c]=b[c];var d=this.$f,e=a.type;if(a.target=a.target||this,a.currentTarget=this,0!=e.indexOf("on")&&(e="on"+e),t.lang.jk(this[e])&&this[e].apply(this,arguments),"object"==typeof d[e])for(c in d[e])d[e][c].apply(this,arguments);return a.returnValue},t.lang.ia=function(a,b,c){var d,e,f=a.prototype;e=new Function,e.prototype=b.prototype,e=a.prototype=new e;for(d in f)e[d]=f[d];a.prototype.constructor=a,a.jB=b.prototype,"string"==typeof c&&(e.hw=c)},t.ia=t.lang.ia,t.lang.Bc=function(a){return window[t.L]._instances[a]||n},t.platform=t.platform||{},t.platform.CI=/macintosh/i.test(navigator.userAgent),t.platform.Xz=/windows/i.test(navigator.userAgent),t.platform.II=/x11/i.test(navigator.userAgent),t.platform.ik=/android/i.test(navigator.userAgent),/android (\d+\.\d)/i.test(navigator.userAgent)&&(t.platform.dy=t.dy=RegExp.$1),t.platform.AI=/ipad/i.test(navigator.userAgent),t.platform.BI=/iphone/i.test(navigator.userAgent),t.lang.Xo=function(a){var b=window[t.L];b.YD&&delete b.YD[a]},t.event={},t.C=t.event.C=function(a,b,c){return(a=t.R(a))?(b=b.replace(/^on/,""),a.addEventListener?a.addEventListener(b,c,o):a.attachEvent&&a.attachEvent("on"+b,c),a):a},t.Yc=t.event.Yc=function(a,b,c){return(a=t.R(a))?(b=b.replace(/^on/,""),a.removeEventListener?a.removeEventListener(b,c,o):a.detachEvent&&a.detachEvent("on"+b,c),a):a},t.z.$t=function(a,b){if(!a||!a.className||"string"!=typeof a.className)return o;var c=-1;try{c=a.className==b||a.className.search(RegExp("(\\s|^)"+b+"(\\s|$)"))}catch(d){return o}return c>-1},t.it=function(){function a(a){document.addEventListener&&(this.element=a,this.$y=this.Ri?"touchstart":"mousedown",this.mt=this.Ri?"touchmove":"mousemove",this.lt=this.Ri?"touchend":"mouseup",this.uu=o,this.fB=this.eB=0,this.element.addEventListener(this.$y,this,o),ha.C(this.element,"mousedown",q()),this.handleEvent(n))}return a.prototype={Ri:"ontouchstart"in window||"createTouch"in document,start:function(a){A(a),this.uu=o,this.eB=this.Ri?a.touches[0].clientX:a.clientX,this.fB=this.Ri?a.touches[0].clientY:a.clientY,this.element.addEventListener(this.mt,this,o),this.element.addEventListener(this.lt,this,o)},move:function(a){ka(a);var c=this.Ri?a.touches[0].clientY:a.clientY;(10<Math.abs((this.Ri?a.touches[0].clientX:a.clientX)-this.eB)||10<Math.abs(c-this.fB))&&(this.uu=i)},end:function(a){ka(a),this.uu||(a=document.createEvent("Event"),a.initEvent("tap",o,i),this.element.dispatchEvent(a)),this.element.removeEventListener(this.mt,this,o),this.element.removeEventListener(this.lt,this,o)},handleEvent:function(a){if(a)switch(a.type){case this.$y:this.start(a);break;case this.mt:this.move(a);break;case this.lt:this.end(a)}}},function(b){return new a(b)}}();var B=window.BMap||{};B.version="2.0",B.El=[],B.rd=function(a){this.El.push(a)},B.Qr=[],B.Au=function(a){this.Qr.push(a)},B.HF=B.apiLoad||q();var la=window.BMAP_AUTHENTIC_KEY;window.BMAP_AUTHENTIC_KEY=n;var ma=window.BMap_loadScriptTime,na=(new Date).getTime(),oa=n,pa=i;t.lang.ia(qa,t.lang.la,"Map"),t.extend(qa.prototype,{ua:function(){var a=J("div"),b=a.style;b.overflow="visible",b.position="absolute",b.zIndex="0",b.top=b.left="0px";var b=J("div",{"class":"BMap_mask"}),c=b.style;return c.position="absolute",c.top=c.left="0px",c.zIndex="9",c.overflow="hidden",c.WebkitUserSelect="none",a.appendChild(b),a},cs:function(a){var b=a.style;b.overflow="hidden","absolute"!=Aa(a).position&&(b.position="relative",b.zIndex=0),b.backgroundColor="#F3F1EC",b.color="#000",b.textAlign="left"},N:function(){var a=this;a.Ml=function(){var b=a.Fb();if(a.width!=b.width||a.height!=b.height){var c=new K(a.width,a.height),d=new L("onbeforeresize");d.size=c,a.dispatchEvent(d),a.Wg((b.width-a.width)/2,(b.height-a.height)/2),a.Hd.style.width=(a.width=b.width)+"px",a.Hd.style.height=(a.height=b.height)+"px",c=new L("onresize"),c.size=b,a.dispatchEvent(c)}},a.F.ap&&(a.D.Pl=setInterval(a.Ml,80))},Wg:function(a,b,c,d){var e=this.ha().Ib(this.U()),f=this.Tc,g=i;c&&F.Oz(c)&&(this.Le=new F(c.lng,c.lat),g=o),(c=c&&d?f.Vi(c,this.Db):this.Ob)&&(this.Ob=new F(c.lng+a*e,c.lat-b*e),(a=f.uh(this.Ob,this.Db))&&g&&(this.Le=a))},gf:function(a,b){if(Ba(a)&&(a=this.xj(a).zoom,a!=this.na)){this.ac=this.na,this.na=a;var c;b?c=b:this.Se()&&(c=this.Se().ca()),c&&(c=this.nb(c,this.ac),this.Wg(this.width/2-c.x,this.height/2-c.y,this.Ua(c,this.ac),i)),this.dispatchEvent(new L("onzoomstart")),this.dispatchEvent(new L("onzoomstartcode"))}},Jc:function(a){this.gf(a)},pv:function(a){this.gf(this.na+1,a)},qv:function(a){this.gf(this.na-1,a)},ue:function(a){a instanceof F&&(this.Ob=this.Tc.Vi(a,this.Db),this.Le=F.Oz(a)?new F(a.lng,a.lat):this.Tc.uh(this.Ob,this.Db))},te:function(a,b){a=Math.round(a)||0,b=Math.round(b)||0,this.Wg(-a,-b)},Eo:function(a){a&&Ca(a.Qd)&&(a.Qd(this),this.dispatchEvent(new L("onaddcontrol",a)))},NA:function(a){a&&Ca(a.remove)&&(a.remove(),this.dispatchEvent(new L("onremovecontrol",a)))},Oj:function(a){a&&Ca(a.ta)&&(a.ta(this),this.dispatchEvent(new L("onaddcontextmenu",a)))},rk:function(a){a&&Ca(a.remove)&&(this.dispatchEvent(new L("onremovecontextmenu",a)),a.remove())},Wa:function(a){a&&Ca(a.Qd)&&(a.Qd(this),this.dispatchEvent(new L("onaddoverlay",a)))},Uc:function(a){a&&Ca(a.remove)&&(a.remove(),this.dispatchEvent(new L("onremoveoverlay",a)))},wy:function(){this.dispatchEvent(new L("onclearoverlays"))},Af:function(a){a&&this.dispatchEvent(new L("onaddtilelayer",a))},Qf:function(a){a&&this.dispatchEvent(new L("onremovetilelayer",a))},Cg:function(a){if(this.yb!==a){var b=new L("onsetmaptype");b.HM=this.yb,this.yb=this.F.yb=a,this.Tc=this.yb.Ni(),this.Wg(0,0,this.Ga(),i),this.Lq();var c=this.xj(this.U()).zoom;this.gf(c),this.dispatchEvent(b),b=new L("onmaptypechange"),b.na=c,b.yb=a,this.dispatchEvent(b),(a===va||a===xa)&&ua(5003)}},ve:function(a){var b=this;if(a instanceof F)b.ue(a,{noAnimation:i});else if(Da(a))if(b.yb==ta){var c=C.Cs[a];c&&(pt=c.m,b.ve(pt))}else{var d=this.Kw();d.Zu(function(c){0==d.Oi()&&2==d.oa.result.type&&(b.ve(c.kh(0).point),ta.Wj(a)&&b.Wu(a))}),d.search(a,{log:"center"})}},Wd:function(a,b){var c=this;if(Da(a))if(c.yb==ta){var d=C.Cs[a];d&&(pt=d.m,c.Wd(pt,b))}else{var e=c.Kw();e.Zu(function(d){if(0==e.Oi()&&2==e.oa.result.type){var d=d.kh(0).point,f=b||N.yt(e.oa.content.level,c);c.Wd(d,f),ta.Wj(a)&&c.Wu(a)}}),e.search(a,{log:"center"})}else if(a instanceof F&&b){b=c.xj(b).zoom,c.ac=c.na||b,c.na=b,c.Le=new F(a.lng,a.lat),c.Ob=c.Tc.Vi(c.Le,c.Db),c.Ns=c.Ns||c.na,c.Ms=c.Ms||c.Le;var d=new L("onload"),f=new L("onloadcode");d.point=new F(a.lng,a.lat),d.pixel=c.nb(c.Le,c.na),d.zoom=b,c.loaded||(c.loaded=i,c.dispatchEvent(d),oa||(oa=Ea())),c.dispatchEvent(f),c.dispatchEvent(new L("onmoveend")),c.ac!=c.na&&c.dispatchEvent(new L("onzoomend"))}},Kw:function(){return this.D.fA||(this.D.fA=new Fa(1)),this.D.fA},reset:function(){this.Wd(this.Ms,this.Ns,i)},enableDragging:function(){this.F.Eb=i},disableDragging:function(){this.F.Eb=o},enableInertialDragging:function(){this.F.bp=i},disableInertialDragging:function(){this.F.bp=o},enableScrollWheelZoom:function(){this.F.im=i},disableScrollWheelZoom:function(){this.F.im=o},enableContinuousZoom:function(){this.F.gm=i},disableContinuousZoom:function(){this.F.gm=o},enableDoubleClickZoom:function(){this.F.ct=i},disableDoubleClickZoom:function(){this.F.ct=o},enableKeyboard:function(){this.F.cp=i},disableKeyboard:function(){this.F.cp=o},enablePinchToZoom:function(){this.F.hm=i},disablePinchToZoom:function(){this.F.hm=o},enableAutoResize:function(){this.F.ap=i,this.Ml(),this.D.Pl||(this.D.Pl=setInterval(this.Ml,80))},disableAutoResize:function(){this.F.ap=o,this.D.Pl&&(clearInterval(this.D.Pl),this.D.Pl=n)},Fb:function(){return this.$l&&this.$l instanceof K?new K(this.$l.width,this.$l.height):new K(this.xa.clientWidth,this.xa.clientHeight)},Ic:function(a){a&&a instanceof K?(this.$l=a,this.xa.style.width=a.width+"px",this.xa.style.height=a.height+"px"):this.$l=n},Ga:s("Le"),U:s("na"),bG:function(){this.Ml()},xj:function(a){var b=this.F.oc,c=this.F.od,d=o;return b>a&&(d=i,a=b),a>c&&(d=i,a=c),{zoom:a,nt:d}},Ba:s("xa"),nb:function(a,b){return b=b||this.U(),this.Tc.nb(a,b,this.Ob,this.Fb(),this.Db)},Ua:function(a,b){return b=b||this.U(),this.Tc.Ua(a,b,this.Ob,this.Fb(),this.Db)},$e:function(a,b){if(a){var c=this.nb(new F(a.lng,a.lat),b);return c.x-=this.offsetX,c.y-=this.offsetY,c}},FA:function(a,b){if(a){var c=new O(a.x,a.y);return c.x+=this.offsetX,c.y+=this.offsetY,this.Ua(c,b)}},pointToPixelFor3D:function(a,b){var c=map.Db;this.yb==ta&&c&&Ga.By(a,this,b)},CM:function(a,b){var c=map.Db;this.yb==ta&&c&&Ga.Ay(a,this,b)},DM:function(a,b){var c=this,d=map.Db;c.yb==ta&&d&&Ga.By(a,c,function(a){a.x-=c.offsetX,a.y-=c.offsetY,b&&b(a)})},BM:function(a,b){var c=map.Db;this.yb==ta&&c&&(a.x+=this.offsetX,a.y+=this.offsetY,Ga.Ay(a,this,b))},vg:function(a){if(!this.iu())return new Ia;var b=a||{},a=b.margins||[0,0,0,0],c=b.zoom||n,b=this.Ua({x:a[3],y:this.height-a[2]},c),a=this.Ua({x:this.width-a[1],y:a[0]},c);return new Ia(b,a)},iu:function(){return!!this.loaded},sD:function(a,b){for(var c=this.ha(),d=b.margins||[10,10,10,10],e=b.zoomFactor||0,f=d[1]+d[3],d=d[0]+d[2],g=c.Yj(),j=c=c.Li();j>=g;j--){var k=this.ha().Ib(j);if(a.lv().lng/k<this.width-f&&a.lv().lat/k<this.height-d)break}return j+=e,g>j&&(j=g),j>c&&(j=c),j},qp:function(a,b){var c={center:this.Ga(),zoom:this.U()};if(!a||!a instanceof Ia&&0==a.length||a instanceof Ia&&a.zg())return c;var d=[];a instanceof Ia?(d.push(a.oe()),d.push(a.pe())):d=a.slice(0);for(var b=b||{},e=[],f=0,g=d.length;g>f;f++)e.push(this.Tc.Vi(d[f],this.Db));for(d=new Ia,f=e.length-1;f>=0;f--)d.extend(e[f]);return d.zg()?c:(c=d.Ga(),e=this.sD(d,b),b.margins&&(d=b.margins,f=(d[1]-d[3])/2,d=(d[0]-d[2])/2,g=this.ha().Ib(e),b.offset&&(f=b.offset.width,d=b.offset.height),c.lng+=g*f,c.lat+=g*d),c=this.Tc.uh(c,this.Db),{center:c,zoom:e})},zk:function(a,b){var c;c=a&&a.center?a:this.qp(a,b);var b=b||{},d=b.delay||200;if(c.zoom==this.na&&b.enableAnimation!=o){var e=this;setTimeout(function(){e.ue(c.center,{duration:210})},d)}else this.Wd(c.center,c.zoom)},Ue:s("Lc"),Se:function(){return this.D.Ja&&this.D.Ja.za()?this.D.Ja:n},getDistance:function(a,b){if(a&&b){var c=0,c=P.Dt(a,b);
return(c==n||c==aa)&&(c=0),c}},Pt:function(){var a=[],b=this.fa,c=this.ad;if(b)for(var d in b)b[d]instanceof Q&&a.push(b[d]);if(c)for(d=0,b=c.length;b>d;d++)a.push(c[d]);return a},ha:s("yb"),Fq:function(){for(var a=this.D.Ku;a<B.El.length;a++)B.El[a](this);this.D.Ku=a},Wu:function(a){this.Db=ta.Wj(a),this.As=ta.qH(this.Db),this.yb==ta&&this.Tc instanceof Ja&&(this.Tc.Is=this.Db)},setDefaultCursor:function(a){this.F.mb=a,this.platform&&(this.platform.style.cursor=this.F.mb)},getDefaultCursor:function(){return this.F.mb},setDraggingCursor:function(a){this.F.mc=a},getDraggingCursor:function(){return this.F.mc},ph:ca(o),Ho:function(a,b){b?this.rf[b]||(this.rf[b]={}):b="custom",a.tag=b,a instanceof Ka&&(this.rf[b][a.L]=a,a.ta(this));var c=this;G.load("hotspot",function(){c.Fq()})},qJ:function(a,b){b||(b="custom"),this.rf[b][a.L]&&delete this.rf[b][a.L]},si:function(a){a||(a="custom"),this.rf[a]={}},Lq:function(){var a=this.ph()?this.yb.k.kI:this.yb.Yj(),b=this.ph()?this.yb.k.jI:this.yb.Li(),c=this.F;c.oc=c.zB||a,c.od=c.yB||b,c.oc<a&&(c.oc=a),c.od>b&&(c.od=b)},setMinZoom:function(a){a>this.F.od&&(a=this.F.od),this.F.zB=a,this.Px()},setMaxZoom:function(a){a<this.F.oc&&(a=this.F.oc),this.F.yB=a,this.Px()},Px:function(){this.Lq();var a=this.F;this.na<a.oc?this.Jc(a.oc):this.na>a.od&&this.Jc(a.od);var b=new L("onzoomspanchange");b.oc=a.oc,b.od=a.od,this.dispatchEvent(b)},iM:s("ms"),getKey:function(){return la},XA:function(a){a&&(a.styleId?this.yz(a.styleId):(this.F.nc=a,this.dispatchEvent(new L("onsetcustomstyles",a)),this.Kz(a.controls),this.Lz(this.F.nc.geotableId)),a.style)&&(a=this.F.Cf[a.style]?this.F.Cf[a.style].backColor:this.F.Cf.normal.backColor,this.Ba().style.backgroundColor=a)},yz:function(a){var b=this;La("http://api.map.baidu.com/style/poi/personalize?method=get&ak="+la+"&id="+a,function(a){if(a&&a.content&&0<a.content.length){var a=a.content[0],d={};a.features&&0<a.features.length&&(d.features=a.features),a.controllers&&0<a.controllers.length&&(d.controls=a.controllers),a.style&&""!=a.style&&(d.style=a.style),a.geotable_id&&""!=a.geotable_id&&(d.geotableId=a.geotable_id),setTimeout(function(){b.XA(d)},200)}})},Kz:function(a){this.controls||(this.controls={navigationControl:new Ma,scaleControl:new Na,overviewMapControl:new Oa,mapTypeControl:new Pa});var c,b=this;for(c in this.controls)b.NA(b.controls[c]);a=a||[],t.Mb.Xd(a,function(a){b.Eo(b.controls[a])})},Lz:function(a){a?this.Yl&&this.Yl.he==a||(this.Qf(this.Yl),this.Yl=new Qa({geotableId:a}),this.Af(this.Yl)):this.Qf(this.Yl)},tc:function(){var a=this.U()>=this.F.DB&&this.ha()==ra&&18>=this.U(),b=o;try{document.createElement("canvas").getContext("2d"),b=i}catch(c){b=o}return a&&b},getCurrentCity:function(){return{name:this.Tl,code:this.vs}},getPanorama:s("Q"),setPanorama:function(a){this.Q=a,this.Q.Xu(this)}});var Ra,Ua,Ta=[],Sa=new Image;ua(5e3);var Xa="INFINITE";Va.prototype.start=function(){this.Bn=Ea(),this.br=this.Bn+this.k.duration,Ya(this)},Va.prototype.add=fa(0),Va.prototype.stop=function(a){this.gv=i;for(var b=0;b<this.be.length;b++)this.be[b].stop(),this.be[b]=n;this.be.length=0,this.Kl&&(clearTimeout(this.Kl),this.Kl=n),this.k.yu(this.Vp),a&&(this.br=this.Bn,Ya(this))},Va.prototype.cancel=fa(2);var Wa={dA:function(a){return a},reverse:function(a){return 1-a},$s:function(a){return a*a},$G:function(a){return Math.pow(a,3)},bH:function(a){return-(a*(a-2))},aH:function(a){return Math.pow(a-1,3)+1},Wy:function(a){return.5>a?2*a*a:-2*(a-2)*a-1},IL:function(a){return.5>a?4*Math.pow(a,3):4*Math.pow(a-1,3)+1},JL:function(a){return(1-Math.cos(Math.PI*a))/2}};Wa["ease-in"]=Wa.$s,Wa["ease-out"]=Wa.bH;var C={ba:"http://api0.map.bdimg.com/images/",Cs:{"北京":{Np:"bj",m:new F(116.403874,39.914889)},"上海":{Np:"sh",m:new F(121.487899,31.249162)},"深圳":{Np:"sz",m:new F(114.025974,22.546054)},"广州":{Np:"gz",m:new F(113.30765,23.120049)}},fontFamily:"arial,sans-serif"};t.M.Pe?(t.extend(C,{Ny:"url("+C.ba+"ruler.cur),crosshair",mb:"-moz-grab",mc:"-moz-grabbing"}),t.platform.Xz&&(C.fontFamily="arial,simsun,sans-serif")):t.M.uy||t.M.BJ?t.extend(C,{Ny:"url("+C.ba+"ruler.cur) 2 6,crosshair",mb:"url("+C.ba+"openhand.cur) 8 8,default",mc:"url("+C.ba+"closedhand.cur) 8 8,move"}):t.extend(C,{Ny:"url("+C.ba+"ruler.cur),crosshair",mb:"url("+C.ba+"openhand.cur),default",mc:"url("+C.ba+"closedhand.cur),move"});var jb="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",L=t.lang.oq,pb={map:"yzm00d",common:"gdx5gm",tile:"a3eyso",marker:"jhxop3",markeranimation:"ygp4ek",poly:"ueadjd",draw:"xvide4",drawbysvg:"urehax",drawbyvml:"cckpb2",drawbycanvas:"v0bddq",infowindow:"eicb5o",oppc:"4onuhp",opmb:"oskerp",menu:"l2utkb",control:"d1gwmb",navictrl:"hhwgz2",geoctrl:"lw1gax",copyrightctrl:"oe0kxo",scommon:"ojthft",local:"b1ev55",route:"fqqtny",othersearch:"2r3kzj",mapclick:"ajps3r",buslinesearch:"3myxaq",hotspot:"ndeby4",autocomplete:"uquuxf",coordtrans:"bpmno5",coordtransutils:"c5cfrn",clayer:"frdiae",panorama:"gsoea1",panoramaservice:"3fomck",panoramaflash:"nbtqkc",mapclick:"ajps3r",vector:"wiheem"};t.eq=function(){function a(a){return d&&!!c[b+a+"_"+pb[a]]}var b="BMap_",c=window.localStorage,d="localStorage"in window&&c!==n&&c!==aa;return{FI:d,set:function(a,f){if(d){for(var k,g=b+a+"_",j=c.length;j--;)k=c.key(j),-1<k.indexOf(g)&&c.removeItem(k);try{c.setItem(b+a+"_"+pb[a],f)}catch(l){c.clear()}}},get:function(e){return d&&a(e)?c.getItem(b+e+"_"+pb[e]):o},qy:a}}(),t.object.extend(G,{Fg:{Bv:-1,cC:0,Ik:1},jz:function(){var a="drawbysvg";return nb()?a="drawbysvg":mb()?a="drawbyvml":ob()&&(a="drawbycanvas"),{control:[],marker:[],poly:["marker",a],drawbysvg:["draw"],drawbyvml:["draw"],drawbycanvas:["draw"],infowindow:["common","marker"],menu:[],oppc:[],opmb:[],scommon:[],local:["scommon"],route:["scommon"],othersearch:["scommon"],autocomplete:["scommon"],mapclick:["scommon"],buslinesearch:["route"],hotspot:[],coordtransutils:["coordtrans"],clayer:["tile"],panoramaservice:[],panorama:["marker","panoramaservice"],panoramaflash:["panoramaservice"]}},GM:{},uv:{jC:"http://api0.map.bdimg.com/getmodules?v=2.0",sF:5e3},Os:o,vc:{Vh:{},qj:[],so:[]},load:function(a,b,c){var d=this.Xl(a);if(d.Ac==this.Fg.Ik)c&&b();else{if(d.Ac==this.Fg.Bv){this.yy(a),this.LA(a);var e=this;e.Os==o&&(e.Os=i,setTimeout(function(){for(var a=[],b=0,c=e.vc.qj.length;c>b;b++){var d=e.vc.qj[b],l="";ha.eq.qy(d)?l=ha.eq.get(d):(l="",a.push(d+"_"+pb[d])),e.vc.so.push({pA:d,su:l})}e.Os=o,e.vc.qj.length=0,0==a.length?e.Zy():La(e.uv.jC+"&mod="+a.join(","))},1)),d.Ac=this.Fg.cC}d.Cn.push(b)}},yy:function(a){if(a&&this.jz()[a])for(var a=this.jz()[a],b=0;b<a.length;b++)this.yy(a[b]),this.vc.Vh[a[b]]||this.LA(a[b])},LA:function(a){for(var b=0;b<this.vc.qj.length;b++)if(this.vc.qj[b]==a)return;this.vc.qj.push(a)},AJ:function(a,b){var c=this.Xl(a);try{eval(b)}catch(d){return}c.Ac=this.Fg.Ik;for(var e=0,f=c.Cn.length;f>e;e++)c.Cn[e]();c.Cn.length=0},qy:function(a,b){var c=this;c.timeout=setTimeout(function(){c.vc.Vh[a].Ac!=c.Fg.Ik?(c.remove(a),c.load(a,b)):clearTimeout(c.timeout)},c.uv.sF)},Xl:function(a){return this.vc.Vh[a]||(this.vc.Vh[a]={},this.vc.Vh[a].Ac=this.Fg.Bv,this.vc.Vh[a].Cn=[]),this.vc.Vh[a]},remove:function(a){delete this.Xl(a)},$F:function(a,b){for(var c=this.vc.so,d=i,e=0,f=c.length;f>e;e++)""==c[e].su&&(c[e].pA==a?c[e].su=b:d=o);d&&this.Zy()},Zy:function(){for(var a=this.vc.so,b=0,c=a.length;c>b;b++)this.AJ(a[b].pA,a[b].su);this.vc.so.length=0}}),O.prototype.bb=function(a){return a&&a.x==this.x&&a.y==this.y},K.prototype.bb=function(a){return a&&this.width==a.width&&this.height==a.height},Ka.L=0,t.extend(Ka.prototype,{ta:function(a){this.uf==n&&(this.uf=a.F.oc),this.Td==n&&(this.Td=a.F.od)},da:function(a){a instanceof F&&(this.qb=a)},ca:s("qb"),Vm:ba("lg"),Vt:s("lg"),setUserData:ba("Qx"),getUserData:s("Qx")}),t.lang.ia(R,t.lang.la,"Control"),t.extend(R.prototype,{initialize:function(a){return this.A=a,this.B?(a.xa.appendChild(this.B),this.B):void 0},Qd:function(a){!this.B&&this.initialize&&Ca(this.initialize)&&(this.B=this.initialize(a)),this.k=this.k||{bf:o},this.cs(),this.no(),this.B&&(this.B.sl=this)},cs:function(){var a=this.B;if(a){var b=a.style;b.position="absolute",b.zIndex=this.Hq||"10",b.MozUserSelect="none",b.WebkitTextSizeAdjust="none",this.k.bf||t.z.$a(a,"BMap_noprint"),H()||t.C(a,"contextmenu",ka)}},remove:function(){this.A=n,this.B&&(this.B.parentNode&&this.B.parentNode.removeChild(this.B),this.B=this.B.sl=n)},ab:function(){return this.B=bb(this.A.xa,"<div unselectable='on'></div>"),this.vb==o&&t.z.H(this.B),this.B},no:function(){this.Sb(this.k.anchor)},Sb:function(a){(this.tL||!Ba(a)||isNaN(a)||qb>a||a>3)&&(a=this.defaultAnchor),this.k=this.k||{bf:o},this.k.ga=this.k.ga||this.defaultOffset;var b=this.k.anchor;if(this.k.anchor=a,this.B){var c=this.B,d=this.k.ga.width,e=this.k.ga.height;switch(c.style.left=c.style.top=c.style.right=c.style.bottom="auto",a){case qb:c.style.top=e+"px",c.style.left=d+"px";break;case rb:c.style.top=e+"px",c.style.right=d+"px";break;case sb:c.style.bottom=e+"px",c.style.left=d+"px";break;case 3:c.style.bottom=e+"px",c.style.right=d+"px"}c=["TL","TR","BL","BR"],t.z.Rb(this.B,"anchor"+c[b]),t.z.$a(this.B,"anchor"+c[a])}},wt:function(){return this.k.anchor},Vc:function(a){a instanceof K&&(this.k=this.k||{bf:o},this.k.ga=new K(a.width,a.height),this.B&&this.Sb(this.k.anchor))},Te:function(){return this.k.ga},md:s("B"),show:function(){this.vb!=i&&(this.vb=i,this.B&&t.z.show(this.B))},H:function(){this.vb!=o&&(this.vb=o,this.B&&t.z.H(this.B))},isPrintable:function(){return!!this.k.bf},Ag:function(){return this.B||this.A?!!this.vb:o}});var qb=0,rb=1,sb=2;t.lang.ia(Ma,R,"NavigationControl"),t.extend(Ma.prototype,{initialize:function(a){return this.A=a,this.B},jj:function(a){this.k.type=Ba(a)&&a>=0&&3>=a?a:0},ek:function(){return this.k.type},Nd:function(){var a=this;G.load("navictrl",function(){a.Md()})}}),t.lang.ia(tb,R,"GeolocationControl"),t.extend(tb.prototype,{initialize:function(a){return this.A=a,this.B},Nd:function(){var a=this;G.load("geoctrl",function(){a.Md()})},getAddressComponent:function(){return this.by||n},location:function(){this.k.Xy=i}}),t.lang.ia(ub,R,"CopyrightControl"),t.object.extend(ub.prototype,{initialize:function(a){return this.A=a,this.B},Fo:function(a){if(a&&Ba(a.id)&&!isNaN(a.id)){var c,b={bounds:n,content:""};for(c in a)b[c]=a[c];if(a=this.Ii(a.id))for(var d in b)a[d]=b[d];else this.hb.push(b)}},Ii:function(a){for(var b=0,c=this.hb.length;c>b;b++)if(this.hb[b].id==a)return this.hb[b]},Ct:s("hb"),Lu:function(a){for(var b=0,c=this.hb.length;c>b;b++)this.hb[b].id==a&&(r=this.hb.splice(b,1),b--,c=this.hb.length)},Nd:function(){var a=this;G.load("copyrightctrl",function(){a.Md()})}}),t.lang.ia(Oa,R,"OverviewMapControl"),t.extend(Oa.prototype,{initialize:function(a){return this.A=a,this.B},Sb:function(a){R.prototype.Sb.call(this,a)},Mc:function(){this.Mc.Gj=i,this.k.za=!this.k.za,this.B||(this.Mc.Gj=o)},Ic:function(a){a instanceof K||(a=new K(150,150)),a.width=0<a.width?a.width:150,a.height=0<a.height?a.height:150,this.k.size=a},Fb:function(){return this.k.size},za:function(){return this.k.za},Nd:function(){var a=this;G.load("control",function(){a.Md()})}}),t.lang.ia(Na,R,"ScaleControl"),t.object.extend(Na.prototype,{initialize:function(a){return this.A=a,this.B},Vu:function(a){this.k.color=a+""},SL:function(){return this.k.color},av:function(a){this.k.Tb=this.xf[a]&&this.xf[a].name||this.k.Tb},bI:function(){return this.k.Tb},Nd:function(){var a=this;G.load("control",function(){a.Md()})}});var wb=0;t.lang.ia(Pa,R,"MapTypeControl"),t.object.extend(Pa.prototype,{initialize:function(a){return this.A=a,this.B},Nd:function(){var a=this;G.load("control",function(){a.Md()})}}),t.lang.ia(xb,R,"PanoramaControl"),t.extend(xb.prototype,{initialize:function(a){return this.A=a,this.B},Nd:function(){var a=this;G.load("control",function(){a.Md()})}}),t.lang.ia(Ab,t.lang.la,"ContextMenu"),t.object.extend(Ab.prototype,{ta:function(a,b){this.A=a,this.Zh=b||n},remove:function(){this.A=this.Zh=n},Io:function(a){if(a&&!("menuitem"!=a.wb||""==a.lg||0>=a.uF)){for(var b=0,c=this.ea.length;c>b;b++)if(this.ea[b]===a)return;this.ea.push(a),this.Ud.push(a)}},removeItem:function(a){if(a&&"menuitem"==a.wb){for(var b=0,c=this.ea.length;c>b;b++)this.ea[b]===a&&(this.ea[b].remove(),this.ea.splice(b,1),c--);for(b=0,c=this.Ud.length;c>b;b++)this.Ud[b]===a&&(this.Ud[b].remove(),this.Ud.splice(b,1),c--)}},qs:function(){this.ea.push({wb:"divider",Jg:this.bd.length}),this.bd.push({z:n})},Nu:function(a){if(this.bd[a]){for(var b=0,c=this.ea.length;c>b;b++)this.ea[b]&&"divider"==this.ea[b].wb&&this.ea[b].Jg==a&&(this.ea.splice(b,1),c--),this.ea[b]&&"divider"==this.ea[b].wb&&this.ea[b].Jg>a&&this.ea[b].Jg--;this.bd.splice(a,1)}},md:s("B"),show:function(){this.sf!=i&&(this.sf=i)},H:function(){this.sf!=o&&(this.sf=o)},LJ:function(a){a&&(this.k.cursor=a)},getItem:function(a){return this.Ud[a]}}),t.lang.ia(Bb,t.lang.la,"MenuItem"),t.object.extend(Bb.prototype,{ta:function(a,b){this.A=a,this.mf=b},remove:function(){this.A=this.mf=n},Vm:function(a){a&&(this.lg=a+"")},md:s("B"),enable:function(){this.pf=i},disable:function(){this.pf=o}}),t.object.extend(Ia.prototype,{zg:function(){return!this.gi||!this.Yh},bb:function(a){return a instanceof Ia&&!this.zg()?this.pe().bb(a.pe())&&this.oe().bb(a.oe()):o},pe:s("gi"),oe:s("Yh"),lG:function(a){return a instanceof Ia&&!this.zg()&&!a.zg()?a.hd>this.hd&&a.ed<this.ed&&a.gd>this.gd&&a.dd<this.dd:o},Ga:function(){return this.zg()?n:new F((this.hd+this.ed)/2,(this.gd+this.dd)/2)},Mz:function(a){if(!(a instanceof Ia)||Math.max(a.hd,a.ed)<Math.min(this.hd,this.ed)||Math.min(a.hd,a.ed)>Math.max(this.hd,this.ed)||Math.max(a.gd,a.dd)<Math.min(this.gd,this.dd)||Math.min(a.gd,a.dd)>Math.max(this.gd,this.dd))return n;var b=Math.max(this.hd,a.hd),c=Math.min(this.ed,a.ed),d=Math.max(this.gd,a.gd),a=Math.min(this.dd,a.dd);return new Ia(new F(b,d),new F(c,a))},mG:function(a){return a instanceof F&&!this.zg()?a.lng>=this.hd&&a.lng<=this.ed&&a.lat>=this.gd&&a.lat<=this.dd:o},extend:function(a){if(a instanceof F){var b=a.lng,a=a.lat;this.gi||(this.gi=new F(0,0)),this.Yh||(this.Yh=new F(0,0)),(!this.hd||this.hd>b)&&(this.gi.lng=this.hd=b),(!this.ed||this.ed<b)&&(this.Yh.lng=this.ed=b),(!this.gd||this.gd>a)&&(this.gi.lat=this.gd=a),(!this.dd||this.dd<a)&&(this.Yh.lat=this.dd=a)}},lv:function(){return this.zg()?new F(0,0):new F(Math.abs(this.ed-this.hd),Math.abs(this.dd-this.gd))}}),F.Oz=function(a){return a&&180>=a.lng&&-180<=a.lng&&74>=a.lat&&-74<=a.lat},F.prototype.bb=function(a){return a&&this.lat==a.lat&&this.lng==a.lng},Cb.prototype.Em=function(){throw"lngLatToPoint方法未实现"},Cb.prototype.xh=function(){throw"pointToLngLat方法未实现"};var Ga={By:function(a,b,c){G.load("coordtransutils",function(){Ga.NF(a,b,c)},i)},Ay:function(a,b,c){G.load("coordtransutils",function(){Ga.MF(a,b,c)},i)}};P.prototype=new Cb,t.extend(P,{LB:6370996.81,Ev:[12890594.86,8362377.87,5591021,3481989.83,1678043.12,0],wn:[75,60,45,30,15,0],OB:[[1.410526172116255e-8,898305509648872e-20,-1.9939833816331,200.9824383106796,-187.2403703815547,91.6087516669843,-23.38765649603339,2.57121317296198,-.03801003308653,17337981.2],[-7.435856389565537e-9,8983055097726239e-21,-.78625201886289,96.32687599759846,-1.85204757529826,-59.36935905485877,47.40033549296737,-16.50741931063887,2.28786674699375,10260144.86],[-3.030883460898826e-8,898305509983578e-20,.30071316287616,59.74293618442277,7.357984074871,-25.38371002664745,13.45380521110908,-3.29883767235584,.32710905363475,6856817.37],[-1.981981304930552e-8,8983055099779535e-21,.03278182852591,40.31678527705744,.65659298677277,-4.44255534477492,.85341911805263,.12923347998204,-.04625736007561,4482777.06],[3.09191371068437e-9,8983055096812155e-21,6995724062e-14,23.10934304144901,-.00023663490511,-.6321817810242,-.00663494467273,.03430082397953,-.00466043876332,2555164.4],[2.890871144776878e-9,8983055095805407e-21,-3.068298e-8,7.47137025468032,-353937994e-14,-.02145144861037,-1234426596e-14,.00010322952773,-323890364e-14,826088.5]],Cv:[[-.0015702102444,111320.7020616939,0x60e374c3105a3,-0x24bb4115e2e164,0x5cc55543bb0ae8,-0x7ce070193f3784,0x5e7ca61ddf8150,-0x261a578d8b24d0,0x665d60f3742ca,82.5],[.0008277824516172526,111320.7020463578,647795574.6671607,-4082003173.641316,10774905663.51142,-15171875531.51559,12053065338.62167,-5124939663.577472,913311935.9512032,67.5],[.00337398766765,111320.7020202162,4481351.045890365,-23393751.19931662,79682215.47186455,-115964993.2797253,97236711.15602145,-43661946.33752821,8477230.501135234,52.5],[.00220636496208,111320.7020209128,51751.86112841131,3796837.749470245,992013.7397791013,-1221952.21711287,1340652.697009075,-620943.6990984312,144416.9293806241,37.5],[-.0003441963504368392,111320.7020576856,278.2353980772752,2485758.690035394,6070.750963243378,54821.18345352118,9540.606633304236,-2710.55326746645,1405.483844121726,22.5],[-.0003218135878613132,111320.7020701615,.00369383431289,823725.6402795718,.46104986909093,2351.343141331292,1.58060784298199,8.77738589078284,.37238884252424,7.45]],UL:function(a,b){if(!a||!b)return 0;var c,d,a=this.lb(a);return a?(c=this.Fh(a.lng),d=this.Fh(a.lat),b=this.lb(b),b?this.Cd(c,this.Fh(b.lng),d,this.Fh(b.lat)):0):0},Dt:function(a,b){return a&&b?(a.lng=this.Lt(a.lng,-180,180),a.lat=this.Rt(a.lat,-74,74),b.lng=this.Lt(b.lng,-180,180),b.lat=this.Rt(b.lat,-74,74),this.Cd(this.Fh(a.lng),this.Fh(b.lng),this.Fh(a.lat),this.Fh(b.lat))):0},lb:function(a){var b,c;b=new F(Math.abs(a.lng),Math.abs(a.lat));for(var d=0;d<this.Ev.length;d++)if(b.lat>=this.Ev[d]){c=this.OB[d];break}return a=this.Cy(a,c),a=new F(a.lng.toFixed(6),a.lat.toFixed(6))},sb:function(a){var b,c;a.lng=this.Lt(a.lng,-180,180),a.lat=this.Rt(a.lat,-74,74),b=new F(a.lng,a.lat);for(var d=0;d<this.wn.length;d++)if(b.lat>=this.wn[d]){c=this.Cv[d];break}if(!c)for(d=this.wn.length-1;d>=0;d--)if(b.lat<=-this.wn[d]){c=this.Cv[d];break}return a=this.Cy(a,c),a=new F(a.lng.toFixed(2),a.lat.toFixed(2))},Cy:function(a,b){if(a&&b){var c=b[0]+b[1]*Math.abs(a.lng),d=Math.abs(a.lat)/b[9],d=b[2]+b[3]*d+b[4]*d*d+b[5]*d*d*d+b[6]*d*d*d*d+b[7]*d*d*d*d*d+b[8]*d*d*d*d*d*d,c=c*(0>a.lng?-1:1),d=d*(0>a.lat?-1:1);return new F(c,d)}},Cd:function(a,b,c,d){return this.LB*Math.acos(Math.sin(c)*Math.sin(d)+Math.cos(c)*Math.cos(d)*Math.cos(b-a))},Fh:function(a){return Math.PI*a/180},WM:function(a){return 180*a/Math.PI},Rt:function(a,b,c){return b!=n&&(a=Math.max(a,b)),c!=n&&(a=Math.min(a,c)),a},Lt:function(a,b,c){for(;a>c;)a-=c-b;for(;b>a;)a+=c-b;return a}}),t.extend(P.prototype,{Vi:function(a){return P.sb(a)},Em:function(a){return a=P.sb(a),new O(a.lng,a.lat)},uh:function(a){return P.lb(a)},xh:function(a){return a=new F(a.x,a.y),P.lb(a)},nb:function(a,b,c,d,e){return a?(a=this.Vi(a,e),b=this.Ib(b),new O(Math.round((a.lng-c.lng)/b+d.width/2),Math.round((c.lat-a.lat)/b+d.height/2))):void 0},Ua:function(a,b,c,d,e){return a?(b=this.Ib(b),this.uh(new F(c.lng+b*(a.x-d.width/2),c.lat-b*(a.y-d.height/2)),e)):void 0},Ib:function(a){return Math.pow(2,18-a)}}),Eb.Bj=new P,t.extend(Eb,{JG:function(a,b,c){c=t.lang.Bc(c),b={data:b},"position_changed"==a&&(b.data=Eb.Bj.xh(new O(b.data.mercatorX,b.data.mercatorY))),c.dispatchEvent(new L("on"+a),b)}});var Fb=Eb;S(Fb,{dispatchFlashEvent:Fb.JG}),Ja.prototype=new P,t.extend(Ja.prototype,{Vi:function(a,b){return this.AC(b,P.sb(a))},uh:function(a,b){return P.lb(this.BC(b,a))},lngLatToPointFor3D:function(a,b){var c=this,d=P.sb(a);G.load("coordtrans",function(){var a=Db.Ot(c.Is||"bj",d),a=new O(a.x,a.y);b&&b(a)},i)},pointToLngLatFor3D:function(a,b){var c=this,d=new F(a.x,a.y);G.load("coordtrans",function(){var a=Db.Nt(c.Is||"bj",d),a=new F(a.lng,a.lat),a=P.lb(a);b&&b(a)},i)},AC:function(a,b){if(G.Xl("coordtrans").Ac==G.Fg.Ik){var c=Db.Ot(a||"bj",b);return new F(c.x,c.y)}return G.load("coordtrans",q()),new F(0,0)},BC:function(a,b){if(G.Xl("coordtrans").Ac==G.Fg.Ik){var c=Db.Nt(a||"bj",b);return new F(c.lng,c.lat)}return G.load("coordtrans",q()),new F(0,0)},Ib:function(a){return Math.pow(2,20-a)}}),t.lang.ia(Gb,t.lang.la,"Overlay"),Gb.um=function(a){return a*=1,a?-1e5*a<<1:0},t.extend(Gb.prototype,{Qd:function(a){!this.J&&Ca(this.initialize)&&(this.J=this.initialize(a))&&(this.J.style.WebkitUserSelect="none"),this.draw()},initialize:function(){throw"initialize方法未实现"},draw:function(){throw"draw方法未实现"},remove:function(){this.J&&this.J.parentNode&&this.J.parentNode.removeChild(this.J),this.J=n,this.dispatchEvent(new L("onremove"))},H:function(){this.J&&t.z.H(this.J)},show:function(){this.J&&t.z.show(this.J)},Ag:function(){return this.J&&"none"!=this.J.style.display&&"hidden"!=this.J.style.visibility?i:o}}),B.rd(function(a){function b(a,b){var c=J("div"),g=c.style;return g.position="absolute",g.top=g.left=g.width=g.height="0",g.zIndex=b,a.appendChild(c),c}var c=a.D;c.Jd=a.Jd=b(a.platform,200),a.Lc.ut=b(c.Jd,800),a.Lc.qu=b(c.Jd,700),a.Lc.cz=b(c.Jd,600),a.Lc.aA=b(c.Jd,500),a.Lc.lA=b(c.Jd,400),a.Lc.mA=b(c.Jd,300),a.Lc.KK=b(c.Jd,201),a.Lc.Cp=b(c.Jd,200)}),t.lang.ia(Q,Gb,"OverlayInternal"),t.extend(Q.prototype,{initialize:function(a){return this.map=a,t.lang.la.call(this,this.L),n},Mt:s("map"),draw:q(),remove:function(){this.map=n,t.lang.Xo(this.L),Gb.prototype.remove.call(this)},H:function(){this.vb!=o&&(this.vb=o)},show:function(){this.vb!=i&&(this.vb=i)},Ag:function(){return this.J?!!this.vb:o},Ba:s("J"),TA:function(a){var b,a=a||{};for(b in a)this.w[b]=a[b]},aq:ba("zIndex"),gh:function(){this.w.gh=i},GG:function(){this.w.gh=o},Oj:ba("Aj"),rk:function(){this.Aj=n}}),B.rd(function(a){var b=new Hb;b.map=a,a.fa=b.fa,a.ad=b.ad,a.addEventListener("load",function(a){b.draw(a)}),a.addEventListener("moveend",function(a){b.draw(a)}),t.M.S&&8>t.M.S||"BackCompat"==document.compatMode?a.addEventListener("zoomend",function(a){setTimeout(function(){b.draw(a)},20)}):a.addEventListener("zoomend",function(a){b.draw(a)}),a.addEventListener("maptypechange",function(a){b.draw(a)}),a.addEventListener("addoverlay",function(a){if(a=a.target,a instanceof Q)b.fa[a.L]||(b.fa[a.L]=a);else{for(var d=o,e=0,f=b.ad.length;f>e;e++)if(b.ad[e]===a){d=i;break}d||b.ad.push(a)}}),a.addEventListener("removeoverlay",function(a){if(a=a.target,a instanceof Q)delete b.fa[a.L];else for(var d=0,e=b.ad.length;e>d;d++)if(b.ad[d]===a){b.ad.splice(d,1);break}}),a.addEventListener("clearoverlays",function(){this.kc();for(var a in b.fa)b.fa[a].w.gh&&(b.fa[a].remove(),delete b.fa[a]);a=0;for(var d=b.ad.length;d>a;a++)b.ad[a].gh!=o&&(b.ad[a].remove(),b.ad[a]=n,b.ad.splice(a,1),a--,d--)}),a.addEventListener("infowindowopen",function(){var a=this.xb;a&&(t.z.H(a.zb),t.z.H(a.ob))}),a.addEventListener("movestart",function(){this.Se()&&this.Se().Bx()}),a.addEventListener("moveend",function(){this.Se()&&this.Se().vx()})}),Hb.prototype.draw=function(){for(var a in this.fa)this.fa[a].draw();t.Mb.Xd(this.ad,function(a){a.draw()}),this.map.D.Ja&&this.map.D.Ja.da(),B.tn&&B.tn.lm(this.map).Yu()},t.lang.ia(Ib,Q,"Graph"),Ib.jp=function(a){var b=[];return a?(Da(a)&&t.Mb.Xd(a.split(";"),function(a){a=a.split(","),b.push(new F(a[0],a[1]))}),"[object Array]"==Object.prototype.toString.apply(a)&&0<a.length&&(b=a),b):b},Ib.Cu=[.09,.005,1e-4,1e-5],t.extend(Ib.prototype,{initialize:function(a){return this.map=a,n},draw:q(),Il:function(a){this.ud.length=0,this.W=Ib.jp(a).slice(0),this.jf()},Wc:function(a){this.Il(a)},jf:function(){if(this.W){var a=this;a.Gq=new Ia,t.Mb.Xd(this.W,function(b){a.Gq.extend(b)})}},Pc:s("W"),ij:function(a,b){b&&this.W[a]&&(this.ud.length=0,this.W[a]=new F(b.lng,b.lat),this.jf())},setStrokeColor:function(a){this.w.strokeColor=a},SH:function(){return this.w.strokeColor},Um:function(a){a>0&&(this.w.ef=a)},xz:function(){return this.w.ef},Sm:function(a){a==aa||a>1||0>a||(this.w.ye=a)},TH:function(){return this.w.ye},Wp:function(a){a>1||0>a||(this.w.Fi=a)},xH:function(){return this.w.Fi},Tm:function(a){"solid"!=a&&"dashed"!=a||(this.w.strokeStyle=a)},wz:function(){return this.w.strokeStyle},setFillColor:function(a){this.w.fillColor=a||""},wH:function(){return this.w.fillColor},vg:s("Gq"),remove:function(){this.map&&this.map.removeEventListener("onmousemove",this.Rn),Q.prototype.remove.call(this),this.ud.length=0},Yd:function(){if(!(2>this.W.length)){this.w.Yd=i;var a=this;G.load("poly",function(){a.li()},i)}},FG:function(){this.w.Yd=o;var a=this;G.load("poly",function(){a.Zg()},i)}}),t.lang.ia(Jb,Q,"Division"),t.extend(Jb.prototype,{Rk:function(){var a=this.w,b=this.content,c=['<div class="BMap_Division" style="position:absolute;'];c.push("width:"+a.width+"px;display:block;"),c.push("overflow:hidden;"),"none"!=a.borderColor&&c.push("border:"+a.yp+"px "+a.OI+" "+a.cA+";"),c.push("opacity:"+a.opacity+"; filter:(opacity="+100*a.opacity+")"),c.push("background:"+a.background+";"),c.push('z-index:60;">'),c.push(b),c.push("</div>"),this.J=bb(this.map.Ue().qu,c.join(""))},initialize:function(a){return this.map=a,this.Rk(),this.J&&t.C(this.J,H()?"touchstart":"mousedown",function(a){A(a)}),this.J},draw:function(){var a=this.map.$e(this.w.O);this.w.ga=new K(-Math.round(this.w.width/2)-Math.round(this.w.yp),-Math.round(this.w.height/2)-Math.round(this.w.yp)),this.J.style.left=a.x+this.w.ga.width+"px",this.J.style.top=a.y+this.w.ga.height+"px"},ca:function(){return this.w.O},gL:function(){return this.map.nb(this.ca())},da:function(a){this.w.O=a,this.draw()},MJ:function(a,b){this.w.width=Math.round(a),this.w.height=Math.round(b),this.J&&(this.J.style.width=this.w.width+"px",this.J.style.height=this.w.height+"px",this.draw())}}),t.extend(Kb.prototype,{QJ:function(a){a&&(this.imageUrl=a)},aK:function(a){a&&(this.printImageUrl=a)},Ic:function(a){a&&(this.size=new K(a.width,a.height))},Sb:function(a){a&&(this.anchor=new K(a.width,a.height))},Pm:function(a){a&&(this.imageOffset=new K(a.width,a.height))},SJ:function(a){a&&(this.infoWindowAnchor=new K(a.width,a.height))},PJ:function(a){a&&(this.imageSize=new K(a.width,a.height))},toString:ca("Icon")}),t.lang.ia(Lb,t.lang.la,"InfoWindow"),t.extend(Lb.prototype,{setWidth:function(a){!a&&0!=a||isNaN(a)||0>a||(0!=a&&(220>a&&(a=220),a>730&&(a=730)),this.w.width=a)},setHeight:function(a){!a&&0!=a||isNaN(a)||0>a||(0!=a&&(60>a&&(a=60),a>650&&(a=650)),this.w.height=a)},ZA:function(a){!a&&0!=a||isNaN(a)||0>a||(0!=a&&(220>a&&(a=220),a>730&&(a=730)),this.w.maxWidth=a)},bc:function(a){this.w.title=a},getTitle:function(){return this.w.title},Hc:ba("content"),hz:s("content"),Qm:function(a){this.w.ru=a+""},Gc:q(),fm:function(){this.w.fm=i},disableAutoPan:function(){this.w.fm=o},enableCloseOnClick:function(){this.w.bt=i},disableCloseOnClick:function(){this.w.bt=o},Oe:function(){this.w.Oe=i},Zo:function(){this.w.Oe=o},show:function(){this.vb=i},H:function(){this.vb=o},close:function(){this.H()},Dp:function(){this.Cc=i},restore:function(){this.Cc=o},Ag:function(){return this.za()},za:ca(o),ca:function(){return this.Ka&&this.Ka.ca?this.Ka.ca():void 0},Te:function(){return this.w.ga}}),qa.prototype.Pb=function(a,b){if(a instanceof Lb&&b instanceof F){var c=this.D;c.Wi?c.Wi.da(b):(c.Wi=new T(b,{icon:new Kb(C.ba+"blank.gif",{width:1,height:1}),offset:new K(0,0),clickable:o}),c.Wi.kD=1),this.Wa(c.Wi),c.Wi.Pb(a)}},qa.prototype.kc=function(){var a=this.D.Ja||this.D.Qh;a&&a.Ka&&a.Ka.kc()},Q.prototype.Pb=function(a){this.map&&(this.map.kc(),a.vb=i,this.map.D.Qh=a,a.Ka=this,t.lang.la.call(a,a.L))},Q.prototype.kc=function(){this.map&&this.map.D.Qh&&(this.map.D.Qh.vb=o,t.lang.Xo(this.map.D.Qh.L),this.map.D.Qh=n)},t.lang.ia(Mb,Q,"Label"),t.extend(Mb.prototype,{ca:function(){return this.eo?this.eo.ca():this.O},da:function(a){a instanceof F&&!this.mp()&&(this.O=this.w.position=new F(a.lng,a.lat))},Hc:ba("content"),VJ:function(a){a>=0&&1>=a&&(this.w.opacity=a)},Vc:function(a){a instanceof K&&(this.w.ga=new K(a.width,a.height))},Te:function(){return this.w.ga},qc:function(a){a=a||{},this.w.Bk=t.extend(this.w.Bk,a)},Ch:function(a){return this.qc(a)},bc:function(a){this.w.title=a||""},getTitle:function(){return this.w.title},YA:function(a){this.O=this.w.position=(this.eo=a)?a.ca():n},mp:function(){return this.eo||n}});var Nb=new Kb(C.ba+"marker_red_sprite.png",new K(19,25),{anchor:new K(10,25),infoWindowAnchor:new K(10,0)}),Pb=new Kb(C.ba+"marker_red_sprite.png",new K(20,11),{anchor:new K(6,11),imageOffset:new K(-19,-13)});T.zn=Gb.um(-90)+1e6,T.zv=T.zn+1e6,t.lang.ia(T,Q,"Marker"),t.extend(T.prototype,{Rf:function(a){a instanceof Kb&&(this.w.Ve=a)},nz:function(){return this.w.Ve},$p:function(a){a instanceof Kb&&(this.w.Dh=a)},getShadow:function(){return this.w.Dh},gj:function(a){this.w.label=a||n},oz:function(){return this.w.label},Eb:function(){this.w.Eb=i},Ps:function(){this.w.Eb=o},ca:s("O"),da:function(a){a instanceof F&&(this.O=new F(a.lng,a.lat))},yk:function(a,b){this.w.mu=!!a,a&&(this.Sv=b||0)},bc:function(a){this.w.title=a+""},getTitle:function(){return this.w.title},Vc:function(a){a instanceof K&&(this.w.ga=a)},Te:function(){return this.w.ga},fj:ba("Tk")}),t.lang.ia(Qb,Ib,"Polygon"),t.extend(Qb.prototype,{Wc:function(a,b){this.Lj=Ib.jp(a).slice(0);var c=Ib.jp(a).slice(0);1<c.length&&c.push(new F(c[0].lng,c[0].lat)),Ib.prototype.Wc.call(this,c,b)},ij:function(a,b){this.Lj[a]&&(this.Lj[a]=new F(b.lng,b.lat),this.W[a]=new F(b.lng,b.lat),0==a&&!this.W[0].bb(this.W[this.W.length-1])&&(this.W[this.W.length-1]=new F(b.lng,b.lat)),this.jf())},Pc:function(){var a=this.Lj;return 0==a.length&&(a=this.W),a}}),t.lang.ia(Rb,Ib,"Polyline"),Sb.Cu=[.01,1e-4,1e-5,4e-6],t.lang.ia(Sb,Qb,"Circle"),t.extend(Sb.prototype,{initialize:function(a){return this.map=a,this.W=this.Pn(this.O,this.Ca),this.jf(),n},Ga:s("O"),ve:function(a){a&&(this.O=a)},LH:s("Ca"),Zp:function(a){this.Ca=Math.abs(a)},Pn:function(a,b){if(!a||!b||!this.map)return[];for(var c=[],d=b/6378800,e=Math.PI/180*a.lat,f=Math.PI/180*a.lng,g=0;360>g;g+=9){var j=Math.PI/180*g,k=Math.asin(Math.sin(e)*Math.cos(d)+Math.cos(e)*Math.sin(d)*Math.cos(j)),j=new F(((f-Math.atan2(Math.sin(j)*Math.sin(d)*Math.cos(e),Math.cos(d)-Math.sin(e)*Math.sin(k))+Math.PI)%(2*Math.PI)-Math.PI)*(180/Math.PI),k*(180/Math.PI));c.push(j)}return d=c[0],c.push(new F(d.lng,d.lat)),c}});var Tb={};B.rd(function(a){var b=new Ub(a);b.ta(),a.tb=b}),t.extend(Ub.prototype,{ta:function(){var a=this,b=a.map;b.addEventListener("loadcode",function(){a.zp()}),b.addEventListener("addtilelayer",function(b){a.Af(b)}),b.addEventListener("removetilelayer",function(b){a.Qf(b)}),b.addEventListener("setmaptype",function(b){a.Cg(b)}),b.addEventListener("zoomstartcode",function(b){a.Yb(b)}),b.addEventListener("setcustomstyles",function(){a.Ye(i)})},zp:function(){var a=this;if(t.M.S)try{document.execCommand("BackgroundImageCache",o,i)}catch(b){}this.loaded||a.vp(),a.Ye(),this.loaded||(this.loaded=i,G.load("tile",function(){a.iC()}))},vp:function(){for(var a=this.map.ha().tl,b=0;b<a.length;b++){var c=new Vb;t.extend(c,a[b]),this.mk.push(c),c.ta(this.map,this.co)}},bl:function(a){var b=J("div");return b.style.position="absolute",b.style.overflow="visible",b.style.left=b.style.top="0",b.style.zIndex=a,b},De:function(){this.Ze--;var a=this;this.hu&&(this.map.dispatchEvent(new L("onfirsttileloaded")),this.hu=o),0==this.Ze&&(this.dg&&(clearTimeout(this.dg),this.dg=n),this.dg=setTimeout(function(){0==a.Ze&&(a.map.dispatchEvent(new L("ontilesloaded")),a.hu=i),a.dg=n},80))},Wt:function(a,b){return"TILE-"+b.L+"-"+a[0]+"-"+a[1]+"-"+a[2]},sp:function(a){var b=a.Va;b&&ab(b)&&b.parentNode.removeChild(b),delete this.re[a.name],a.loaded||(Wb(a),a.Va=n,a.Xi=n)},dk:function(a,b,c){var d=this.map,e=d.ha(),f=d.na,g=d.Ob,j=e.Ib(f),k=this.sH(),l=k[0],m=k[1],p=k[2],u=k[3],v=k[4],c="undefined"!=typeof c?c:0,e=e.k.Jb,k=d.L.replace(/^TANGRAM_/,"");for(this.Uf?this.Uf.length=0:this.Uf=[];p>l;l++)for(var w=m;u>w;w++){var z=l,E=w;this.Uf.push([z,E]),z=k+"_"+b+"_"+z+"_"+E+"_"+f,this.Hy[z]=z}for(this.Uf.sort(function(a){return function(b,c){return.4*Math.abs(b[0]-a[0])+.6*Math.abs(b[1]-a[1])-(.4*Math.abs(c[0]-a[0])+.6*Math.abs(c[1]-a[1]))}}([v[0]-1,v[1]-1])),g=[Math.round(-g.lng/j),Math.round(g.lat/j)],l=-d.offsetY+d.height/2,a.style.left=-d.offsetX+d.width/2+"px",a.style.top=l+"px",this.oi?this.oi.length=0:this.oi=[],l=0,d=a.childNodes.length;d>l;l++)w=a.childNodes[l],w.Uw=o,this.oi.push(w);
if(l=this.wu)for(var x in l)delete l[x];else this.wu={};for(this.pi?this.pi.length=0:this.pi=[],l=0,d=this.Uf.length;d>l;l++)for(x=this.Uf[l][0],j=this.Uf[l][1],w=0,m=this.oi.length;m>w;w++)if(p=this.oi[w],p.id==k+"_"+b+"_"+x+"_"+j+"_"+f){p.Uw=i,this.wu[p.id]=p;break}for(l=0,d=this.oi.length;d>l;l++)p=this.oi[l],p.Uw||this.pi.push(p);for(this.iv=[],w=(e+c)*this.map.F.devicePixelRatio,l=0,d=this.Uf.length;d>l;l++)x=this.Uf[l][0],j=this.Uf[l][1],u=x*e+g[0]-c/2,v=(-1-j)*e+g[1]-c/2,z=k+"_"+b+"_"+x+"_"+j+"_"+f,m=this.wu[z],p=n,m?(p=m.style,p.left=u+"px",p.top=v+"px",m.Ee||this.iv.push([x,j,m])):(0<this.pi.length?(m=this.pi.shift(),m.getContext("2d").clearRect(-c/2,-c/2,w,w),p=m.style):(m=document.createElement("canvas"),p=m.style,p.position="absolute",p.width=e+c+"px",p.height=e+c+"px",this.Uz()&&(p.WebkitTransform="scale(1.001)"),m.setAttribute("width",w),m.setAttribute("height",w),a.appendChild(m)),m.id=z,p.left=u+"px",p.top=v+"px",-1<z.indexOf("bg")&&(u="#F3F1EC",this.map.F.nc&&this.map.F.nc.style&&(u=this.map.F.Cf[this.map.F.nc.style].backColor),p.background=u?u:""),this.iv.push([x,j,m])),m.style.visibility="";for(l=0,d=this.pi.length;d>l;l++)this.pi[l].style.visibility="hidden";return this.iv},Uz:function(){return/M040/i.test(navigator.userAgent)},sH:function(){var a=this.map,b=a.ha(),c=a.na;b.Ib(c);var c=b.Az(c),d=a.Ob,e=Math.ceil(d.lng/c),f=Math.ceil(d.lat/c),b=b.k.Jb,c=[e,f,(d.lng-e*c)/c*b,(d.lat-f*c)/c*b];return[c[0]-Math.ceil((a.width/2-c[2])/b),c[1]-Math.ceil((a.height/2-c[3])/b),c[0]+Math.ceil((a.width/2+c[2])/b),c[1]+Math.ceil((a.height/2+c[3])/b),c]},fK:function(a,b,c,d){var e=this;e.BL=b;var f=this.map.ha(),g=e.Wt(a,c),j=f.k.Jb,b=[a[0]*j+b[0],(-1-a[1])*j+b[1]],k=this.re[g];k&&k.Va?(Za(k.Va,b),d&&(d=new O(a[0],a[1]),f=this.map.F.nc?this.map.F.nc.style:"normal",d=c.getTilesUrl(d,a[2],f),k.loaded=o,Xb(k,d)),k.loaded?this.De():Yb(k,function(){e.De()})):(k=this.qg[g])&&k.Va?(c.gb.insertBefore(k.Va,c.gb.lastChild),this.re[g]=k,Za(k.Va,b),d&&(d=new O(a[0],a[1]),f=this.map.F.nc?this.map.F.nc.style:"normal",d=c.getTilesUrl(d,a[2],f),k.loaded=o,Xb(k,d)),k.loaded?this.De():Yb(k,function(){e.De()})):(k=j*Math.pow(2,f.Li()-a[2]),new F(a[0]*k,a[1]*k),d=new O(a[0],a[1]),f=this.map.F.nc?this.map.F.nc.style:"normal",d=c.getTilesUrl(d,a[2],f),k=new Zb(this,d,b,a,c),Yb(k,function(){e.De()}),$b(k),this.re[g]=k)},De:function(){this.Ze--;var a=this;0==this.Ze&&(this.dg&&(clearTimeout(this.dg),this.dg=n),this.dg=setTimeout(function(){if(0==a.Ze&&(a.map.dispatchEvent(new L("ontilesloaded")),pa)){if(ma&&na&&oa){var b=Ea(),c=a.map.Fb();setTimeout(function(){ua(5030,{load_script_time:na-ma,load_tiles_time:b-oa,map_width:c.width,map_height:c.height,map_size:c.width*c.height})},1e4)}pa=o}a.dg=n},80))},Wt:function(a,b){return this.map.ha()===ta?"TILE-"+b.L+"-"+this.map.As+"-"+a[0]+"-"+a[1]+"-"+a[2]:"TILE-"+b.L+"-"+a[0]+"-"+a[1]+"-"+a[2]},sp:function(a){var b=a.Va;b&&(ac(b),ab(b)&&b.parentNode.removeChild(b)),delete this.re[a.name],a.loaded||(ac(b),Wb(a),a.Va=n,a.Xi=n)},Ye:function(a){var b=this;if(b.map.ha()==ta)G.load("coordtrans",function(){b.$w()},i);else{if(a&&a)for(var c in this.qg)delete this.qg[c];b.$w(a)}},$w:function(a){for(var b=this.mk.concat(this.$d),c=b.length,d=0;c>d;d++){var e=b[d];if(e.oc&&l.na<e.oc)break;if(e.Mo){var f=this.gb=e.gb;if(a){var g=f;if(g&&g.childNodes)for(var j=g.childNodes.length,k=j-1;k>=0;k--)j=g.childNodes[k],g.removeChild(j),j=n}if(this.map.tc()){this.le.style.display="block",f.style.display="none",this.map.dispatchEvent(new L("vectorchanged"),{isvector:i});continue}f.style.display="block",this.le.style.display="none",this.map.dispatchEvent(new L("vectorchanged"),{isvector:o})}if(!(e.kk&&!this.map.tc()||e.Tz&&this.map.tc())){var l=this.map,m=l.ha(),f=m.Ni(),j=l.na,p=l.Ob;m==ta&&p.bb(new F(0,0))&&(p=l.Ob=f.Vi(l.Le,l.Db));var u=m.Ib(j),j=m.Az(j),f=Math.ceil(p.lng/j),g=Math.ceil(p.lat/j),v=m.k.Jb,j=[f,g,(p.lng-f*j)/j*v,(p.lat-g*j)/j*v],k=j[0]-Math.ceil((l.width/2-j[2])/v),f=j[1]-Math.ceil((l.height/2-j[3])/v),g=j[0]+Math.ceil((l.width/2+j[2])/v),w=0;m===ta&&15==l.U()&&(w=1),m=j[1]+Math.ceil((l.height/2+j[3])/v)+w,this.fy=new F(p.lng,p.lat);var E,z=this.re,v=-this.fy.lng/u,w=this.fy.lat/u,u=[Math.ceil(v),Math.ceil(w)],p=l.U();for(E in z){var x=z[E],I=x.info;(I[2]!=p||I[2]==p&&(k>I[0]||g<=I[0]||f>I[1]||m<=I[1]))&&this.sp(x)}for(z=-l.offsetX+l.width/2,x=-l.offsetY+l.height/2,e.gb&&(e.gb.style.left=Math.ceil(v+z)-u[0]+"px",e.gb.style.top=Math.ceil(w+x)-u[1]+"px"),v=[],l.ms=[];g>k;k++)for(w=f;m>w;w++)v.push([k,w]),l.ms.push({x:k,y:w});for(v.sort(function(a){return function(b,c){return.4*Math.abs(b[0]-a[0])+.6*Math.abs(b[1]-a[1])-(.4*Math.abs(c[0]-a[0])+.6*Math.abs(c[1]-a[1]))}}([j[0]-1,j[1]-1])),this.Ze+=v.length,k=0,j=v.length;j>k;k++)this.fK([v[k][0],v[k][1],p],u,e,a)}}},Af:function(a){var b=this,c=a.target;if(c.Ae&&this.map.Af(c.Ae),c.kk){for(a=0;a<b.Be.length;a++)if(b.Be[a]==c)return;G.load("vector",function(){c.ta(b.map,b.le),b.Be.push(c)},i)}else{for(a=0;a<b.$d.length;a++)if(b.$d[a]==c)return;c.ta(this.map,this.xl),b.$d.push(c)}},Qf:function(a){if(a=a.target,a.Ae&&this.map.Qf(a.Ae),a.kk)for(var b=0,c=this.Be.length;c>b;b++)a==this.Be[b]&&this.Be.splice(b,1);else for(b=0,c=this.$d.length;c>b;b++)a==this.$d[b]&&this.$d.splice(b,1);a.remove()},Cg:function(){for(var a=this.mk,b=0,c=a.length;c>b;b++)a[b].remove();delete this.gb,this.mk=[],this.qg=this.re={},this.vp(),this.Ye()},Yb:function(){var a=this;a.fc&&t.z.H(a.fc),setTimeout(function(){a.Ye(),a.map.dispatchEvent(new L("onzoomend"))},10)},$M:q()});var bc=!t.M.S||8<t.M.S;Vb.RD=0,t.lang.ia(Vb,t.lang.la,"TileLayer"),t.extend(Vb.prototype,{ta:function(a,b){if(this.Mo&&(this.zIndex=-100),this.map=a,!this.gb){var c=J("div"),d=c.style;d.position="absolute",d.overflow="visible",d.zIndex=this.zIndex,d.left=Math.ceil(-a.offsetX+a.width/2)+"px",d.top=Math.ceil(-a.offsetY+a.height/2)+"px",b.appendChild(c),this.gb=c}c=a.ha(),a.ph()&&c==ra&&(c.k.Jb=128,d=function(a){return 2*Math.pow(2,18-a)},c.Ib=d,c.k.Tc.Ib=d)},remove:function(){this.gb&&this.gb.parentNode&&(this.gb.innerHTML="",this.gb.parentNode.removeChild(this.gb)),delete this.gb},Bm:s("EK"),getTilesUrl:function(a,b){var c="";return this.ok.tileUrlTemplate&&(c=this.ok.tileUrlTemplate.replace(/\{X\}/,a.x),c=c.replace(/\{Y\}/,a.y),c=c.replace(/\{Z\}/,b)),c},Ii:s("oG"),ha:function(){return this.yb||ra}}),t.ia(cc,Vb,"VectorCloudLayer"),t.ia(dc,Vb,"VectorTrafficLayer"),ec.prototype=new Vb,ec.prototype.ta=function(a,b){Vb.prototype.ta.call(this,a,b),this.A=a},ec.prototype.Bm=ca(i),ec.prototype.getTilesUrl=function(a,b){var c="";return this.k.predictDate?c="HistoryService?day="+(this.k.predictDate.weekday-1)+"&hour="+this.k.predictDate.hour+"&t="+(new Date).getTime()+"&":(c="TrafficTileService?time="+(new Date).getTime()+"&",this.A.ph()||(c+="label=web2D&v=016&")),(this.rF+c+"level="+b+"&x="+a.x+"&y="+a.y).replace(/-(\d+)/gi,"M$1")},Qa.prototype=new Vb,Qa.prototype.ta=function(a,b){Vb.prototype.ta.call(this,a,b),this.A=a},Qa.prototype.getTilesUrl=function(a,b){var c=this.zc,c=c.pI+"?grids="+a.x+"_"+a.y+"_"+b+"&q="+c.Rp+"&tags="+c.bn+"&filter="+c.filter+"&ak="+this.zc.mi+"&age="+c.Lo+"&format="+c.tK;return this.he?c+="&geotable_id="+this.he:this.dl&&(c+="&databox_id="+this.dl),c},Qa.TE=/^point\(|\)$/gi,Qa.UE=/\s+/,Qa.WE=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,t.extend(fc.prototype,{getName:s("vl"),tm:function(){return this.k.uK},YL:function(){return this.k.pu},YH:function(){return this.tl[0]},hM:s("tl"),ZH:function(){return this.k.Jb},Yj:function(){return this.k.oc},Li:function(){return this.k.od},sm:function(){return this.k.sK},Ni:function(){return this.k.Tc},VL:function(){return this.k.kt},ZH:function(){return this.k.Jb},Ib:function(a){return Math.pow(2,18-a)},Az:function(a){return this.Ib(a)*this.k.Jb}});var gc=["http://shangetu0.map.bdimg.com/it/","http://shangetu1.map.bdimg.com/it/","http://shangetu2.map.bdimg.com/it/","http://shangetu3.map.bdimg.com/it/","http://shangetu4.map.bdimg.com/it/"],hc=["http://online0.map.bdimg.com/tile/","http://online1.map.bdimg.com/tile/","http://online2.map.bdimg.com/tile/","http://online3.map.bdimg.com/tile/","http://online4.map.bdimg.com/tile/"],hc=["http://or.map.bdimg.com:8080/tile/","http://or0.map.bdimg.com:8080/tile/","http://or1.map.bdimg.com:8080/tile/","http://or2.map.bdimg.com:8080/tile/","http://or3.map.bdimg.com:8080/tile/"],ic={dark:"dl",light:"ll",normal:"pl"},jc=new Vb;jc.getTilesUrl=function(a,b,c){var d=a.x,a=a.y,e="pl";return this.map.ph(),e=ic[c],(hc[Math.abs(d+a)%hc.length]+"?qt=tile&x="+(d+"").replace(/-/gi,"M")+"&y="+(a+"").replace(/-/gi,"M")+"&z="+b+"&styles="+e+(6==t.M.S?"&color_dep=32&colors=50":"")+"&udt=20130822").replace(/-(\d+)/gi,"M$1")};var ra=new fc("地图",jc,{tips:"显示普通地图"}),lc=new Vb;lc.nB=["http://d0.map.baidu.com/resource/mappic/","http://d1.map.baidu.com/resource/mappic/","http://d2.map.baidu.com/resource/mappic/","http://d3.map.baidu.com/resource/mappic/"],lc.getTilesUrl=function(a,b){var c=a.x,d=a.y,e=256*Math.pow(2,20-b),d=Math.round((9998336-e*d)/e)-1;return url=this.nB[Math.abs(c+d)%this.nB.length]+this.map.Db+"/"+this.map.As+"/3/lv"+(21-b)+"/"+c+","+d+".jpg"};var ta=new fc("三维",lc,{tips:"显示三维地图",minZoom:15,maxZoom:20,textColor:"white",projection:new Ja});ta.Ib=function(a){return Math.pow(2,20-a)},ta.Wj=function(a){if(!a)return"";var c,b=C.Cs;for(c in b)if(-1<a.search(c))return b[c].Np;return""},ta.qH=function(a){return{bj:2,gz:1,sz:14,sh:4}[a]};var mc=new Vb({Mo:i});mc.getTilesUrl=function(a,b){var c=a.x,d=a.y;return(gc[Math.abs(c+d)%gc.length]+"u=x="+c+";y="+d+";z="+b+";v=009;type=sate&fm=46").replace(/-(\d+)/gi,"M$1")};var va=new fc("卫星",mc,{tips:"显示卫星影像",minZoom:1,maxZoom:19,textColor:"white"}),nc=new Vb({transparentPng:i});nc.getTilesUrl=function(a,b){var c=a.x,d=a.y;return(hc[Math.abs(c+d)%hc.length]+"?qt=tile&x="+(c+"").replace(/-/gi,"M")+"&y="+(d+"").replace(/-/gi,"M")+"&z="+b+"&styles=sl"+(6==t.M.S?"&color_dep=32&colors=50":"")+"&udt=20130712").replace(/-(\d+)/gi,"M$1")};var xa=new fc("混合",[mc,nc],{tips:"显示带有街道的卫星影像",labelText:"路网",minZoom:1,maxZoom:19,textColor:"white"}),oc=1,U={};window.RK=U,t.ia(V,t.lang.la),t.extend(V.prototype,{getResults:function(){return this.Cb?this.ag:this.P},enableAutoViewport:function(){this.k.$.Ke=i},disableAutoViewport:function(){this.k.$.Ke=o},hj:function(a){a&&(this.hc.src=a)},Zu:function(a){this.k.Jp=a||q()},setMarkersSetCallback:function(a){this.k.CA=a||q()},setPolylinesSetCallback:function(a){this.k.xu=a||q()},setInfoHtmlSetCallback:function(a){this.k.BA=a||q()},setResultsHtmlSetCallback:function(a){this.k.DA=a||q()},Oi:s("Ac")});var pc={VB:"http://api.map.baidu.com/",Qa:function(a,b,c,d,e){var f=(1e5*Math.random()).toFixed(0);B._rd["_cbk"+f]=function(b){c=c||{},a&&a(b,c),delete B._rd["_cbk"+f]},d=d||"",b=c&&c.wB?gb(b,encodeURI):gb(b,encodeURIComponent),d=this.VB+d+"?"+b+"&ie=utf-8&oue=1&fromproduct=jsapi",e||(d+="&res=api"),La(d+("&callback=BMap._rd._cbk"+f))}};window.VK=pc,B._rd={};var N={};window.UK=N,N.OA=function(a){return a.replace(/<\/?b>/g,"")},N.hJ=function(a){return a.replace(/([1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0|[1-9]\d*),([1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0|[1-9]\d*)(,)/g,"$1,$2;")},N.iJ=function(a,b){return a.replace(RegExp("(((-?\\d+)(\\.\\d+)?),((-?\\d+)(\\.\\d+)?);)(((-?\\d+)(\\.\\d+)?),((-?\\d+)(\\.\\d+)?);){"+b+"}","ig"),"$1")};var qc=2,rc=3,sc=0,tc="bt",uc="nav",vc="walk",wc="bl",xc="bsl",yc=14,zc=15,Ac=18,Bc=20,Cc=31;B.I=window.Instance=t.lang.Bc,t.ia(Fa,V,"LocalSearch"),Fa.Kk=10,Fa.SK=1,Fa.oj=100,Fa.xv=2e3,Fa.Dv=1e5,t.extend(Fa.prototype,{search:function(a,b){this.pa.push({method:"search",arguments:[a,b]})},ej:function(a,b,c){this.pa.push({method:"searchInBounds",arguments:[a,b,c]})},vk:function(a,b,c,d){this.pa.push({method:"searchNearby",arguments:[a,b,c,d]})},kd:function(){delete this.oa,delete this.Ac,delete this.P,delete this.V,this.Ha=-1,this.Sa(),this.k.$.wa&&(this.k.$.wa.innerHTML="")},Qi:q(),dt:function(){this.k.$.Nm=i},Qs:function(){this.k.$.Nm=o},xk:function(a){this.k.wh="number"!=typeof a||isNaN(a)?Fa.Kk:1>a?Fa.Kk:a>Fa.oj?Fa.Kk:a},Ed:function(){return this.k.wh},toString:ca("LocalSearch")});var Dc=Fa.prototype;S(Dc,{clearResults:Dc.kd,setPageCapacity:Dc.xk,getPageCapacity:Dc.Ed,gotoPage:Dc.Qi,searchNearby:Dc.vk,searchInBounds:Dc.ej,search:Dc.search,enableFirstResultSelection:Dc.dt,disableFirstResultSelection:Dc.Qs}),t.ia(Ec,V,"BaseRoute"),t.extend(Ec.prototype,{kd:q()}),Fc.oj=100,Fc.MB=[0,1,0,0,0,0,0,0,2,0,0,0,1,1,1],t.ia(Fc,Ec,"TransitRoute"),t.extend(Fc.prototype,{Rm:function(a){this.k.Sc=a>=0&&4>=a?a:0},ZD:function(a,b){this.pa.push({method:"_internalSearch",arguments:[a,b]})},search:function(a,b){this.pa.push({method:"search",arguments:[a,b]})},xk:function(a){return"string"==typeof a&&(a=parseInt(a),isNaN(a))?(this.k.wh=Fc.oj,void 0):(this.k.wh="number"!=typeof a?Fc.oj:a>=1&&a<=Fc.oj?Math.round(a):Fc.oj,void 0)},toString:ca("TransitRoute"),fF:function(a){return a.replace(/\(.*\)/,"")}}),Gc.YB=" 环岛 无属性道路 主路 高速连接路 交叉点内路段 连接道路 停车场内部道路 服务区内部道路 桥 步行街 辅路 匝道 全封闭道路 未定义交通区域 POI连接路 隧道 步行道 公交专用道 提前右转道".split(" "),t.ia(Gc,Ec,"DWRoute"),t.extend(Gc.prototype,{search:function(a,b,c){this.pa.push({method:"search",arguments:[a,b,c]})}}),t.ia(Hc,Gc,"DrivingRoute"),t.extend(Hc.prototype,{Rm:function(a){this.k.Sc=a>=0&&2>=a?a:0}}),t.ia(Ic,Gc,"WalkingRoute"),t.ia(Jc,t.lang.la,"Geocoder"),t.extend(Jc.prototype,{Qt:function(a,b,c){this.pa.push({method:"getPoint",arguments:[a,b,c]})},lp:function(a,b,c){this.pa.push({method:"getLocation",arguments:[a,b,c]})},toString:ca("Geocoder")});var Kc=Jc.prototype;S(Kc,{getPoint:Kc.Qt,getLocation:Kc.lp}),t.extend(Geolocation.prototype,{getCurrentPosition:function(a,b){this.pa.push({method:"getCurrentPosition",arguments:[a,b]})},Oi:s("Ac")});var Lc=Geolocation.prototype;S(Lc,{getCurrentPosition:Lc.getCurrentPosition,getStatus:Lc.Oi}),t.ia(Mc,t.lang.la,"LocalCity"),t.extend(Mc.prototype,{get:function(a){this.pa.push({method:"get",arguments:[a]})},toString:ca("LocalCity")}),t.ia(Nc,t.lang.la,"Boundary"),t.extend(Nc.prototype,{get:function(a,b){this.pa.push({method:"get",arguments:[a,b]})},toString:ca("Boundary")}),Oc.Un=C.ba+"iw_plus.gif",Oc.VD=C.ba+"iw_minus.gif",Oc.nF=C.ba+"stop_icon.png",t.ia(Oc,V),t.extend(Oc.prototype,{getBusList:function(a){this.pa.push({method:"getBusList",arguments:[a]})},getBusLine:function(a){this.pa.push({method:"getBusLine",arguments:[a]})},setGetBusListCompleteCallback:function(a){this.k.AA=a||q()},setGetBusLineCompleteCallback:function(a){this.k.zA=a||q()},setBusListHtmlSetCallback:function(a){this.k.yA=a||q()},setBusLineHtmlSetCallback:function(a){this.k.xA=a||q()},setPolylinesSetCallback:function(a){this.k.xu=a||q()}}),t.ia(Pc,V,"Autocomplete"),t.extend(Pc.prototype,{Fe:q(),show:q(),H:q(),$u:function(a){this.zc.types=a},hj:function(a){this.hc.src=a},search:ba("og"),Xp:ba("Tw")});var ya,Qc=4,Rc=1;t.lang.ia(sa,t.lang.la,"Panorama"),t.extend(sa.prototype,{BH:s("Zn"),Dd:s("Oa"),$H:s("wo"),aB:s("wo"),ca:s("qb"),Xa:s("Ra"),U:s("Yb"),Ki:s("Kg"),cM:function(){return this.mL||[]},$L:s("iE"),we:function(a,b){a!=this.Oa&&(this.Uh=this.Oa,this.Wn=this.qb,this.Oa=a,this.Al=b||"street",this.qb=n)},da:function(a){a.bb(this.qb)||(this.Uh=this.Oa,this.Wn=this.qb,this.qb=a,this.Oa=n)},Sf:function(a){this.Ra=a,a=this.Ra.pitch,"cvsRender"==this.ll()?(a>90&&(a=90),-90>a&&(a=-90)):"cssRender"==this.ll()&&(a>45&&(a=45),-45>a&&(a=-45)),this.Ra.pitch=a},Jc:function(a){a!=this.Yb&&(a>Qc&&(a=Qc),Rc>a&&(a=Rc),a!=this.Yb&&(this.Yb=a))},as:function(){if(this.A)for(var a=this.A.Pt(),b=0;b<a.length;b++)(a[b]instanceof T||a[b]instanceof Mb)&&a[b].O&&this.fa.push(a[b])},Xu:ba("A"),oh:function(){this.Sg.style.display="none"},bq:function(){this.Sg.style.display="block"},cH:function(){this.k.enableScrollWheelZoom=i},HG:function(){this.k.enableScrollWheelZoom=o},show:function(){this.k.visible=i},H:function(){this.k.visible=o},ll:function(){return!H()&&ob()?"cvsRender":"cssRender"},cI:function(){return this.k.visible},os:function(a){function b(a,b){return function(){a.Bl.push({rA:b,qA:arguments})}}for(var c=a.getPanoMethodList(),d="",e=0,f=c.length;f>e;e++)d=c[e],this[d]=b(this,d);this.He.push(a)},Mu:function(a){for(var b=this.He.length;b--;)this.He[b]===a&&this.He.splice(b,1)}});var W=sa.prototype;S(W,{setId:W.we,setPosition:W.da,setPov:W.Sf,setZoom:W.Jc,getId:W.Dd,getPosition:W.ca,getPov:W.Xa,getZoom:W.U,getLinks:W.BH,enableDoubleClickZoom:W.ML,disableDoubleClickZoom:W.GL,enableScrollWheelZoom:W.cH,disableScrollWheelZoom:W.HG,show:W.show,hide:W.H,addPlugin:W.os,removePlugin:W.Mu,getVisible:W.cI}),B.Au(function(a){new zb(a,{Uj:"api"})}),t.extend(zb.prototype,{N:function(){function a(a){if(a){if(a.id!=b.wo){b.aB(a.id);var c=new L("ondataload");c.data=a,b.Oa=a.id,b.qb=a.position,b.jL=a.Hu,b.kL=a.Iu,b.Kg=a.description,b.Zn=a.links,b.dispatchEvent(c),b.dispatchEvent(new L("onposition_changed")),b.dispatchEvent(new L("onlinks_changed"))}}else b.Oa=b.Uh,b.qb=b.Wn,b.dispatchEvent(new L("onnoresult"))}var b=this.Q,c=this;b.addEventListener("id_changed",function(){c.rm(b.Dd(),a)}),b.addEventListener("position_changed_inner",function(){c.ih(b.ca(),a)})},rm:function(a,b){this.Oa=a,this.kf=b,this.Er=n},ih:function(a,b){this.Er=a,this.kf=b,this.Oa=n}});var Sc=zb.prototype;S(Sc,{getPanoramaById:Sc.rm,getPanoramaByLocation:Sc.ih}),yb.Kv=["http://pcsv0.map.bdimg.com/tile/","http://pcsv1.map.bdimg.com/tile/"],yb.prototype=new Vb,yb.prototype.getTilesUrl=function(a,b){return yb.Kv[(a.x+a.y)%yb.Kv.length]+"?udt=v&qt=tile&styles=pl&x="+a.x+"&y="+a.y+"&z="+b},yb.prototype.Bm=ca(i),B.Map=qa,B.Hotspot=Ka,B.MapType=fc,B.Point=F,B.Pixel=O,B.Size=K,B.Bounds=Ia,B.TileLayer=Vb,B.Projection=Cb,B.MercatorProjection=P,B.PerspectiveProjection=Ja,B.Copyright=function(a,b,c){this.id=a,this.rb=b,this.content=c},B.Overlay=Gb,B.Label=Mb,B.Marker=T,B.Icon=Kb,B.Polyline=Rb,B.Polygon=Qb,B.InfoWindow=Lb,B.Circle=Sb,B.Control=R,B.NavigationControl=Ma,B.GeolocationControl=tb,B.OverviewMapControl=Oa,B.CopyrightControl=ub,B.ScaleControl=Na,B.MapTypeControl=Pa,B.PanoramaControl=xb,B.TrafficLayer=ec,B.CustomLayer=Qa,B.ContextMenu=Ab,B.MenuItem=Bb,B.LocalSearch=Fa,B.TransitRoute=Fc,B.DrivingRoute=Hc,B.WalkingRoute=Ic,B.Autocomplete=Pc,B.Geocoder=Jc,B.LocalCity=Mc,B.Geolocation=Geolocation,B.BusLineSearch=Oc,B.Boundary=Nc,B.VectorCloudLayer=cc,B.VectorTrafficLayer=dc,B.Panorama=sa,B.PanoramaService=zb,B.PanoramaCoverageLayer=yb,B.PanoramaFlashInterface=Eb,S(window,{BMap:B,_jsload:function(a,b){ha.eq.FI&&ha.eq.set(a,b),G.$F(a,b)},BMAP_API_VERSION:"1.5"});var X=qa.prototype;S(X,{getBounds:X.vg,getCenter:X.Ga,getMapType:X.ha,getSize:X.Fb,setSize:X.Ic,getViewport:X.qp,getZoom:X.U,centerAndZoom:X.Wd,panTo:X.ue,panBy:X.te,setCenter:X.ve,setCurrentCity:X.Wu,setMapType:X.Cg,setViewport:X.zk,setZoom:X.Jc,highResolutionEnabled:X.ph,zoomTo:X.gf,zoomIn:X.pv,zoomOut:X.qv,addHotspot:X.Ho,removeHotspot:X.qJ,clearHotspots:X.si,checkResize:X.bG,addControl:X.Eo,removeControl:X.NA,getContainer:X.Ba,addContextMenu:X.Oj,removeContextMenu:X.rk,addOverlay:X.Wa,removeOverlay:X.Uc,clearOverlays:X.wy,openInfoWindow:X.Pb,closeInfoWindow:X.kc,pointToOverlayPixel:X.$e,overlayPixelToPoint:X.FA,getInfoWindow:X.Se,getOverlays:X.Pt,getPanes:function(){return{floatPane:this.Lc.ut,markerMouseTarget:this.Lc.qu,floatShadow:this.Lc.cz,labelPane:this.Lc.aA,markerPane:this.Lc.lA,markerShadow:this.Lc.mA,mapPane:this.Lc.Cp}},addTileLayer:X.Af,removeTileLayer:X.Qf,pixelToPoint:X.Ua,pointToPixel:X.nb,setFeatureStyle:X.UA,selectBaseElement:X.PM,setMapStyle:X.XA});var Tc=fc.prototype;S(Tc,{getTileLayer:Tc.YH,getMinZoom:Tc.Yj,getMaxZoom:Tc.Li,getProjection:Tc.Ni,getTextColor:Tc.sm,getTips:Tc.tm}),S(window,{BMAP_NORMAL_MAP:ra,BMAP_PERSPECTIVE_MAP:ta,BMAP_SATELLITE_MAP:va,BMAP_HYBRID_MAP:xa});var Uc=P.prototype;S(Uc,{lngLatToPoint:Uc.Em,pointToLngLat:Uc.xh});var Vc=Ja.prototype;S(Vc,{lngLatToPoint:Vc.Em,pointToLngLat:Vc.xh});var Wc=Ia.prototype;S(Wc,{equals:Wc.bb,containsPoint:Wc.mG,containsBounds:Wc.lG,intersects:Wc.Mz,extend:Wc.extend,getCenter:Wc.Ga,isEmpty:Wc.zg,getSouthWest:Wc.pe,getNorthEast:Wc.oe,toSpan:Wc.lv});var Xc=Gb.prototype;S(Xc,{isVisible:Xc.Ag,show:Xc.show,hide:Xc.H}),Gb.getZIndex=Gb.um;var Yc=Q.prototype;S(Yc,{openInfoWindow:Yc.Pb,closeInfoWindow:Yc.kc,enableMassClear:Yc.gh,disableMassClear:Yc.GG,show:Yc.show,hide:Yc.H,getMap:Yc.Mt,addContextMenu:Yc.Oj,removeContextMenu:Yc.rk});var Zc=T.prototype;S(Zc,{setIcon:Zc.Rf,getIcon:Zc.nz,setPosition:Zc.da,getPosition:Zc.ca,setOffset:Zc.Vc,getOffset:Zc.Te,getLabel:Zc.oz,setLabel:Zc.gj,setTitle:Zc.bc,setTop:Zc.yk,enableDragging:Zc.Eb,disableDragging:Zc.Ps,setZIndex:Zc.aq,getMap:Zc.Mt,setAnimation:Zc.fj,setShadow:Zc.$p,hide:Zc.H}),S(window,{BMAP_ANIMATION_DROP:1,BMAP_ANIMATION_BOUNCE:2});var $c=Mb.prototype;S($c,{setStyle:$c.qc,setStyles:$c.Ch,setContent:$c.Hc,setPosition:$c.da,getPosition:$c.ca,setOffset:$c.Vc,getOffset:$c.Te,setTitle:$c.bc,setZIndex:$c.aq,getMap:$c.Mt});var ad=Kb.prototype;S(ad,{setImageUrl:ad.QJ,setSize:ad.Ic,setAnchor:ad.Sb,setImageOffset:ad.Pm,setImageSize:ad.PJ,setInfoWindowAnchor:ad.SJ,setPrintImageUrl:ad.aK});var bd=Lb.prototype;S(bd,{redraw:bd.Gc,setTitle:bd.bc,setContent:bd.Hc,getContent:bd.hz,getPosition:bd.ca,enableMaximize:bd.Oe,disableMaximize:bd.Zo,isOpen:bd.za,setMaxContent:bd.Qm,maximize:bd.Dp,enableAutoPan:bd.fm});var cd=Ib.prototype;S(cd,{getPath:cd.Pc,setPath:cd.Wc,setPositionAt:cd.ij,getStrokeColor:cd.SH,setStrokeWeight:cd.Um,getStrokeWeight:cd.xz,setStrokeOpacity:cd.Sm,getStrokeOpacity:cd.TH,setFillOpacity:cd.Wp,getFillOpacity:cd.xH,setStrokeStyle:cd.Tm,getStrokeStyle:cd.wz,getFillColor:cd.wH,getBounds:cd.vg,enableEditing:cd.Yd,disableEditing:cd.FG});var dd=Sb.prototype;S(dd,{setCenter:dd.ve,getCenter:dd.Ga,getRadius:dd.LH,setRadius:dd.Zp});var ed=Qb.prototype;S(ed,{getPath:ed.Pc,setPath:ed.Wc,setPositionAt:ed.ij});var fd=Ka.prototype;S(fd,{getPosition:fd.ca,setPosition:fd.da,getText:fd.Vt,setText:fd.Vm}),F.prototype.equals=F.prototype.bb,O.prototype.equals=O.prototype.bb,K.prototype.equals=K.prototype.bb,S(window,{BMAP_ANCHOR_TOP_LEFT:qb,BMAP_ANCHOR_TOP_RIGHT:rb,BMAP_ANCHOR_BOTTOM_LEFT:sb,BMAP_ANCHOR_BOTTOM_RIGHT:3});var gd=R.prototype;S(gd,{setAnchor:gd.Sb,getAnchor:gd.wt,setOffset:gd.Vc,getOffset:gd.Te,show:gd.show,hide:gd.H,isVisible:gd.Ag,toString:gd.toString});var hd=Ma.prototype;S(hd,{getType:hd.ek,setType:hd.jj}),S(window,{BMAP_NAVIGATION_CONTROL_LARGE:0,BMAP_NAVIGATION_CONTROL_SMALL:1,BMAP_NAVIGATION_CONTROL_PAN:2,BMAP_NAVIGATION_CONTROL_ZOOM:3});var id=Oa.prototype;S(id,{changeView:id.Mc,setSize:id.Ic,getSize:id.Fb});var kd=Na.prototype;S(kd,{getUnit:kd.bI,setUnit:kd.av}),S(window,{BMAP_UNIT_METRIC:"metric",BMAP_UNIT_IMPERIAL:"us"});var ld=ub.prototype;S(ld,{addCopyright:ld.Fo,removeCopyright:ld.Lu,getCopyright:ld.Ii,getCopyrightCollection:ld.Ct}),S(window,{BMAP_MAPTYPE_CONTROL_HORIZONTAL:wb,BMAP_MAPTYPE_CONTROL_DROPDOWN:1});var md=Vb.prototype;S(md,{getMapType:md.ha,getCopyright:md.Ii,isTransparentPng:md.Bm});var nd=Ab.prototype;S(nd,{addItem:nd.Io,addSeparator:nd.qs,removeSeparator:nd.Nu});var od=Bb.prototype;S(od,{setText:od.Vm});var pd=V.prototype;S(pd,{getStatus:pd.Oi,setSearchCompleteCallback:pd.Zu,getPageCapacity:pd.Ed,setPageCapacity:pd.xk,setLocation:pd.hj,disableFirstResultSelection:pd.Qs,enableFirstResultSelection:pd.dt,gotoPage:pd.Qi,searchNearby:pd.vk,searchInBounds:pd.ej,search:pd.search}),S(window,{BMAP_STATUS_SUCCESS:0,BMAP_STATUS_CITY_LIST:1,BMAP_STATUS_UNKNOWN_LOCATION:2,BMAP_STATUS_UNKNOWN_ROUTE:3,BMAP_STATUS_INVALID_KEY:4,BMAP_STATUS_INVALID_REQUEST:5,BMAP_STATUS_PERMISSION_DENIED:6,BMAP_STATUS_SERVICE_UNAVAILABLE:7,BMAP_STATUS_TIMEOUT:8}),S(window,{BMAP_POI_TYPE_NORMAL:0,BMAP_POI_TYPE_BUSSTOP:1,BMAP_POI_TYPE_BUSLINE:2,BMAP_POI_TYPE_SUBSTOP:3,BMAP_POI_TYPE_SUBLINE:4}),S(window,{BMAP_TRANSIT_POLICY_LEAST_TIME:0,BMAP_TRANSIT_POLICY_LEAST_TRANSFER:2,BMAP_TRANSIT_POLICY_LEAST_WALKING:3,BMAP_TRANSIT_POLICY_AVOID_SUBWAYS:4,BMAP_LINE_TYPE_BUS:0,BMAP_LINE_TYPE_SUBWAY:1,BMAP_LINE_TYPE_FERRY:2});var qd=Ec.prototype;S(qd,{clearResults:qd.kd});var rd=Fc.prototype;S(rd,{setPolicy:rd.Rm,toString:rd.toString,setPageCapacity:rd.xk}),S(window,{BMAP_DRIVING_POLICY_LEAST_TIME:0,BMAP_DRIVING_POLICY_LEAST_DISTANCE:1,BMAP_DRIVING_POLICY_AVOID_HIGHWAYS:2}),S(window,{BMAP_HIGHLIGHT_STEP:1,BMAP_HIGHLIGHT_ROUTE:2}),S(window,{BMAP_ROUTE_TYPE_DRIVING:rc,BMAP_ROUTE_TYPE_WALKING:qc}),S(window,{BMAP_ROUTE_STATUS_NORMAL:sc,BMAP_ROUTE_STATUS_EMPTY:1,BMAP_ROUTE_STATUS_ADDRESS:2});var sd=Hc.prototype;S(sd,{setPolicy:sd.Rm});var td=Pc.prototype;S(td,{show:td.show,hide:td.H,setTypes:td.$u,setLocation:td.hj,search:td.search,setInputValue:td.Xp}),S(Qa.prototype,{});var ud=Nc.prototype;S(ud,{get:ud.get}),S(yb.prototype,{}),B.HF()}();